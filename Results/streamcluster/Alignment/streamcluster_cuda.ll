...
entry:
  ...
  tail call void @llvm.dbg.value(metadata i8* %addressP, i64 0, metadata !1170, metadata !1160), !dbg !1210
  tail call void @llvm.dbg.value(metadata i8* %moduleName, i64 0, metadata !1171, metadata !1160), !dbg !1211
  tail call void @llvm.dbg.value(metadata i8* %functionName, i64 0, metadata !1172, metadata !1160), !dbg !1212
  tail call void @llvm.dbg.value(metadata i8* %loadOrStore, i64 0, metadata !1173, metadata !1160), !dbg !1213
  tail call void @llvm.dbg.value(metadata i32 %lineNum, i64 0, metadata !1174, metadata !1160), !dbg !1214
  tail call void @llvm.dbg.value(metadata i32 %columnNum, i64 0, metadata !1175, metadata !1160), !dbg !1215
  tail call void @llvm.dbg.value(metadata i32 %dynamicId, i64 0, metadata !1176, metadata !1160), !dbg !1216
  tail call void @llvm.dbg.value(metadata i32 %typeSize, i64 0, metadata !1177, metadata !1160), !dbg !1217
  tail call void @llvm.dbg.value(metadata i8* %addressP, i64 0, metadata !1218, metadata !1160) #7, !dbg !1225
  %0 = tail call i32 asm sideeffect "{ \0A\09    .reg .pred p; \0A\09    isspacep.global p, $1; \0A\09    selp.u32 $0, 1, 0, p;  \0A\09} \0A\09", "=r,l"(i8* %addressP) #8, !dbg !1228, !srcloc !1229
  tail call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !1224, metadata !1160) #7, !dbg !1230
  %cmp = icmp eq i32 %0, 1, !dbg !1231
  br i1 %cmp, label %if.end, label %return, !dbg !1232

if.end:                                           ; preds = %entry
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !1233, metadata !1160) #7, !dbg !1237
  %1 = tail call i32 asm sideeffect "{ \0A\09.reg .pred \09%p1; \0A\09setp.ne.u32 \09%p1, $1, 0; \0A\09vote.ballot.b32 \09$0, %p1; \0A\09}", "=r,r"(i32 1) #8, !dbg !1239, !srcloc !1240
  tail call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !1236, metadata !1160) #7, !dbg !1241
  tail call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !1178, metadata !1160), !dbg !1242
  %2 = ptrtoint i8* %addressP to i64, !dbg !1243
  tail call void @llvm.dbg.value(metadata i64 %2, i64 0, metadata !1179, metadata !1160), !dbg !1244
  %3 = bitcast [64 x i64]* %addrArray to i8*, !dbg !1245
  call void @llvm.lifetime.start(i64 512, i8* %3) #7, !dbg !1245
  tail call void @llvm.dbg.declare(metadata [64 x i64]* %addrArray, metadata !1180, metadata !1160), !dbg !1246
  tail call void @llvm.dbg.value(metadata i32 -1, i64 0, metadata !1184, metadata !1160), !dbg !1247
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1185, metadata !1160), !dbg !1248
  br label %for.body, !dbg !1249

for.body:                                         ; preds = %for.inc.3, %if.end
  %inc.sink149 = phi i32 [ 0, %if.end ], [ %inc.3, %for.inc.3 ]
  %4 = shl i32 1, %inc.sink149, !dbg !1252
  %and.i141 = and i32 %4, %1, !dbg !1252
  %cmp4 = icmp eq i32 %and.i141, 0, !dbg !1252
  br i1 %cmp4, label %for.inc, label %cleanup, !dbg !1254

for.inc:                                          ; preds = %for.body
  %inc = or i32 %inc.sink149, 1, !dbg !1255
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1185, metadata !1160), !dbg !1248
  %5 = shl i32 1, %inc, !dbg !1252
  %and.i141.1 = and i32 %5, %1, !dbg !1252
  %cmp4.1 = icmp eq i32 %and.i141.1, 0, !dbg !1252
  br i1 %cmp4.1, label %for.inc.1, label %cleanup, !dbg !1254
...
cleanup:                                          ; preds = %for.inc.3, %for.inc.2, %for.inc.1, %for.inc, %for.body
  ...
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1187, metadata !1160), !dbg !1257
  %shr = lshr i64 %2, 32, !dbg !1258
  %conv = trunc i64 %shr to i32, !dbg !1259
  %conv15 = trunc i64 %2 to i32, !dbg !1260
  br label %for.body11, !dbg !1261

for.cond.cleanup10:                               ; preds = %for.inc24
  %6 = tail call i32 asm sideeffect "mov.u32 $0, %laneid;", "=r"() #8, !dbg !1263, !srcloc !1271
  tail call void @llvm.dbg.value(metadata i32 %6, i64 0, metadata !1269, metadata !1160) #7, !dbg !1272
  %cmp29 = icmp eq i32 %reduceThread.0, %6, !dbg !1273
  br i1 %cmp29, label %for.cond32.preheader, label %if.end87, !dbg !1274

for.cond32.preheader:                             ; preds = %for.cond.cleanup10
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1198, metadata !1160), !dbg !1275
  %conv39 = sext i32 %typeSize to i64, !dbg !1276
  %add = add nsw i64 %conv39, -1, !dbg !1279
  br label %for.body35, !dbg !1280

for.body11:                                       ; preds = %for.inc24, %cleanup
  %inc25.sink148 = phi i32 [ 0, %cleanup ], [ %inc25, %for.inc24 ]
  %7 = shl i32 1, %inc25.sink148, !dbg !1282
  %and.i139140 = and i32 %7, %1, !dbg !1282
  %cmp13 = icmp eq i32 %and.i139140, 0, !dbg !1282
  br i1 %cmp13, label %if.then14, label %if.else, !dbg !1283

if.then14:                                        ; preds = %for.body11
  %mul = shl nsw i32 %inc25.sink148, 1, !dbg !1284
  %idxprom = sext i32 %mul to i64, !dbg !1285
  %arrayidx = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom, !dbg !1285
  store i64 %2, i64* %arrayidx, align 8, !dbg !1286, !tbaa !1287
  br label %for.inc24, !dbg !1285

if.else:                                          ; preds = %for.body11
  tail call void @llvm.dbg.value(metadata i32 %conv, i64 0, metadata !1189, metadata !1160), !dbg !1291
  tail call void @llvm.dbg.value(metadata i32 %conv15, i64 0, metadata !1194, metadata !1160), !dbg !1292
  tail call void @llvm.dbg.value(metadata i32 %conv, i64 0, metadata !1293, metadata !1160) #7, !dbg !1301
  tail call void @llvm.dbg.value(metadata i32 %inc25.sink148, i64 0, metadata !1299, metadata !1160) #7, !dbg !1301
  tail call void @llvm.dbg.value(metadata i32 32, i64 0, metadata !1300, metadata !1160) #7, !dbg !1301
  %8 = tail call i32 @llvm.nvvm.shfl.idx.i32(i32 %conv, i32 %inc25.sink148, i32 31) #7, !dbg !1301
  tail call void @llvm.dbg.value(metadata i32 %8, i64 0, metadata !1189, metadata !1160), !dbg !1291
  tail call void @llvm.dbg.value(metadata i32 %conv15, i64 0, metadata !1293, metadata !1160) #7, !dbg !1303
  tail call void @llvm.dbg.value(metadata i32 %inc25.sink148, i64 0, metadata !1299, metadata !1160) #7, !dbg !1303
  tail call void @llvm.dbg.value(metadata i32 32, i64 0, metadata !1300, metadata !1160) #7, !dbg !1303
  %9 = tail call i32 @llvm.nvvm.shfl.idx.i32(i32 %conv15, i32 %inc25.sink148, i32 31) #7, !dbg !1303
  tail call void @llvm.dbg.value(metadata i32 %9, i64 0, metadata !1194, metadata !1160), !dbg !1292
  %conv18137 = zext i32 %8 to i64, !dbg !1305
  %shl = shl nuw i64 %conv18137, 32, !dbg !1306
  %conv19 = sext i32 %9 to i64, !dbg !1307
  %or = or i64 %shl, %conv19, !dbg !1308
  %mul20 = shl nsw i32 %inc25.sink148, 1, !dbg !1309
  %idxprom21 = sext i32 %mul20 to i64, !dbg !1310
  %arrayidx22 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom21, !dbg !1310
  store i64 %or, i64* %arrayidx22, align 8, !dbg !1311, !tbaa !1287
  br label %for.inc24

for.inc24:                                        ; preds = %if.else, %if.then14
  %inc25 = add nuw nsw i32 %inc25.sink148, 1, !dbg !1312
  tail call void @llvm.dbg.value(metadata i32 %inc25, i64 0, metadata !1187, metadata !1160), !dbg !1257
  %exitcond152 = icmp eq i32 %inc25, 32, !dbg !1261
  br i1 %exitcond152, label %for.cond.cleanup10, label %for.body11, !dbg !1261, !llvm.loop !1314

for.cond.cleanup34:                               ; preds = %for.body35
  %arrayidx53 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 0, !dbg !1316
  %10 = load i64, i64* %arrayidx53, align 8, !dbg !1316, !tbaa !1287
  tail call void @llvm.dbg.value(metadata i64 %10, i64 0, metadata !1200, metadata !1160), !dbg !1317
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1201, metadata !1160), !dbg !1318
  br label %for.body58, !dbg !1319

for.body35:                                       ; preds = %for.body35, %for.cond32.preheader
  %inc50.sink147 = phi i32 [ 0, %for.cond32.preheader ], [ %inc50.1, %for.body35 ]
  %mul36 = shl nsw i32 %inc50.sink147, 1, !dbg !1321
  %idxprom37 = sext i32 %mul36 to i64, !dbg !1322
  %arrayidx38 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom37, !dbg !1322
  %11 = load i64, i64* %arrayidx38, align 8, !dbg !1322, !tbaa !1287
  %sub = add i64 %add, %11, !dbg !1323
  %shr40 = lshr i64 %sub, 7, !dbg !1324
  %add42 = or i32 %mul36, 1, !dbg !1325
  %idxprom43 = sext i32 %add42 to i64, !dbg !1326
  %arrayidx44 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom43, !dbg !1326
  store i64 %shr40, i64* %arrayidx44, align 8, !dbg !1327, !tbaa !1287
  %shr48 = lshr i64 %11, 7, !dbg !1328
  store i64 %shr48, i64* %arrayidx38, align 8, !dbg !1328, !tbaa !1287
  %inc50 = shl i32 %inc50.sink147, 1, !dbg !1321
  %mul36.1 = or i32 %inc50, 2, !dbg !1321
  %idxprom37.1 = sext i32 %mul36.1 to i64, !dbg !1322
  %arrayidx38.1 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom37.1, !dbg !1322
  %12 = load i64, i64* %arrayidx38.1, align 8, !dbg !1322, !tbaa !1287
  %sub.1 = add i64 %add, %12, !dbg !1323
  %shr40.1 = lshr i64 %sub.1, 7, !dbg !1324
  %add42.1 = or i32 %inc50, 3, !dbg !1325
  %idxprom43.1 = sext i32 %add42.1 to i64, !dbg !1326
  %arrayidx44.1 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom43.1, !dbg !1326
  store i64 %shr40.1, i64* %arrayidx44.1, align 8, !dbg !1327, !tbaa !1287
  %shr48.1 = lshr i64 %12, 7, !dbg !1328
  store i64 %shr48.1, i64* %arrayidx38.1, align 8, !dbg !1328, !tbaa !1287
  %inc50.1 = add nsw i32 %inc50.sink147, 2, !dbg !1329
  %exitcond151.1 = icmp eq i32 %inc50.1, 32, !dbg !1280
  br i1 %exitcond151.1, label %for.cond.cleanup34, label %for.body35, !dbg !1280, !llvm.loop !1331

for.cond.cleanup57:                               ; preds = %for.inc83
  tail call void @llvm.dbg.value(metadata !2, i64 0, metadata !1209, metadata !1160), !dbg !1333
  %13 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 0, !dbg !1334
  store i8* %moduleName, i8** %13, align 8, !dbg !1334
  %14 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 1, !dbg !1334
  store i8* %functionName, i8** %14, align 8, !dbg !1334
  %15 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 2, !dbg !1334
  store i32 %dynamicId, i32* %15, align 8, !dbg !1334
  %16 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 3, !dbg !1334
  store i8* %loadOrStore, i8** %16, align 8, !dbg !1334
  %17 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 4, !dbg !1334
  store i32 %lineNum, i32* %17, align 8, !dbg !1334
  %18 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 5, !dbg !1334
  store i32 %columnNum, i32* %18, align 4, !dbg !1334
  %19 = getelementptr inbounds %printf_args, %printf_args* %tmp, i64 0, i32 6, !dbg !1334
  store i32 %count.1, i32* %19, align 8, !dbg !1334
  %20 = bitcast %printf_args* %tmp to i8*, !dbg !1334
  %21 = call i32 @vprintf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str, i64 0, i64 0), i8* %20), !dbg !1334
  br label %if.end87, !dbg !1335

for.body58:                                       ; preds = %for.inc83.for.body58_crit_edge, %for.cond.cleanup34
  %22 = phi i64 [ %10, %for.cond.cleanup34 ], [ %.pre, %for.inc83.for.body58_crit_edge ], !dbg !1336
  ...
  %cmp61 = icmp eq i64 %22, %10, !dbg !1337
  br i1 %cmp61, label %for.body58.for.inc83_crit_edge, label %if.then62, !dbg !1338

for.body58.for.inc83_crit_edge:                   ; preds = %for.body58
  %.pre153 = add nuw nsw i32 %inc84.sink146, 1, !dbg !1339
  br label %for.inc83, !dbg !1338

if.then62:                                        ; preds = %for.body58
  tail call void @llvm.dbg.value(metadata i64 %22, i64 0, metadata !1203, metadata !1160), !dbg !1341
  %inc65 = add nsw i32 %count.0145, 1, !dbg !1342
  tail call void @llvm.dbg.value(metadata i32 %inc65, i64 0, metadata !1195, metadata !1160), !dbg !1343
  %inc79142 = add nuw nsw i32 %inc84.sink146, 1, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79142, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %cmp68143 = icmp slt i32 %inc79142, 64, !dbg !1348
  br i1 %cmp68143, label %for.body70.preheader, label %for.inc83, !dbg !1350

for.body70.preheader:                             ; preds = %if.then62
  %23 = sub i32 63, %inc84.sink146, !dbg !1351
  %24 = sub i32 62, %inc84.sink146, !dbg !1351
  %xtraiter = and i32 %23, 3, !dbg !1351
  %lcmp.mod = icmp eq i32 %xtraiter, 0, !dbg !1351
  br i1 %lcmp.mod, label %for.body70.prol.loopexit, label %for.body70.prol.preheader, !dbg !1351

for.body70.prol.preheader:                        ; preds = %for.body70.preheader
  br label %for.body70.prol, !dbg !1351
...
for.body70.prol:                                  ; preds = %for.cond67.backedge.prol, %for.body70.prol.preheader
  ...
  %idxprom71.prol = sext i32 %inc79144.prol to i64, !dbg !1351
  %arrayidx72.prol = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom71.prol, !dbg !1351
  %25 = load i64, i64* %arrayidx72.prol, align 8, !dbg !1351, !tbaa !1287
  %cmp73.prol = icmp eq i64 %25, %22, !dbg !1353
  br i1 %cmp73.prol, label %if.then74.prol, label %for.cond67.backedge.prol, !dbg !1354

if.then74.prol:                                   ; preds = %for.body70.prol
  store i64 %10, i64* %arrayidx72.prol, align 8, !dbg !1355, !tbaa !1287
  br label %for.cond67.backedge.prol, !dbg !1356

for.cond67.backedge.prol:                         ; preds = %if.then74.prol, %for.body70.prol
  %inc79.prol = add nuw nsw i32 %inc79144.prol, 1, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79.prol, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %prol.iter.sub = add i32 %prol.iter, -1, !dbg !1350
  %prol.iter.cmp = icmp eq i32 %prol.iter.sub, 0, !dbg !1350
  br i1 %prol.iter.cmp, label %for.body70.prol.loopexit.unr-lcssa, label %for.body70.prol, !dbg !1350, !llvm.loop !1357

for.body70.prol.loopexit.unr-lcssa:               ; preds = %for.cond67.backedge.prol
  br label %for.body70.prol.loopexit, !dbg !1351
...
for.body70.prol.loopexit:                         ; preds = %for.body70.prol.loopexit.unr-lcssa, %for.body70.preheader
  ...
  %26 = icmp ult i32 %24, 3, !dbg !1351
  br i1 %26, label %for.inc83.loopexit, label %for.body70.preheader.new, !dbg !1351

for.body70.preheader.new:                         ; preds = %for.body70.prol.loopexit
  br label %for.body70, !dbg !1351
...
for.body70:                                       ; preds = %for.cond67.backedge.3, %for.body70.preheader.new
  ...
  %idxprom71 = sext i32 %inc79144 to i64, !dbg !1351
  %arrayidx72 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom71, !dbg !1351
  %27 = load i64, i64* %arrayidx72, align 8, !dbg !1351, !tbaa !1287
  %cmp73 = icmp eq i64 %27, %22, !dbg !1353
  br i1 %cmp73, label %if.then74, label %for.cond67.backedge, !dbg !1354

for.cond67.backedge:                              ; preds = %if.then74, %for.body70
  %inc79 = add nuw nsw i32 %inc79144, 1, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %idxprom71.1 = sext i32 %inc79 to i64, !dbg !1351
  %arrayidx72.1 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom71.1, !dbg !1351
  %28 = load i64, i64* %arrayidx72.1, align 8, !dbg !1351, !tbaa !1287
  %cmp73.1 = icmp eq i64 %28, %22, !dbg !1353
  br i1 %cmp73.1, label %if.then74.1, label %for.cond67.backedge.1, !dbg !1354

if.then74:                                        ; preds = %for.body70
  store i64 %10, i64* %arrayidx72, align 8, !dbg !1355, !tbaa !1287
  br label %for.cond67.backedge, !dbg !1356

for.inc83.loopexit.unr-lcssa:                     ; preds = %for.cond67.backedge.3
  br label %for.inc83.loopexit, !dbg !1318

for.inc83.loopexit:                               ; preds = %for.inc83.loopexit.unr-lcssa, %for.body70.prol.loopexit
  br label %for.inc83, !dbg !1318

for.inc83:                                        ; preds = %for.inc83.loopexit, %if.then62, %for.body58.for.inc83_crit_edge
  %inc84.pre-phi = phi i32 [ %.pre153, %for.body58.for.inc83_crit_edge ], [ %inc79142, %if.then62 ], [ %inc79142, %for.inc83.loopexit ], !dbg !1339
  %count.1 = phi i32 [ %count.0145, %for.body58.for.inc83_crit_edge ], [ %inc65, %if.then62 ], [ %inc65, %for.inc83.loopexit ]
  tail call void @llvm.dbg.value(metadata i32 %inc84.pre-phi, i64 0, metadata !1201, metadata !1160), !dbg !1318
  %exitcond150 = icmp eq i32 %inc84.pre-phi, 64, !dbg !1319
  br i1 %exitcond150, label %for.cond.cleanup57, label %for.inc83.for.body58_crit_edge, !dbg !1319, !llvm.loop !1359

for.inc83.for.body58_crit_edge:                   ; preds = %for.inc83
  %idxprom59.phi.trans.insert = sext i32 %inc84.pre-phi to i64, !dbg !1336
  %arrayidx60.phi.trans.insert = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom59.phi.trans.insert, !dbg !1336
  %.pre = load i64, i64* %arrayidx60.phi.trans.insert, align 8, !dbg !1336, !tbaa !1287
  br label %for.body58, !dbg !1319

if.end87:                                         ; preds = %for.cond.cleanup57, %for.cond.cleanup10
  call void @llvm.lifetime.end(i64 512, i8* nonnull %3) #7, !dbg !1361
  br label %return
...
if.then74.1:                                      ; preds = %for.cond67.backedge
  store i64 %10, i64* %arrayidx72.1, align 8, !dbg !1355, !tbaa !1287
  br label %for.cond67.backedge.1, !dbg !1356

for.cond67.backedge.1:                            ; preds = %if.then74.1, %for.cond67.backedge
  %inc79.1 = add nsw i32 %inc79144, 2, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %idxprom71.2 = sext i32 %inc79.1 to i64, !dbg !1351
  %arrayidx72.2 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom71.2, !dbg !1351
  %29 = load i64, i64* %arrayidx72.2, align 8, !dbg !1351, !tbaa !1287
  %cmp73.2 = icmp eq i64 %29, %22, !dbg !1353
  br i1 %cmp73.2, label %if.then74.2, label %for.cond67.backedge.2, !dbg !1354

if.then74.2:                                      ; preds = %for.cond67.backedge.1
  store i64 %10, i64* %arrayidx72.2, align 8, !dbg !1355, !tbaa !1287
  br label %for.cond67.backedge.2, !dbg !1356

for.cond67.backedge.2:                            ; preds = %if.then74.2, %for.cond67.backedge.1
  %inc79.2 = add nsw i32 %inc79144, 3, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %idxprom71.3 = sext i32 %inc79.2 to i64, !dbg !1351
  %arrayidx72.3 = getelementptr inbounds [64 x i64], [64 x i64]* %addrArray, i64 0, i64 %idxprom71.3, !dbg !1351
  %30 = load i64, i64* %arrayidx72.3, align 8, !dbg !1351, !tbaa !1287
  %cmp73.3 = icmp eq i64 %30, %22, !dbg !1353
  br i1 %cmp73.3, label %if.then74.3, label %for.cond67.backedge.3, !dbg !1354

if.then74.3:                                      ; preds = %for.cond67.backedge.2
  store i64 %10, i64* %arrayidx72.3, align 8, !dbg !1355, !tbaa !1287
  br label %for.cond67.backedge.3, !dbg !1356

for.cond67.backedge.3:                            ; preds = %if.then74.3, %for.cond67.backedge.2
  %inc79.3 = add nsw i32 %inc79144, 4, !dbg !1344
  tail call void @llvm.dbg.value(metadata i32 %inc79, i64 0, metadata !1207, metadata !1160), !dbg !1347
  %exitcond.3 = icmp eq i32 %inc79.3, 64, !dbg !1350
  br i1 %exitcond.3, label %for.inc83.loopexit.unr-lcssa, label %for.body70, !dbg !1350

for.inc.1:                                        ; preds = %for.inc
  %inc.1 = or i32 %inc.sink149, 2, !dbg !1255
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1185, metadata !1160), !dbg !1248
  %31 = shl i32 1, %inc.1, !dbg !1252
  %and.i141.2 = and i32 %31, %1, !dbg !1252
  %cmp4.2 = icmp eq i32 %and.i141.2, 0, !dbg !1252
  br i1 %cmp4.2, label %for.inc.2, label %cleanup, !dbg !1254

for.inc.2:                                        ; preds = %for.inc.1
  %inc.2 = or i32 %inc.sink149, 3, !dbg !1255
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1185, metadata !1160), !dbg !1248
  %32 = shl i32 1, %inc.2, !dbg !1252
  %and.i141.3 = and i32 %32, %1, !dbg !1252
  %cmp4.3 = icmp eq i32 %and.i141.3, 0, !dbg !1252
  br i1 %cmp4.3, label %for.inc.3, label %cleanup, !dbg !1254

for.inc.3:                                        ; preds = %for.inc.2
  %inc.3 = add nsw i32 %inc.sink149, 4, !dbg !1255
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1185, metadata !1160), !dbg !1248
  %cmp2.3 = icmp slt i32 %inc.3, 32, !dbg !1364
  br i1 %cmp2.3, label %for.body, label %cleanup, !dbg !1249, !llvm.loop !1365
}
...
define float @_Z6d_distiiiiPf(i32 %p1, i32 %p2, i32 %num, i32 %dim, float* nocapture readonly %coord_d) local_unnamed_addr #4 !dbg !1367 {
entry:
  tail call void @llvm.dbg.value(metadata i32 %p1, i64 0, metadata !1371, metadata !1160), !dbg !1382
  tail call void @llvm.dbg.value(metadata i32 %p2, i64 0, metadata !1372, metadata !1160), !dbg !1383
  tail call void @llvm.dbg.value(metadata i32 %num, i64 0, metadata !1373, metadata !1160), !dbg !1384
  tail call void @llvm.dbg.value(metadata i32 %dim, i64 0, metadata !1374, metadata !1160), !dbg !1385
  tail call void @llvm.dbg.value(metadata float* %coord_d, i64 0, metadata !1375, metadata !1160), !dbg !1386
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, i64 0, metadata !1376, metadata !1160), !dbg !1387
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1377, metadata !1160), !dbg !1388
  %cmp18 = icmp sgt i32 %dim, 0, !dbg !1389
  br i1 %cmp18, label %for.body.preheader, label %for.cond.cleanup, !dbg !1391

for.body.preheader:                               ; preds = %entry
  %xtraiter = and i32 %dim, 1, !dbg !1392
  %lcmp.mod = icmp eq i32 %xtraiter, 0, !dbg !1392
  br i1 %lcmp.mod, label %for.body.prol.loopexit, label %for.body.prol.preheader, !dbg !1392

for.body.prol.preheader:                          ; preds = %for.body.preheader
  br label %for.body.prol, !dbg !1392

for.body.prol:                                    ; preds = %for.body.prol.preheader
  %idxprom.prol = sext i32 %p1 to i64, !dbg !1393
  %arrayidx.prol = getelementptr inbounds float, float* %coord_d, i64 %idxprom.prol, !dbg !1393
  %0 = bitcast float* %arrayidx.prol to i8*, !dbg !1393
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %0, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0), i32 53, i32 15, i32 0, i32 4), !dbg !1393
  %1 = load float, float* %arrayidx.prol, align 4, !dbg !1393, !tbaa !1394
  %idxprom4.prol = sext i32 %p2 to i64, !dbg !1396
  %arrayidx5.prol = getelementptr inbounds float, float* %coord_d, i64 %idxprom4.prol, !dbg !1396
  %2 = bitcast float* %arrayidx5.prol to i8*, !dbg !1396
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %2, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @5, i32 0, i32 0), i32 53, i32 37, i32 1, i32 4), !dbg !1396
  %3 = load float, float* %arrayidx5.prol, align 4, !dbg !1396, !tbaa !1394
  %sub.prol = fsub float %1, %3, !dbg !1397
  tail call void @llvm.dbg.value(metadata float %sub.prol, i64 0, metadata !1379, metadata !1160), !dbg !1398
  %mul6.prol = fmul float %sub.prol, %sub.prol, !dbg !1399
  %add7.prol = fadd float %mul6.prol, 0.000000e+00, !dbg !1400
  tail call void @llvm.dbg.value(metadata float %add7.prol, i64 0, metadata !1376, metadata !1160), !dbg !1387
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !1377, metadata !1160), !dbg !1388
  br label %for.body.prol.loopexit, !dbg !1391
...
for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader
  ...
  %4 = icmp eq i32 %dim, 1, !dbg !1392
  br i1 %4, label %for.cond.cleanup.loopexit, label %for.body.preheader.new, !dbg !1392
...
for.cond.cleanup.loopexit.unr-lcssa:              ; preds = %for.body
  br label %for.cond.cleanup.loopexit, !dbg !1401
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %mul = mul nsw i32 %inc.sink20, %num, !dbg !1392
  %add = add nsw i32 %mul, %p1, !dbg !1402
  %idxprom = sext i32 %add to i64, !dbg !1393
  %arrayidx = getelementptr inbounds float, float* %coord_d, i64 %idxprom, !dbg !1393
  %5 = bitcast float* %arrayidx to i8*, !dbg !1393
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %5, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @6, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @7, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @8, i32 0, i32 0), i32 53, i32 15, i32 2, i32 4), !dbg !1393
  %6 = load float, float* %arrayidx, align 4, !dbg !1393, !tbaa !1394
  %add3 = add nsw i32 %mul, %p2, !dbg !1403
  %idxprom4 = sext i32 %add3 to i64, !dbg !1396
  %arrayidx5 = getelementptr inbounds float, float* %coord_d, i64 %idxprom4, !dbg !1396
  %7 = bitcast float* %arrayidx5 to i8*, !dbg !1396
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %7, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @11, i32 0, i32 0), i32 53, i32 37, i32 3, i32 4), !dbg !1396
  %8 = load float, float* %arrayidx5, align 4, !dbg !1396, !tbaa !1394
  %sub = fsub float %6, %8, !dbg !1397
  tail call void @llvm.dbg.value(metadata float %sub, i64 0, metadata !1379, metadata !1160), !dbg !1398
  %mul6 = fmul float %sub, %sub, !dbg !1399
  %add7 = fadd float %retval1.019, %mul6, !dbg !1400
  tail call void @llvm.dbg.value(metadata float %add7, i64 0, metadata !1376, metadata !1160), !dbg !1387
  %inc = add nuw nsw i32 %inc.sink20, 1, !dbg !1404
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1377, metadata !1160), !dbg !1388
  %mul.1 = mul nsw i32 %inc, %num, !dbg !1392
  %add.1 = add nsw i32 %mul.1, %p1, !dbg !1402
  %idxprom.1 = sext i32 %add.1 to i64, !dbg !1393
  %arrayidx.1 = getelementptr inbounds float, float* %coord_d, i64 %idxprom.1, !dbg !1393
  %9 = bitcast float* %arrayidx.1 to i8*, !dbg !1393
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %9, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @12, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @13, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i32 0, i32 0), i32 53, i32 15, i32 4, i32 4), !dbg !1393
  %10 = load float, float* %arrayidx.1, align 4, !dbg !1393, !tbaa !1394
  %add3.1 = add nsw i32 %mul.1, %p2, !dbg !1403
  %idxprom4.1 = sext i32 %add3.1 to i64, !dbg !1396
  %arrayidx5.1 = getelementptr inbounds float, float* %coord_d, i64 %idxprom4.1, !dbg !1396
  %11 = bitcast float* %arrayidx5.1 to i8*, !dbg !1396
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %11, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @15, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @16, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @17, i32 0, i32 0), i32 53, i32 37, i32 5, i32 4), !dbg !1396
  %12 = load float, float* %arrayidx5.1, align 4, !dbg !1396, !tbaa !1394
  %sub.1 = fsub float %10, %12, !dbg !1397
  tail call void @llvm.dbg.value(metadata float %sub, i64 0, metadata !1379, metadata !1160), !dbg !1398
  %mul6.1 = fmul float %sub.1, %sub.1, !dbg !1399
  %add7.1 = fadd float %add7, %mul6.1, !dbg !1400
  tail call void @llvm.dbg.value(metadata float %add7, i64 0, metadata !1376, metadata !1160), !dbg !1387
  %inc.1 = add nsw i32 %inc.sink20, 2, !dbg !1404
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !1377, metadata !1160), !dbg !1388
  %exitcond.1 = icmp eq i32 %inc.1, %dim, !dbg !1391
  br i1 %exitcond.1, label %for.cond.cleanup.loopexit.unr-lcssa, label %for.body, !dbg !1391, !llvm.loop !1406
}

; Function Attrs: nounwind
define void @_Z19kernel_compute_costiilP5PointiiPfS1_PiPb(i32 %num, i32 %dim, i64 %x, %struct.Point* nocapture readonly %p, i32 %K, i32 %stride, float* nocapture readonly %coord_d, float* nocapture %work_mem_d, i32* nocapture readonly %center_table_d, i8* nocapture %switch_membership_d) local_unnamed_addr #5 !dbg !1408 {
entry:
  tail call void @llvm.dbg.value(metadata i32 %num, i64 0, metadata !1422, metadata !1160), !dbg !1438
  tail call void @llvm.dbg.value(metadata i32 %dim, i64 0, metadata !1423, metadata !1160), !dbg !1439
  tail call void @llvm.dbg.value(metadata i64 %x, i64 0, metadata !1424, metadata !1160), !dbg !1440
  tail call void @llvm.dbg.value(metadata %struct.Point* %p, i64 0, metadata !1425, metadata !1160), !dbg !1441
  tail call void @llvm.dbg.value(metadata i32 %K, i64 0, metadata !1426, metadata !1160), !dbg !1442
  tail call void @llvm.dbg.value(metadata i32 %stride, i64 0, metadata !1427, metadata !1160), !dbg !1443
  tail call void @llvm.dbg.value(metadata float* %coord_d, i64 0, metadata !1428, metadata !1160), !dbg !1444
  tail call void @llvm.dbg.value(metadata float* %work_mem_d, i64 0, metadata !1429, metadata !1160), !dbg !1445
  tail call void @llvm.dbg.value(metadata i32* %center_table_d, i64 0, metadata !1430, metadata !1160), !dbg !1446
  tail call void @llvm.dbg.value(metadata i8* %switch_membership_d, i64 0, metadata !1431, metadata !1160), !dbg !1447
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() #7, !dbg !1448, !range !1484
  %1 = tail call i32 @llvm.nvvm.read.ptx.sreg.nctaid.x() #7, !dbg !1485, !range !1530
  %2 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.y() #7, !dbg !1531, !range !1535
  %mul = mul i32 %2, %1, !dbg !1536
  %add = add i32 %mul, %0, !dbg !1537
  tail call void @llvm.dbg.value(metadata i32 %add, i64 0, metadata !1432, metadata !1160), !dbg !1538
  %3 = tail call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() #7, !dbg !1539, !range !1567
  %mul4 = mul i32 %add, %3, !dbg !1568
  %4 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #7, !dbg !1569, !range !1597
  %add6 = add i32 %mul4, %4, !dbg !1598
  tail call void @llvm.dbg.value(metadata i32 %add6, i64 0, metadata !1433, metadata !1160), !dbg !1599
  %cmp = icmp slt i32 %add6, %num, !dbg !1600
  br i1 %cmp, label %if.then, label %if.end34, !dbg !1601

if.then:                                          ; preds = %entry
  %mul7 = mul nsw i32 %add6, %stride, !dbg !1602
  %idxprom = sext i32 %mul7 to i64, !dbg !1603
  %arrayidx = getelementptr inbounds float, float* %work_mem_d, i64 %idxprom, !dbg !1603
  tail call void @llvm.dbg.value(metadata float* %arrayidx, i64 0, metadata !1434, metadata !1160), !dbg !1604
  %conv = trunc i64 %x to i32, !dbg !1605
  tail call void @llvm.dbg.value(metadata i32 %add6, i64 0, metadata !1371, metadata !1160), !dbg !1606
  tail call void @llvm.dbg.value(metadata i32 %conv, i64 0, metadata !1372, metadata !1160), !dbg !1608
  tail call void @llvm.dbg.value(metadata i32 %num, i64 0, metadata !1373, metadata !1160), !dbg !1609
  tail call void @llvm.dbg.value(metadata i32 %dim, i64 0, metadata !1374, metadata !1160), !dbg !1610
  tail call void @llvm.dbg.value(metadata float* %coord_d, i64 0, metadata !1375, metadata !1160), !dbg !1611
  tail call void @llvm.dbg.value(metadata float 0.000000e+00, i64 0, metadata !1376, metadata !1160), !dbg !1612
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !1377, metadata !1160), !dbg !1613
  %cmp18.i = icmp sgt i32 %dim, 0, !dbg !1614
  br i1 %cmp18.i, label %for.body.i.preheader, label %_Z6d_distiiiiPf.exit, !dbg !1615

for.body.i.preheader:                             ; preds = %if.then
  %xtraiter = and i32 %dim, 1, !dbg !1616
  %lcmp.mod = icmp eq i32 %xtraiter, 0, !dbg !1616
  br i1 %lcmp.mod, label %for.body.i.prol.loopexit, label %for.body.i.prol.preheader, !dbg !1616

for.body.i.prol.preheader:                        ; preds = %for.body.i.preheader
  br label %for.body.i.prol, !dbg !1616

for.body.i.prol:                                  ; preds = %for.body.i.prol.preheader
  %add.i.prol = add i32 %mul4, %4, !dbg !1617
  %idxprom.i.prol = sext i32 %add.i.prol to i64, !dbg !1618
  %arrayidx.i.prol = getelementptr inbounds float, float* %coord_d, i64 %idxprom.i.prol, !dbg !1618
  %5 = bitcast float* %arrayidx.i.prol to i8*, !dbg !1618
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %5, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @18, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @19, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @20, i32 0, i32 0), i32 53, i32 15, i32 6, i32 4), !dbg !1618
  %6 = load float, float* %arrayidx.i.prol, align 4, !dbg !1618, !tbaa !1394
  %sext = shl i64 %x, 32, !dbg !1619
  %idxprom4.i.prol = ashr exact i64 %sext, 32, !dbg !1619
  %arrayidx5.i.prol = getelementptr inbounds float, float* %coord_d, i64 %idxprom4.i.prol, !dbg !1619
  %7 = bitcast float* %arrayidx5.i.prol to i8*, !dbg !1619
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %7, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @21, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @22, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @23, i32 0, i32 0), i32 53, i32 37, i32 7, i32 4), !dbg !1619
  %8 = load float, float* %arrayidx5.i.prol, align 4, !dbg !1619, !tbaa !1394
  %sub.i.prol = fsub float %6, %8, !dbg !1620
  tail call void @llvm.dbg.value(metadata float %sub.i.prol, i64 0, metadata !1379, metadata !1160), !dbg !1621
  %mul6.i.prol = fmul float %sub.i.prol, %sub.i.prol, !dbg !1622
  %add7.i.prol = fadd float %mul6.i.prol, 0.000000e+00, !dbg !1623
  tail call void @llvm.dbg.value(metadata float %add7.i.prol, i64 0, metadata !1376, metadata !1160), !dbg !1612
  tail call void @llvm.dbg.value(metadata i32 1, i64 0, metadata !1377, metadata !1160), !dbg !1613
  br label %for.body.i.prol.loopexit, !dbg !1615
...
for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.i.preheader
  ...
  %9 = icmp eq i32 %dim, 1, !dbg !1616
  br i1 %9, label %_Z6d_distiiiiPf.exit.loopexit, label %for.body.i.preheader.new, !dbg !1616

for.body.i.preheader.new:                         ; preds = %for.body.i.prol.loopexit
  br label %for.body.i, !dbg !1616

for.body.i:                                       ; preds = %for.body.i, %for.body.i.preheader.new
  %inc.sink20.i = phi i32 [ %inc.sink20.i.unr, %for.body.i.preheader.new ], [ %inc.i.1, %for.body.i ], !dbg !1624
  %retval1.019.i = phi float [ %retval1.019.i.unr, %for.body.i.preheader.new ], [ %add7.i.1, %for.body.i ], !dbg !1624
  %mul.i = mul nsw i32 %inc.sink20.i, %num, !dbg !1616
  %add.i = add nsw i32 %mul.i, %add6, !dbg !1617
  %idxprom.i = sext i32 %add.i to i64, !dbg !1618
  %arrayidx.i = getelementptr inbounds float, float* %coord_d, i64 %idxprom.i, !dbg !1618
  %10 = bitcast float* %arrayidx.i to i8*, !dbg !1618
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %10, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @24, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @25, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @26, i32 0, i32 0), i32 53, i32 15, i32 8, i32 4), !dbg !1618
  %11 = load float, float* %arrayidx.i, align 4, !dbg !1618, !tbaa !1394
  %add3.i = add nsw i32 %mul.i, %conv, !dbg !1625
  %idxprom4.i = sext i32 %add3.i to i64, !dbg !1619
  %arrayidx5.i = getelementptr inbounds float, float* %coord_d, i64 %idxprom4.i, !dbg !1619
  %12 = bitcast float* %arrayidx5.i to i8*, !dbg !1619
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %12, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @27, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @28, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @29, i32 0, i32 0), i32 53, i32 37, i32 9, i32 4), !dbg !1619
  %13 = load float, float* %arrayidx5.i, align 4, !dbg !1619, !tbaa !1394
  %sub.i = fsub float %11, %13, !dbg !1620
  tail call void @llvm.dbg.value(metadata float %sub.i, i64 0, metadata !1379, metadata !1160), !dbg !1621
  %mul6.i = fmul float %sub.i, %sub.i, !dbg !1622
  %add7.i = fadd float %retval1.019.i, %mul6.i, !dbg !1623
  tail call void @llvm.dbg.value(metadata float %add7.i, i64 0, metadata !1376, metadata !1160), !dbg !1612
  %inc.i = add nuw nsw i32 %inc.sink20.i, 1, !dbg !1626
  tail call void @llvm.dbg.value(metadata i32 %inc.i, i64 0, metadata !1377, metadata !1160), !dbg !1613
  %mul.i.1 = mul nsw i32 %inc.i, %num, !dbg !1616
  %add.i.1 = add nsw i32 %mul.i.1, %add6, !dbg !1617
  %idxprom.i.1 = sext i32 %add.i.1 to i64, !dbg !1618
  %arrayidx.i.1 = getelementptr inbounds float, float* %coord_d, i64 %idxprom.i.1, !dbg !1618
  %14 = bitcast float* %arrayidx.i.1 to i8*, !dbg !1618
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %14, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @30, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @31, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @32, i32 0, i32 0), i32 53, i32 15, i32 10, i32 4), !dbg !1618
  %15 = load float, float* %arrayidx.i.1, align 4, !dbg !1618, !tbaa !1394
  %add3.i.1 = add nsw i32 %mul.i.1, %conv, !dbg !1625
  %idxprom4.i.1 = sext i32 %add3.i.1 to i64, !dbg !1619
  %arrayidx5.i.1 = getelementptr inbounds float, float* %coord_d, i64 %idxprom4.i.1, !dbg !1619
  %16 = bitcast float* %arrayidx5.i.1 to i8*, !dbg !1619
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %16, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @33, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @34, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @35, i32 0, i32 0), i32 53, i32 37, i32 11, i32 4), !dbg !1619
  %17 = load float, float* %arrayidx5.i.1, align 4, !dbg !1619, !tbaa !1394
  %sub.i.1 = fsub float %15, %17, !dbg !1620
  tail call void @llvm.dbg.value(metadata float %sub.i, i64 0, metadata !1379, metadata !1160), !dbg !1621
  %mul6.i.1 = fmul float %sub.i.1, %sub.i.1, !dbg !1622
  %add7.i.1 = fadd float %add7.i, %mul6.i.1, !dbg !1623
  tail call void @llvm.dbg.value(metadata float %add7.i, i64 0, metadata !1376, metadata !1160), !dbg !1612
  %inc.i.1 = add nsw i32 %inc.sink20.i, 2, !dbg !1626
  tail call void @llvm.dbg.value(metadata i32 %inc.i, i64 0, metadata !1377, metadata !1160), !dbg !1613
  %exitcond.i.1 = icmp eq i32 %inc.i.1, %dim, !dbg !1615
  br i1 %exitcond.i.1, label %_Z6d_distiiiiPf.exit.loopexit.unr-lcssa, label %for.body.i, !dbg !1615, !llvm.loop !1406

_Z6d_distiiiiPf.exit.loopexit.unr-lcssa:          ; preds = %for.body.i
  br label %_Z6d_distiiiiPf.exit.loopexit, !dbg !1627
...
_Z6d_distiiiiPf.exit.loopexit:                    ; preds = %_Z6d_distiiiiPf.exit.loopexit.unr-lcssa, %for.body.i.prol.loopexit
  ...
  br label %_Z6d_distiiiiPf.exit, !dbg !1627

_Z6d_distiiiiPf.exit:                             ; preds = %_Z6d_distiiiiPf.exit.loopexit, %if.then
  %retval1.0.lcssa.i = phi float [ 0.000000e+00, %if.then ], [ %add7.i.lcssa, %_Z6d_distiiiiPf.exit.loopexit ], !dbg !1624
  %idxprom9 = sext i32 %add6 to i64, !dbg !1627
  %weight = getelementptr inbounds %struct.Point, %struct.Point* %p, i64 %idxprom9, i32 0, !dbg !1628
  %18 = bitcast float* %weight to i8*, !dbg !1628
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %18, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @36, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @37, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @38, i32 0, i32 0), i32 75, i32 61, i32 12, i32 4), !dbg !1628
  %19 = load float, float* %weight, align 8, !dbg !1628, !tbaa !1629
  %mul11 = fmul float %retval1.0.lcssa.i, %19, !dbg !1632
  tail call void @llvm.dbg.value(metadata float %mul11, i64 0, metadata !1437, metadata !1160), !dbg !1633
  %cost = getelementptr inbounds %struct.Point, %struct.Point* %p, i64 %idxprom9, i32 3, !dbg !1634
  %20 = bitcast float* %cost to i8*, !dbg !1636
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %20, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @39, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @40, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @41, i32 0, i32 0), i32 81, i32 32, i32 13, i32 4), !dbg !1636
  %21 = load float, float* %cost, align 8, !dbg !1636, !tbaa !1638
  %cmp14 = fcmp olt float %mul11, %21, !dbg !1639
  br i1 %cmp14, label %if.then15, label %if.else, !dbg !1640

if.then15:                                        ; preds = %_Z6d_distiiiiPf.exit
  %arrayidx17 = getelementptr inbounds i8, i8* %switch_membership_d, i64 %idxprom9, !dbg !1641
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %arrayidx17, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @42, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @43, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @44, i32 0, i32 0), i32 80, i32 29, i32 14, i32 1), !dbg !1642
  store i8 1, i8* %arrayidx17, align 1, !dbg !1642, !tbaa !1643
  %sub = fsub float %mul11, %21, !dbg !1645
  %idxprom21 = sext i32 %K to i64, !dbg !1646
  %arrayidx22 = getelementptr inbounds float, float* %arrayidx, i64 %idxprom21, !dbg !1646
  %22 = bitcast float* %arrayidx22 to i8*, !dbg !1647
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %22, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @45, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @46, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @47, i32 0, i32 0), i32 81, i32 13, i32 15, i32 4), !dbg !1647
  %23 = load float, float* %arrayidx22, align 4, !dbg !1647, !tbaa !1394
  %add23 = fadd float %23, %sub, !dbg !1647
  %24 = bitcast float* %arrayidx22 to i8*, !dbg !1647
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %24, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @48, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @49, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @50, i32 0, i32 0), i32 81, i32 13, i32 16, i32 4), !dbg !1647
  store float %add23, float* %arrayidx22, align 4, !dbg !1647, !tbaa !1394
  br label %if.end34, !dbg !1648

if.else:                                          ; preds = %_Z6d_distiiiiPf.exit
  %sub27 = fsub float %21, %mul11, !dbg !1649
  %assign = getelementptr inbounds %struct.Point, %struct.Point* %p, i64 %idxprom9, i32 2, !dbg !1651
  %25 = bitcast i64* %assign to i8*, !dbg !1651
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %25, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @51, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @52, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @53, i32 0, i32 0), i32 86, i32 32, i32 17, i32 8), !dbg !1651
  %26 = load i64, i64* %assign, align 8, !dbg !1651, !tbaa !1652
  %arrayidx30 = getelementptr inbounds i32, i32* %center_table_d, i64 %26, !dbg !1653
  %27 = bitcast i32* %arrayidx30 to i8*, !dbg !1653
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %27, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @54, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @55, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @56, i32 0, i32 0), i32 86, i32 10, i32 18, i32 4), !dbg !1653
  %28 = load i32, i32* %arrayidx30, align 4, !dbg !1653, !tbaa !1654
  %idxprom31 = sext i32 %28 to i64, !dbg !1656
  %arrayidx32 = getelementptr inbounds float, float* %arrayidx, i64 %idxprom31, !dbg !1656
  %29 = bitcast float* %arrayidx32 to i8*, !dbg !1657
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %29, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @57, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @58, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @59, i32 0, i32 0), i32 86, i32 41, i32 19, i32 4), !dbg !1657
  %30 = load float, float* %arrayidx32, align 4, !dbg !1657, !tbaa !1394
  %add33 = fadd float %sub27, %30, !dbg !1657
  %31 = bitcast float* %arrayidx32 to i8*, !dbg !1657
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %31, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @60, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @61, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @62, i32 0, i32 0), i32 86, i32 41, i32 20, i32 4), !dbg !1657
  store float %add33, float* %arrayidx32, align 4, !dbg !1657, !tbaa !1394
  br label %if.end34
...
!722 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 108, baseType: !332)
...
!1169 = !{!1170, !1171, !1172, !1173, !1174, !1175, !1176, !1177, !1178, !1179, !1180, !1184, !1185, !1187, !1189, !1194, !1195, !1198, !1200, !1201, !1203, !1207, !1209}
...
!1200 = !DILocalVariable(name: "myNone", scope: !1196, file: !5, line: 88, type: !4)
!1201 = !DILocalVariable(name: "i", scope: !1202, file: !5, line: 90, type: !9)
!1202 = distinct !DILexicalBlock(scope: !1196, file: !5, line: 90, column: 5)
!1203 = !DILocalVariable(name: "current", scope: !1204, file: !5, line: 92, type: !4)
!1204 = distinct !DILexicalBlock(scope: !1205, file: !5, line: 91, column: 33)
!1205 = distinct !DILexicalBlock(scope: !1206, file: !5, line: 91, column: 10)
!1206 = distinct !DILexicalBlock(scope: !1202, file: !5, line: 90, column: 5)
!1207 = !DILocalVariable(name: "j", scope: !1208, file: !5, line: 95, type: !9)
!1208 = distinct !DILexicalBlock(scope: !1204, file: !5, line: 95, column: 9)
!1209 = !DILocalVariable(name: "str", scope: !1196, file: !5, line: 102, type: !332)
!1210 = !DILocation(line: 34, column: 39, scope: !1166)
!1211 = !DILocation(line: 34, column: 55, scope: !1166)
!1212 = !DILocation(line: 34, column: 73, scope: !1166)
!1213 = !DILocation(line: 35, column: 39, scope: !1166)
!1214 = !DILocation(line: 35, column: 56, scope: !1166)
!1215 = !DILocation(line: 35, column: 69, scope: !1166)
!1216 = !DILocation(line: 36, column: 37, scope: !1166)
!1217 = !DILocation(line: 36, column: 52, scope: !1166)
!1218 = !DILocalVariable(name: "ptr", arg: 1, scope: !1219, file: !1220, line: 100, type: !304)
!1219 = distinct !DISubprogram(name: "__isGlobal", linkageName: "_ZL10__isGlobalPKv", scope: !1220, file: !1220, line: 100, type: !1221, isLocal: true, isDefinition: true, scopeLine: 101, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1223)
!1220 = !DIFile(filename: "/usr/local/cuda/include/sm_20_intrinsics.hpp", directory: "/home/ec2-user/DynamicAnalyis")
!1221 = !DISubroutineType(types: !1222)
!1222 = !{!375, !304}
!1223 = !{!1218, !1224}
!1224 = !DILocalVariable(name: "ret", scope: !1219, file: !1220, line: 102, type: !375)
!1225 = !DILocation(line: 100, column: 63, scope: !1219, inlinedAt: !1226)
!1226 = distinct !DILocation(line: 38, column: 11, scope: !1227)
!1227 = distinct !DILexicalBlock(scope: !1166, file: !5, line: 38, column: 6)
!1228 = !DILocation(line: 103, column: 5, scope: !1219, inlinedAt: !1226)
!1229 = !{i32 3111452, i32 3111457, i32 3111500, i32 3111552, i32 3111604, i32 3111722}
!1230 = !DILocation(line: 102, column: 18, scope: !1219, inlinedAt: !1226)
!1231 = !DILocation(line: 38, column: 8, scope: !1227)
!1232 = !DILocation(line: 38, column: 6, scope: !1166)
!1233 = !DILocalVariable(name: "a", arg: 1, scope: !1234, file: !473, line: 328, type: !9)
!1234 = distinct !DISubprogram(name: "__ballot", linkageName: "_ZL8__balloti", scope: !473, file: !473, line: 328, type: !281, isLocal: true, isDefinition: true, scopeLine: 329, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1235)
!1235 = !{!1233, !1236}
!1236 = !DILocalVariable(name: "result", scope: !1234, file: !473, line: 330, type: !9)
!1237 = !DILocation(line: 328, column: 14, scope: !1234, inlinedAt: !1238)
!1238 = distinct !DILocation(line: 43, column: 22, scope: !1166)
!1239 = !DILocation(line: 331, column: 3, scope: !1234, inlinedAt: !1238)
!1240 = !{i32 2337164, i32 2337169, i32 2337203, i32 2337245, i32 2337288}
!1241 = !DILocation(line: 330, column: 7, scope: !1234, inlinedAt: !1238)
!1242 = !DILocation(line: 43, column: 7, scope: !1166)
!1243 = !DILocation(line: 47, column: 19, scope: !1166)
!1244 = !DILocation(line: 47, column: 9, scope: !1166)
!1245 = !DILocation(line: 52, column: 3, scope: !1166)
!1246 = !DILocation(line: 52, column: 9, scope: !1166)
!1247 = !DILocation(line: 55, column: 7, scope: !1166)
!1248 = !DILocation(line: 56, column: 11, scope: !1186)
!1249 = !DILocation(line: 56, column: 3, scope: !1250)
!1250 = !DILexicalBlockFile(scope: !1251, file: !5, discriminator: 1)
!1251 = distinct !DILexicalBlock(scope: !1186, file: !5, line: 56, column: 3)
!1252 = !DILocation(line: 57, column: 36, scope: !1253)
!1253 = distinct !DILexicalBlock(scope: !1251, file: !5, line: 57, column: 8)
!1254 = !DILocation(line: 57, column: 8, scope: !1251)
!1255 = !DILocation(line: 56, column: 34, scope: !1256)
!1256 = !DILexicalBlockFile(scope: !1251, file: !5, discriminator: 3)
!1257 = !DILocation(line: 64, column: 11, scope: !1188)
!1258 = !DILocation(line: 69, column: 31, scope: !1190)
!1259 = !DILocation(line: 69, column: 22, scope: !1190)
!1260 = !DILocation(line: 70, column: 17, scope: !1190)
!1261 = !DILocation(line: 64, column: 3, scope: !1262)
!1262 = !DILexicalBlockFile(scope: !1193, file: !5, discriminator: 1)
!1263 = !DILocation(line: 20, column: 3, scope: !1264, inlinedAt: !1270)
!1264 = distinct !DISubprogram(name: "getLaneId", linkageName: "_ZL9getLaneIdv", scope: !5, file: !5, line: 18, type: !1265, isLocal: true, isDefinition: true, scopeLine: 18, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1268)
!1265 = !DISubroutineType(types: !1266)
!1266 = !{!1267}
!1267 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !7, line: 51, baseType: !375)
!1268 = !{!1269}
!1269 = !DILocalVariable(name: "laneId", scope: !1264, file: !5, line: 19, type: !1267)
!1270 = distinct !DILocation(line: 77, column: 22, scope: !1197)
!1271 = !{i32 4150674}
!1272 = !DILocation(line: 19, column: 12, scope: !1264, inlinedAt: !1270)
!1273 = !DILocation(line: 77, column: 19, scope: !1197)
!1274 = !DILocation(line: 77, column: 6, scope: !1166)
!1275 = !DILocation(line: 82, column: 13, scope: !1199)
!1276 = !DILocation(line: 83, column: 50, scope: !1277)
!1277 = distinct !DILexicalBlock(scope: !1278, file: !5, line: 82, column: 39)
!1278 = distinct !DILexicalBlock(scope: !1199, file: !5, line: 82, column: 5)
!1279 = !DILocation(line: 83, column: 48, scope: !1277)
!1280 = !DILocation(line: 82, column: 5, scope: !1281)
!1281 = !DILexicalBlockFile(scope: !1278, file: !5, discriminator: 1)
!1282 = !DILocation(line: 65, column: 36, scope: !1191)
!1283 = !DILocation(line: 65, column: 8, scope: !1192)
!1284 = !DILocation(line: 66, column: 19, scope: !1191)
!1285 = !DILocation(line: 66, column: 7, scope: !1191)
!1286 = !DILocation(line: 66, column: 24, scope: !1191)
!1287 = !{!1288, !1288, i64 0}
!1288 = !{!"long", !1289, i64 0}
!1289 = !{!"omnipotent char", !1290, i64 0}
!1290 = !{!"Simple C++ TBAA"}
!1291 = !DILocation(line: 69, column: 11, scope: !1190)
!1292 = !DILocation(line: 70, column: 11, scope: !1190)
!1293 = !DILocalVariable(name: "__in", arg: 1, scope: !1294, file: !1295, line: 84, type: !9)
!1294 = distinct !DISubprogram(name: "__shfl", linkageName: "_Z6__shfliii", scope: !1295, file: !1295, line: 84, type: !1296, isLocal: false, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1298)
!1295 = !DIFile(filename: "/usr/local/bin/../lib/clang/4.0.0/include/__clang_cuda_intrinsics.h", directory: "/home/ec2-user/DynamicAnalyis")
!1296 = !DISubroutineType(types: !1297)
!1297 = !{!9, !9, !9, !9}
!1298 = !{!1293, !1299, !1300}
!1299 = !DILocalVariable(name: "__offset", arg: 2, scope: !1294, file: !1295, line: 84, type: !9)
!1300 = !DILocalVariable(name: "__width", arg: 3, scope: !1294, file: !1295, line: 84, type: !9)
!1301 = !DILocation(line: 84, column: 1, scope: !1294, inlinedAt: !1302)
!1302 = distinct !DILocation(line: 71, column: 13, scope: !1190)
!1303 = !DILocation(line: 84, column: 1, scope: !1294, inlinedAt: !1304)
!1304 = distinct !DILocation(line: 72, column: 13, scope: !1190)
!1305 = !DILocation(line: 73, column: 36, scope: !1190)
!1306 = !DILocation(line: 73, column: 41, scope: !1190)
!1307 = !DILocation(line: 73, column: 58, scope: !1190)
!1308 = !DILocation(line: 73, column: 48, scope: !1190)
!1309 = !DILocation(line: 73, column: 19, scope: !1190)
!1310 = !DILocation(line: 73, column: 7, scope: !1190)
!1311 = !DILocation(line: 73, column: 24, scope: !1190)
!1312 = !DILocation(line: 64, column: 34, scope: !1313)
!1313 = !DILexicalBlockFile(scope: !1193, file: !5, discriminator: 3)
!1314 = distinct !{!1314, !1315}
!1315 = !DILocation(line: 64, column: 3, scope: !1166)
!1316 = !DILocation(line: 88, column: 20, scope: !1196)
!1317 = !DILocation(line: 88, column: 11, scope: !1196)
!1318 = !DILocation(line: 90, column: 13, scope: !1202)
!1319 = !DILocation(line: 90, column: 5, scope: !1320)
!1320 = !DILexicalBlockFile(scope: !1206, file: !5, discriminator: 1)
!1321 = !DILocation(line: 83, column: 43, scope: !1277)
!1322 = !DILocation(line: 83, column: 31, scope: !1277)
!1323 = !DILocation(line: 83, column: 59, scope: !1277)
!1324 = !DILocation(line: 83, column: 64, scope: !1277)
!1325 = !DILocation(line: 83, column: 23, scope: !1277)
!1326 = !DILocation(line: 83, column: 7, scope: !1277)
!1327 = !DILocation(line: 83, column: 28, scope: !1277)
!1328 = !DILocation(line: 84, column: 24, scope: !1277)
!1329 = !DILocation(line: 82, column: 36, scope: !1330)
!1330 = !DILexicalBlockFile(scope: !1278, file: !5, discriminator: 3)
!1331 = distinct !{!1331, !1332}
!1332 = !DILocation(line: 82, column: 5, scope: !1196)
!1333 = !DILocation(line: 102, column: 11, scope: !1196)
!1334 = !DILocation(line: 103, column: 5, scope: !1196)
!1335 = !DILocation(line: 105, column: 3, scope: !1196)
!1336 = !DILocation(line: 91, column: 10, scope: !1205)
!1337 = !DILocation(line: 91, column: 23, scope: !1205)
!1338 = !DILocation(line: 91, column: 10, scope: !1206)
!1339 = !DILocation(line: 90, column: 40, scope: !1340)
!1340 = !DILexicalBlockFile(scope: !1206, file: !5, discriminator: 3)
!1341 = !DILocation(line: 92, column: 15, scope: !1204)
!1342 = !DILocation(line: 93, column: 14, scope: !1204)
!1343 = !DILocation(line: 79, column: 9, scope: !1196)
!1344 = !DILocation(line: 95, column: 48, scope: !1345)
!1345 = !DILexicalBlockFile(scope: !1346, file: !5, discriminator: 3)
!1346 = distinct !DILexicalBlock(scope: !1208, file: !5, line: 95, column: 9)
!1347 = !DILocation(line: 95, column: 17, scope: !1208)
!1348 = !DILocation(line: 95, column: 30, scope: !1349)
!1349 = !DILexicalBlockFile(scope: !1346, file: !5, discriminator: 1)
!1350 = !DILocation(line: 95, column: 9, scope: !1349)
!1351 = !DILocation(line: 96, column: 14, scope: !1352)
!1352 = distinct !DILexicalBlock(scope: !1346, file: !5, line: 96, column: 14)
!1353 = !DILocation(line: 96, column: 27, scope: !1352)
!1354 = !DILocation(line: 96, column: 14, scope: !1346)
!1355 = !DILocation(line: 97, column: 26, scope: !1352)
!1356 = !DILocation(line: 97, column: 13, scope: !1352)
!1357 = distinct !{!1357, !1358}
!1358 = !{!"llvm.loop.unroll.disable"}
!1359 = distinct !{!1359, !1360}
!1360 = !DILocation(line: 90, column: 5, scope: !1196)
!1361 = !DILocation(line: 108, column: 1, scope: !1166)
!1362 = !DILocation(line: 108, column: 1, scope: !1363)
!1363 = !DILexicalBlockFile(scope: !1166, file: !5, discriminator: 1)
!1364 = !DILocation(line: 56, column: 20, scope: !1250)
!1365 = distinct !{!1365, !1366}
!1366 = !DILocation(line: 56, column: 3, scope: !1166)
!1367 = distinct !DISubprogram(name: "d_dist", linkageName: "_Z6d_distiiiiPf", scope: !1, file: !1, line: 49, type: !1368, isLocal: false, isDefinition: true, scopeLine: 50, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1370)
!1368 = !DISubroutineType(types: !1369)
!1369 = !{!26, !9, !9, !9, !9, !154}
!1370 = !{!1371, !1372, !1373, !1374, !1375, !1376, !1377, !1379}
!1371 = !DILocalVariable(name: "p1", arg: 1, scope: !1367, file: !1, line: 49, type: !9)
!1372 = !DILocalVariable(name: "p2", arg: 2, scope: !1367, file: !1, line: 49, type: !9)
!1373 = !DILocalVariable(name: "num", arg: 3, scope: !1367, file: !1, line: 49, type: !9)
!1374 = !DILocalVariable(name: "dim", arg: 4, scope: !1367, file: !1, line: 49, type: !9)
!1375 = !DILocalVariable(name: "coord_d", arg: 5, scope: !1367, file: !1, line: 49, type: !154)
!1376 = !DILocalVariable(name: "retval", scope: !1367, file: !1, line: 51, type: !26)
!1377 = !DILocalVariable(name: "i", scope: !1378, file: !1, line: 52, type: !9)
!1378 = distinct !DILexicalBlock(scope: !1367, file: !1, line: 52, column: 2)
!1379 = !DILocalVariable(name: "tmp", scope: !1380, file: !1, line: 53, type: !26)
!1380 = distinct !DILexicalBlock(scope: !1381, file: !1, line: 52, column: 30)
!1381 = distinct !DILexicalBlock(scope: !1378, file: !1, line: 52, column: 2)
!1382 = !DILocation(line: 49, column: 12, scope: !1367)
!1383 = !DILocation(line: 49, column: 20, scope: !1367)
!1384 = !DILocation(line: 49, column: 28, scope: !1367)
!1385 = !DILocation(line: 49, column: 37, scope: !1367)
!1386 = !DILocation(line: 49, column: 49, scope: !1367)
!1387 = !DILocation(line: 51, column: 8, scope: !1367)
!1388 = !DILocation(line: 52, column: 10, scope: !1378)
!1389 = !DILocation(line: 52, column: 19, scope: !1390)
!1390 = !DILexicalBlockFile(scope: !1381, file: !1, discriminator: 1)
!1391 = !DILocation(line: 52, column: 2, scope: !1390)
!1392 = !DILocation(line: 53, column: 25, scope: !1380)
!1393 = !DILocation(line: 53, column: 15, scope: !1380)
!1394 = !{!1395, !1395, i64 0}
!1395 = !{!"float", !1289, i64 0}
!1396 = !DILocation(line: 53, column: 37, scope: !1380)
!1397 = !DILocation(line: 53, column: 35, scope: !1380)
!1398 = !DILocation(line: 53, column: 9, scope: !1380)
!1399 = !DILocation(line: 54, column: 17, scope: !1380)
!1400 = !DILocation(line: 54, column: 10, scope: !1380)
!1401 = !DILocation(line: 56, column: 2, scope: !1367)
!1402 = !DILocation(line: 53, column: 30, scope: !1380)
!1403 = !DILocation(line: 53, column: 52, scope: !1380)
!1404 = !DILocation(line: 52, column: 27, scope: !1405)
!1405 = !DILexicalBlockFile(scope: !1381, file: !1, discriminator: 3)
!1406 = distinct !{!1406, !1407}
!1407 = !DILocation(line: 52, column: 2, scope: !1367)
!1408 = distinct !DISubprogram(name: "kernel_compute_cost", linkageName: "_Z19kernel_compute_costiilP5PointiiPfS1_PiPb", scope: !1, file: !1, line: 63, type: !1409, isLocal: false, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !1421)
!1409 = !DISubroutineType(types: !1410)
!1410 = !{null, !9, !9, !119, !1411, !9, !9, !154, !154, !85, !1420}
!1411 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1412, size: 64, align: 64)
!1412 = !DIDerivedType(tag: DW_TAG_typedef, name: "Point", file: !1413, line: 44, baseType: !1414)
!1413 = !DIFile(filename: "Results/streamcluster/streamcluster_header.cu", directory: "/home/ec2-user/DynamicAnalyis")
!1414 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !1413, line: 39, size: 256, align: 64, elements: !1415, identifier: "_ZTS5Point")
!1415 = !{!1416, !1417, !1418, !1419}
!1416 = !DIDerivedType(tag: DW_TAG_member, name: "weight", scope: !1414, file: !1413, line: 40, baseType: !26, size: 32, align: 32)
!1417 = !DIDerivedType(tag: DW_TAG_member, name: "coord", scope: !1414, file: !1413, line: 41, baseType: !154, size: 64, align: 64, offset: 64)
!1418 = !DIDerivedType(tag: DW_TAG_member, name: "assign", scope: !1414, file: !1413, line: 42, baseType: !119, size: 64, align: 64, offset: 128)
!1419 = !DIDerivedType(tag: DW_TAG_member, name: "cost", scope: !1414, file: !1413, line: 43, baseType: !26, size: 32, align: 32, offset: 192)
!1420 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !94, size: 64, align: 64)
!1421 = !{!1422, !1423, !1424, !1425, !1426, !1427, !1428, !1429, !1430, !1431, !1432, !1433, !1434, !1437}
!1422 = !DILocalVariable(name: "num", arg: 1, scope: !1408, file: !1, line: 63, type: !9)
!1423 = !DILocalVariable(name: "dim", arg: 2, scope: !1408, file: !1, line: 63, type: !9)
!1424 = !DILocalVariable(name: "x", arg: 3, scope: !1408, file: !1, line: 63, type: !119)
!1425 = !DILocalVariable(name: "p", arg: 4, scope: !1408, file: !1, line: 63, type: !1411)
!1426 = !DILocalVariable(name: "K", arg: 5, scope: !1408, file: !1, line: 63, type: !9)
!1427 = !DILocalVariable(name: "stride", arg: 6, scope: !1408, file: !1, line: 63, type: !9)
!1428 = !DILocalVariable(name: "coord_d", arg: 7, scope: !1408, file: !1, line: 64, type: !154)
!1429 = !DILocalVariable(name: "work_mem_d", arg: 8, scope: !1408, file: !1, line: 64, type: !154)
!1430 = !DILocalVariable(name: "center_table_d", arg: 9, scope: !1408, file: !1, line: 64, type: !85)
!1431 = !DILocalVariable(name: "switch_membership_d", arg: 10, scope: !1408, file: !1, line: 64, type: !1420)
!1432 = !DILocalVariable(name: "bid", scope: !1408, file: !1, line: 67, type: !13)
!1433 = !DILocalVariable(name: "tid", scope: !1408, file: !1, line: 68, type: !13)
!1434 = !DILocalVariable(name: "lower", scope: !1435, file: !1, line: 72, type: !154)
!1435 = distinct !DILexicalBlock(scope: !1436, file: !1, line: 71, column: 2)
!1436 = distinct !DILexicalBlock(scope: !1408, file: !1, line: 70, column: 5)
!1437 = !DILocalVariable(name: "x_cost", scope: !1435, file: !1, line: 75, type: !26)
!1438 = !DILocation(line: 63, column: 25, scope: !1408)
!1439 = !DILocation(line: 63, column: 34, scope: !1408)
!1440 = !DILocation(line: 63, column: 44, scope: !1408)
!1441 = !DILocation(line: 63, column: 54, scope: !1408)
!1442 = !DILocation(line: 63, column: 61, scope: !1408)
!1443 = !DILocation(line: 63, column: 68, scope: !1408)
!1444 = !DILocation(line: 64, column: 13, scope: !1408)
!1445 = !DILocation(line: 64, column: 29, scope: !1408)
!1446 = !DILocation(line: 64, column: 46, scope: !1408)
!1447 = !DILocation(line: 64, column: 68, scope: !1408)
!1448 = !DILocation(line: 78, column: 3, scope: !1449, inlinedAt: !1483)
!1449 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !1450, file: !12, line: 78, type: !1453, isLocal: false, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !1452, variables: !2)
!1450 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_blockIdx_t", file: !12, line: 77, size: 8, align: 8, elements: !1451, identifier: "_ZTS25__cuda_builtin_blockIdx_t")
!1451 = !{!1452, !1455, !1456, !1457, !1468, !1472, !1476, !1479}
!1452 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !1450, file: !12, line: 78, type: !1453, isLocal: false, isDefinition: false, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true)
!1453 = !DISubroutineType(types: !1454)
!1454 = !{!375}
!1455 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !1450, file: !12, line: 79, type: !1453, isLocal: false, isDefinition: false, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: true)
!1456 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_zEv", scope: !1450, file: !12, line: 80, type: !1453, isLocal: false, isDefinition: false, scopeLine: 80, flags: DIFlagPrototyped, isOptimized: true)
!1457 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK25__cuda_builtin_blockIdx_tcv5uint3Ev", scope: !1450, file: !12, line: 83, type: !1458, isLocal: false, isDefinition: false, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true)
!1458 = !DISubroutineType(types: !1459)
!1459 = !{!1460, !1466}
!1460 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uint3", file: !1461, line: 190, size: 96, align: 32, elements: !1462, identifier: "_ZTS5uint3")
!1461 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
!1462 = !{!1463, !1464, !1465}
!1463 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !1460, file: !1461, line: 192, baseType: !375, size: 32, align: 32)
!1464 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !1460, file: !1461, line: 192, baseType: !375, size: 32, align: 32, offset: 32)
!1465 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !1460, file: !1461, line: 192, baseType: !375, size: 32, align: 32, offset: 64)
!1466 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1467, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1467 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1450)
!1468 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !1450, file: !12, line: 85, type: !1469, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1469 = !DISubroutineType(types: !1470)
!1470 = !{null, !1471}
!1471 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1450, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1472 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !1450, file: !12, line: 85, type: !1473, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1473 = !DISubroutineType(types: !1474)
!1474 = !{null, !1471, !1475}
!1475 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1467, size: 64, align: 64)
!1476 = !DISubprogram(name: "operator=", linkageName: "_ZNK25__cuda_builtin_blockIdx_taSERKS_", scope: !1450, file: !12, line: 85, type: !1477, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1477 = !DISubroutineType(types: !1478)
!1478 = !{null, !1466, !1475}
!1479 = !DISubprogram(name: "operator&", linkageName: "_ZNK25__cuda_builtin_blockIdx_tadEv", scope: !1450, file: !12, line: 85, type: !1480, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1480 = !DISubroutineType(types: !1481)
!1481 = !{!1482, !1466}
!1482 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1450, size: 64, align: 64)
!1483 = distinct !DILocation(line: 67, column: 19, scope: !1408)
!1484 = !{i32 0, i32 2147483647}
!1485 = !DILocation(line: 100, column: 3, scope: !1486, inlinedAt: !1528)
!1486 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN24__cuda_builtin_gridDim_t17__fetch_builtin_xEv", scope: !1487, file: !12, line: 100, type: !1453, isLocal: false, isDefinition: true, scopeLine: 100, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !1489, variables: !2)
!1487 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_gridDim_t", file: !12, line: 99, size: 8, align: 8, elements: !1488, identifier: "_ZTS24__cuda_builtin_gridDim_t")
!1488 = !{!1489, !1490, !1491, !1492, !1513, !1517, !1521, !1524}
!1489 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN24__cuda_builtin_gridDim_t17__fetch_builtin_xEv", scope: !1487, file: !12, line: 100, type: !1453, isLocal: false, isDefinition: false, scopeLine: 100, flags: DIFlagPrototyped, isOptimized: true)
!1490 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN24__cuda_builtin_gridDim_t17__fetch_builtin_yEv", scope: !1487, file: !12, line: 101, type: !1453, isLocal: false, isDefinition: false, scopeLine: 101, flags: DIFlagPrototyped, isOptimized: true)
!1491 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN24__cuda_builtin_gridDim_t17__fetch_builtin_zEv", scope: !1487, file: !12, line: 102, type: !1453, isLocal: false, isDefinition: false, scopeLine: 102, flags: DIFlagPrototyped, isOptimized: true)
!1492 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK24__cuda_builtin_gridDim_tcv4dim3Ev", scope: !1487, file: !12, line: 105, type: !1493, isLocal: false, isDefinition: false, scopeLine: 105, flags: DIFlagPrototyped, isOptimized: true)
!1493 = !DISubroutineType(types: !1494)
!1494 = !{!1495, !1511}
!1495 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "dim3", file: !1461, line: 417, size: 96, align: 32, elements: !1496, identifier: "_ZTS4dim3")
!1496 = !{!1497, !1498, !1499, !1500, !1504, !1508}
!1497 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !1495, file: !1461, line: 419, baseType: !375, size: 32, align: 32)
!1498 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !1495, file: !1461, line: 419, baseType: !375, size: 32, align: 32, offset: 32)
!1499 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !1495, file: !1461, line: 419, baseType: !375, size: 32, align: 32, offset: 64)
!1500 = !DISubprogram(name: "dim3", scope: !1495, file: !1461, line: 421, type: !1501, isLocal: false, isDefinition: false, scopeLine: 421, flags: DIFlagPrototyped, isOptimized: true)
!1501 = !DISubroutineType(types: !1502)
!1502 = !{null, !1503, !375, !375, !375}
!1503 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1495, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1504 = !DISubprogram(name: "dim3", scope: !1495, file: !1461, line: 422, type: !1505, isLocal: false, isDefinition: false, scopeLine: 422, flags: DIFlagPrototyped, isOptimized: true)
!1505 = !DISubroutineType(types: !1506)
!1506 = !{null, !1503, !1507}
!1507 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint3", file: !1461, line: 383, baseType: !1460)
!1508 = !DISubprogram(name: "operator uint3", linkageName: "_ZN4dim3cv5uint3Ev", scope: !1495, file: !1461, line: 423, type: !1509, isLocal: false, isDefinition: false, scopeLine: 423, flags: DIFlagPrototyped, isOptimized: true)
!1509 = !DISubroutineType(types: !1510)
!1510 = !{!1507, !1503}
!1511 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1512, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1512 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1487)
!1513 = !DISubprogram(name: "__cuda_builtin_gridDim_t", scope: !1487, file: !12, line: 107, type: !1514, isLocal: false, isDefinition: false, scopeLine: 107, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1514 = !DISubroutineType(types: !1515)
!1515 = !{null, !1516}
!1516 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1487, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1517 = !DISubprogram(name: "__cuda_builtin_gridDim_t", scope: !1487, file: !12, line: 107, type: !1518, isLocal: false, isDefinition: false, scopeLine: 107, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1518 = !DISubroutineType(types: !1519)
!1519 = !{null, !1516, !1520}
!1520 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1512, size: 64, align: 64)
!1521 = !DISubprogram(name: "operator=", linkageName: "_ZNK24__cuda_builtin_gridDim_taSERKS_", scope: !1487, file: !12, line: 107, type: !1522, isLocal: false, isDefinition: false, scopeLine: 107, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1522 = !DISubroutineType(types: !1523)
!1523 = !{null, !1511, !1520}
!1524 = !DISubprogram(name: "operator&", linkageName: "_ZNK24__cuda_builtin_gridDim_tadEv", scope: !1487, file: !12, line: 107, type: !1525, isLocal: false, isDefinition: false, scopeLine: 107, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1525 = !DISubroutineType(types: !1526)
!1526 = !{!1527, !1511}
!1527 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1487, size: 64, align: 64)
!1528 = distinct !DILocation(line: 67, column: 32, scope: !1529)
!1529 = !DILexicalBlockFile(scope: !1408, file: !1, discriminator: 1)
!1530 = !{i32 1, i32 -2147483648}
!1531 = !DILocation(line: 79, column: 3, scope: !1532, inlinedAt: !1533)
!1532 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !1450, file: !12, line: 79, type: !1453, isLocal: false, isDefinition: true, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !1455, variables: !2)
!1533 = distinct !DILocation(line: 67, column: 44, scope: !1534)
!1534 = !DILexicalBlockFile(scope: !1408, file: !1, discriminator: 2)
!1535 = !{i32 0, i32 65535}
!1536 = !DILocation(line: 67, column: 42, scope: !1408)
!1537 = !DILocation(line: 67, column: 30, scope: !1408)
!1538 = !DILocation(line: 67, column: 12, scope: !1408)
!1539 = !DILocation(line: 89, column: 3, scope: !1540, inlinedAt: !1566)
!1540 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !1541, file: !12, line: 89, type: !1453, isLocal: false, isDefinition: true, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !1543, variables: !2)
!1541 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_blockDim_t", file: !12, line: 88, size: 8, align: 8, elements: !1542, identifier: "_ZTS25__cuda_builtin_blockDim_t")
!1542 = !{!1543, !1544, !1545, !1546, !1551, !1555, !1559, !1562}
!1543 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !1541, file: !12, line: 89, type: !1453, isLocal: false, isDefinition: false, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true)
!1544 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv", scope: !1541, file: !12, line: 90, type: !1453, isLocal: false, isDefinition: false, scopeLine: 90, flags: DIFlagPrototyped, isOptimized: true)
!1545 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_zEv", scope: !1541, file: !12, line: 91, type: !1453, isLocal: false, isDefinition: false, scopeLine: 91, flags: DIFlagPrototyped, isOptimized: true)
!1546 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK25__cuda_builtin_blockDim_tcv4dim3Ev", scope: !1541, file: !12, line: 94, type: !1547, isLocal: false, isDefinition: false, scopeLine: 94, flags: DIFlagPrototyped, isOptimized: true)
!1547 = !DISubroutineType(types: !1548)
!1548 = !{!1495, !1549}
!1549 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1550, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1550 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1541)
!1551 = !DISubprogram(name: "__cuda_builtin_blockDim_t", scope: !1541, file: !12, line: 96, type: !1552, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1552 = !DISubroutineType(types: !1553)
!1553 = !{null, !1554}
!1554 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1541, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1555 = !DISubprogram(name: "__cuda_builtin_blockDim_t", scope: !1541, file: !12, line: 96, type: !1556, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1556 = !DISubroutineType(types: !1557)
!1557 = !{null, !1554, !1558}
!1558 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1550, size: 64, align: 64)
!1559 = !DISubprogram(name: "operator=", linkageName: "_ZNK25__cuda_builtin_blockDim_taSERKS_", scope: !1541, file: !12, line: 96, type: !1560, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1560 = !DISubroutineType(types: !1561)
!1561 = !{null, !1549, !1558}
!1562 = !DISubprogram(name: "operator&", linkageName: "_ZNK25__cuda_builtin_blockDim_tadEv", scope: !1541, file: !12, line: 96, type: !1563, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1563 = !DISubroutineType(types: !1564)
!1564 = !{!1565, !1549}
!1565 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1541, size: 64, align: 64)
!1566 = distinct !DILocation(line: 68, column: 18, scope: !1408)
!1567 = !{i32 1, i32 1025}
!1568 = !DILocation(line: 68, column: 29, scope: !1408)
!1569 = !DILocation(line: 67, column: 3, scope: !1570, inlinedAt: !1596)
!1570 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !1571, file: !12, line: 67, type: !1453, isLocal: false, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !1573, variables: !2)
!1571 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_threadIdx_t", file: !12, line: 66, size: 8, align: 8, elements: !1572, identifier: "_ZTS26__cuda_builtin_threadIdx_t")
!1572 = !{!1573, !1574, !1575, !1576, !1581, !1585, !1589, !1592}
!1573 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !1571, file: !12, line: 67, type: !1453, isLocal: false, isDefinition: false, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true)
!1574 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !1571, file: !12, line: 68, type: !1453, isLocal: false, isDefinition: false, scopeLine: 68, flags: DIFlagPrototyped, isOptimized: true)
!1575 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_zEv", scope: !1571, file: !12, line: 69, type: !1453, isLocal: false, isDefinition: false, scopeLine: 69, flags: DIFlagPrototyped, isOptimized: true)
!1576 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK26__cuda_builtin_threadIdx_tcv5uint3Ev", scope: !1571, file: !12, line: 72, type: !1577, isLocal: false, isDefinition: false, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: true)
!1577 = !DISubroutineType(types: !1578)
!1578 = !{!1460, !1579}
!1579 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1580, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1580 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1571)
!1581 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !1571, file: !12, line: 74, type: !1582, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1582 = !DISubroutineType(types: !1583)
!1583 = !{null, !1584}
!1584 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1571, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1585 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !1571, file: !12, line: 74, type: !1586, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1586 = !DISubroutineType(types: !1587)
!1587 = !{null, !1584, !1588}
!1588 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !1580, size: 64, align: 64)
!1589 = !DISubprogram(name: "operator=", linkageName: "_ZNK26__cuda_builtin_threadIdx_taSERKS_", scope: !1571, file: !12, line: 74, type: !1590, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1590 = !DISubroutineType(types: !1591)
!1591 = !{null, !1579, !1588}
!1592 = !DISubprogram(name: "operator&", linkageName: "_ZNK26__cuda_builtin_threadIdx_tadEv", scope: !1571, file: !12, line: 74, type: !1593, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!1593 = !DISubroutineType(types: !1594)
!1594 = !{!1595, !1579}
!1595 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1571, size: 64, align: 64)
!1596 = distinct !DILocation(line: 68, column: 37, scope: !1529)
!1597 = !{i32 0, i32 1024}
!1598 = !DILocation(line: 68, column: 35, scope: !1408)
!1599 = !DILocation(line: 68, column: 12, scope: !1408)
!1600 = !DILocation(line: 70, column: 9, scope: !1436)
!1601 = !DILocation(line: 70, column: 5, scope: !1408)
!1602 = !DILocation(line: 72, column: 33, scope: !1435)
!1603 = !DILocation(line: 72, column: 19, scope: !1435)
!1604 = !DILocation(line: 72, column: 10, scope: !1435)
!1605 = !DILocation(line: 75, column: 30, scope: !1435)
!1606 = !DILocation(line: 49, column: 12, scope: !1367, inlinedAt: !1607)
!1607 = distinct !DILocation(line: 75, column: 18, scope: !1435)
!1608 = !DILocation(line: 49, column: 20, scope: !1367, inlinedAt: !1607)
!1609 = !DILocation(line: 49, column: 28, scope: !1367, inlinedAt: !1607)
!1610 = !DILocation(line: 49, column: 37, scope: !1367, inlinedAt: !1607)
!1611 = !DILocation(line: 49, column: 49, scope: !1367, inlinedAt: !1607)
!1612 = !DILocation(line: 51, column: 8, scope: !1367, inlinedAt: !1607)
!1613 = !DILocation(line: 52, column: 10, scope: !1378, inlinedAt: !1607)
!1614 = !DILocation(line: 52, column: 19, scope: !1390, inlinedAt: !1607)
!1615 = !DILocation(line: 52, column: 2, scope: !1390, inlinedAt: !1607)
!1616 = !DILocation(line: 53, column: 25, scope: !1380, inlinedAt: !1607)
!1617 = !DILocation(line: 53, column: 30, scope: !1380, inlinedAt: !1607)
!1618 = !DILocation(line: 53, column: 15, scope: !1380, inlinedAt: !1607)
!1619 = !DILocation(line: 53, column: 37, scope: !1380, inlinedAt: !1607)
!1620 = !DILocation(line: 53, column: 35, scope: !1380, inlinedAt: !1607)
!1621 = !DILocation(line: 53, column: 9, scope: !1380, inlinedAt: !1607)
!1622 = !DILocation(line: 54, column: 17, scope: !1380, inlinedAt: !1607)
!1623 = !DILocation(line: 54, column: 10, scope: !1380, inlinedAt: !1607)
!1624 = !DILocation(line: 75, column: 18, scope: !1435)
!1625 = !DILocation(line: 53, column: 52, scope: !1380, inlinedAt: !1607)
!1626 = !DILocation(line: 52, column: 27, scope: !1405, inlinedAt: !1607)
!1627 = !DILocation(line: 75, column: 54, scope: !1435)
!1628 = !DILocation(line: 75, column: 61, scope: !1435)
!1629 = !{!1630, !1395, i64 0}
!1630 = !{!"_ZTS5Point", !1395, i64 0, !1631, i64 8, !1288, i64 16, !1395, i64 24}
!1631 = !{!"any pointer", !1289, i64 0}
!1632 = !DILocation(line: 75, column: 52, scope: !1435)
!1633 = !DILocation(line: 75, column: 9, scope: !1435)
!1634 = !DILocation(line: 78, column: 24, scope: !1635)
!1635 = distinct !DILexicalBlock(scope: !1435, file: !1, line: 78, column: 8)
!1636 = !DILocation(line: 81, column: 32, scope: !1637)
!1637 = distinct !DILexicalBlock(scope: !1635, file: !1, line: 79, column: 3)
!1638 = !{!1630, !1395, i64 24}
!1639 = !DILocation(line: 78, column: 15, scope: !1635)
!1640 = !DILocation(line: 78, column: 8, scope: !1435)
!1641 = !DILocation(line: 80, column: 4, scope: !1637)
!1642 = !DILocation(line: 80, column: 29, scope: !1637)
!1643 = !{!1644, !1644, i64 0}
!1644 = !{!"bool", !1289, i64 0}
!1645 = !DILocation(line: 81, column: 23, scope: !1637)
!1646 = !DILocation(line: 81, column: 4, scope: !1637)
!1647 = !DILocation(line: 81, column: 13, scope: !1637)
!1648 = !DILocation(line: 82, column: 3, scope: !1637)
!1649 = !DILocation(line: 86, column: 56, scope: !1650)
!1650 = distinct !DILexicalBlock(scope: !1635, file: !1, line: 85, column: 3)
!1651 = !DILocation(line: 86, column: 32, scope: !1650)
!1652 = !{!1630, !1288, i64 16}
!1653 = !DILocation(line: 86, column: 10, scope: !1650)
!1654 = !{!1655, !1655, i64 0}
!1655 = !{!"int", !1289, i64 0}
!1656 = !DILocation(line: 86, column: 4, scope: !1650)
!1657 = !DILocation(line: 86, column: 41, scope: !1650)
!1658 = !DILocation(line: 89, column: 1, scope: !1408)
