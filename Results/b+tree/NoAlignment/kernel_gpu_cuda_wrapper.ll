...
define void @findK(i64 %height, %struct.knode* nocapture readonly %knodesD, i64 %knodes_elem, %struct.record* nocapture readonly %recordsD, i64* nocapture %currKnodeD, i64* nocapture %offsetD, i32* nocapture readonly %keysD, %struct.record* nocapture %ansD) local_unnamed_addr #4 !dbg !822 {
entry:
  tail call void @llvm.dbg.value(metadata i64 %height, i64 0, metadata !846, metadata !587), !dbg !857
  tail call void @llvm.dbg.value(metadata %struct.knode* %knodesD, i64 0, metadata !847, metadata !587), !dbg !858
  tail call void @llvm.dbg.value(metadata i64 %knodes_elem, i64 0, metadata !848, metadata !587), !dbg !859
  tail call void @llvm.dbg.value(metadata %struct.record* %recordsD, i64 0, metadata !849, metadata !587), !dbg !860
  tail call void @llvm.dbg.value(metadata i64* %currKnodeD, i64 0, metadata !850, metadata !587), !dbg !861
  tail call void @llvm.dbg.value(metadata i64* %offsetD, i64 0, metadata !851, metadata !587), !dbg !862
  tail call void @llvm.dbg.value(metadata i32* %keysD, i64 0, metadata !852, metadata !587), !dbg !863
  tail call void @llvm.dbg.value(metadata %struct.record* %ansD, i64 0, metadata !853, metadata !587), !dbg !864
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #7, !dbg !865, !range !901
  tail call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !854, metadata !587), !dbg !902
  %1 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() #7, !dbg !903, !range !931
  tail call void @llvm.dbg.value(metadata i32 %1, i64 0, metadata !855, metadata !587), !dbg !932
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !856, metadata !587), !dbg !933
  %cmp99 = icmp sgt i64 %height, 0, !dbg !934
  %idxprom94 = zext i32 %0 to i64, !dbg !938
  %idxprom295 = zext i32 %1 to i64, !dbg !941
  %arrayidx = getelementptr inbounds i64, i64* %currKnodeD, i64 %idxprom295, !dbg !941
  %2 = bitcast i64* %arrayidx to i8*, !dbg !941
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %2, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0), i32 26, i32 15, i32 0, i32 8), !dbg !941
  %3 = load i64, i64* %arrayidx, align 8, !dbg !941, !tbaa !718
  %arrayidx4100 = getelementptr inbounds %struct.knode, %struct.knode* %knodesD, i64 %3, i32 2, i64 %idxprom94, !dbg !938
  %4 = bitcast i32* %arrayidx4100 to i8*, !dbg !938
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %4, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @5, i32 0, i32 0), i32 26, i32 7, i32 1, i32 4), !dbg !938
  %5 = load i32, i32* %arrayidx4100, align 4, !dbg !938, !tbaa !942
  %arrayidx6 = getelementptr inbounds i32, i32* %keysD, i64 %idxprom295, !dbg !944
  %6 = bitcast i32* %arrayidx6 to i8*, !dbg !944
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %6, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @6, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @7, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @8, i32 0, i32 0), i32 26, i32 47, i32 2, i32 4), !dbg !944
  %7 = load i32, i32* %arrayidx6, align 4, !dbg !944, !tbaa !942
  br i1 %cmp99, label %for.body.lr.ph, label %for.end, !dbg !945

for.body.lr.ph:                                   ; preds = %entry
  %cmp35 = icmp eq i32 %0, 0, !dbg !946
  %arrayidx38 = getelementptr inbounds i64, i64* %offsetD, i64 %idxprom295, !dbg !948
  %add = add nuw nsw i32 %0, 1, !dbg !950
  %idxprom896 = zext i32 %add to i64, !dbg !952
...
for.body:                                         ; preds = %if.end41, %for.body.lr.ph
  ...
  %cmp7 = icmp sgt i32 %9, %8, !dbg !953
  br i1 %cmp7, label %if.end34, label %land.lhs.true, !dbg !954

land.lhs.true:                                    ; preds = %for.body
  %arrayidx13 = getelementptr inbounds %struct.knode, %struct.knode* %knodesD, i64 %10, i32 2, i64 %idxprom896, !dbg !952
  %11 = bitcast i32* %arrayidx13 to i8*, !dbg !952
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %11, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @11, i32 0, i32 0), i32 26, i32 62, i32 3, i32 4), !dbg !952
  %12 = load i32, i32* %arrayidx13, align 4, !dbg !952, !tbaa !942
  %cmp16 = icmp sgt i32 %12, %8, !dbg !955
  br i1 %cmp16, label %if.then, label %if.end34, !dbg !956

if.then:                                          ; preds = %land.lhs.true
  %13 = bitcast i64* %arrayidx38 to i8*, !dbg !957
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %13, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @12, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @13, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i32 0, i32 0), i32 30, i32 15, i32 4, i32 8), !dbg !957
  %14 = load i64, i64* %arrayidx38, align 8, !dbg !957, !tbaa !718
  %arrayidx21 = getelementptr inbounds %struct.knode, %struct.knode* %knodesD, i64 %14, i32 1, i64 %idxprom94, !dbg !960
  %15 = bitcast i32* %arrayidx21 to i8*, !dbg !960
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %15, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @15, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @16, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @17, i32 0, i32 0), i32 30, i32 7, i32 5, i32 4), !dbg !960
  %16 = load i32, i32* %arrayidx21, align 4, !dbg !960, !tbaa !942
  %conv22 = sext i32 %16 to i64, !dbg !960
  %cmp23 = icmp slt i64 %conv22, %knodes_elem, !dbg !961
  br i1 %cmp23, label %if.then24, label %if.end34, !dbg !962

if.then24:                                        ; preds = %if.then
  %17 = bitcast i64* %arrayidx38 to i8*, !dbg !963
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %17, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @18, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @19, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @20, i32 0, i32 0), i32 31, i32 18, i32 6, i32 8), !dbg !963
  store i64 %conv22, i64* %arrayidx38, align 8, !dbg !963, !tbaa !718
  br label %if.end34, !dbg !965

if.end34:                                         ; preds = %if.then24, %if.then, %land.lhs.true, %for.body
  tail call void @llvm.nvvm.barrier0(), !dbg !966
  br i1 %cmp35, label %if.then36, label %if.end41, !dbg !967

if.then36:                                        ; preds = %if.end34
  %18 = bitcast i64* %arrayidx38 to i8*, !dbg !948
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %18, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @21, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @22, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @23, i32 0, i32 0), i32 38, i32 22, i32 7, i32 8), !dbg !948
  %19 = load i64, i64* %arrayidx38, align 8, !dbg !948, !tbaa !718
  %20 = bitcast i64* %arrayidx to i8*, !dbg !968
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %20, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @24, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @25, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @26, i32 0, i32 0), i32 38, i32 20, i32 8, i32 8), !dbg !968
  store i64 %19, i64* %arrayidx, align 8, !dbg !968, !tbaa !718
  br label %if.end41, !dbg !969

if.end41:                                         ; preds = %if.then36, %if.end34
  tail call void @llvm.nvvm.barrier0(), !dbg !970
  %inc = add nuw nsw i32 %inc.sink101, 1, !dbg !971
  tail call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !856, metadata !587), !dbg !933
  %conv = sext i32 %inc to i64, !dbg !973
  %cmp = icmp slt i64 %conv, %height, !dbg !934
  %21 = bitcast i64* %arrayidx to i8*, !dbg !941
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %21, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @27, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @28, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @29, i32 0, i32 0), i32 26, i32 15, i32 9, i32 8), !dbg !941
  %22 = load i64, i64* %arrayidx, align 8, !dbg !941, !tbaa !718
  %arrayidx4 = getelementptr inbounds %struct.knode, %struct.knode* %knodesD, i64 %22, i32 2, i64 %idxprom94, !dbg !938
  %23 = bitcast i32* %arrayidx4 to i8*, !dbg !938
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %23, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @30, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @31, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @32, i32 0, i32 0), i32 26, i32 7, i32 10, i32 4), !dbg !938
  %24 = load i32, i32* %arrayidx4, align 4, !dbg !938, !tbaa !942
  %25 = bitcast i32* %arrayidx6 to i8*, !dbg !944
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %25, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @33, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @34, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @35, i32 0, i32 0), i32 26, i32 47, i32 11, i32 4), !dbg !944
  %26 = load i32, i32* %arrayidx6, align 4, !dbg !944, !tbaa !942
  br i1 %cmp, label %for.body, label %for.end.loopexit, !dbg !945, !llvm.loop !974

for.end.loopexit:                                 ; preds = %if.end41
  br label %for.end, !dbg !976
...
for.end:                                          ; preds = %for.end.loopexit, %entry
  ...
  %cmp50 = icmp eq i32 %.lcssa97, %.lcssa, !dbg !976
  br i1 %cmp50, label %if.then51, label %if.end63, !dbg !978

if.then51:                                        ; preds = %for.end
  %arrayidx57 = getelementptr inbounds %struct.knode, %struct.knode* %knodesD, i64 %.lcssa98, i32 1, i64 %idxprom94, !dbg !979
  %27 = bitcast i32* %arrayidx57 to i8*, !dbg !979
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %27, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @36, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @37, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @38, i32 0, i32 0), i32 47, i32 30, i32 12, i32 4), !dbg !979
  %28 = load i32, i32* %arrayidx57, align 4, !dbg !979, !tbaa !942
  %idxprom58 = sext i32 %28 to i64, !dbg !981
  %value = getelementptr inbounds %struct.record, %struct.record* %recordsD, i64 %idxprom58, i32 0, !dbg !982
  %29 = bitcast i32* %value to i8*, !dbg !982
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %29, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @39, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @40, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @41, i32 0, i32 0), i32 47, i32 70, i32 13, i32 4), !dbg !982
  %30 = load i32, i32* %value, align 4, !dbg !982, !tbaa !983
  %value62 = getelementptr inbounds %struct.record, %struct.record* %ansD, i64 %idxprom295, i32 0, !dbg !985
  %31 = bitcast i32* %value62 to i8*, !dbg !986
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %31, i8* getelementptr inbounds ([65 x i8], [65 x i8]* @42, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @43, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @44, i32 0, i32 0), i32 47, i32 19, i32 14, i32 4), !dbg !986
  store i32 %30, i32* %value62, align 4, !dbg !986, !tbaa !983
  br label %if.end63, !dbg !987
...
!661 = !{i32 3113689, i32 3113694, i32 3113737, i32 3113789, i32 3113841, i32 3113959}
...
!672 = !{i32 2339401, i32 2339406, i32 2339440, i32 2339482, i32 2339525}
...
!822 = distinct !DISubprogram(name: "findK", scope: !823, file: !823, line: 6, type: !824, isLocal: false, isDefinition: true, scopeLine: 15, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !845)
!823 = !DIFile(filename: "Results/b+tree/kernel/./kernel_gpu_cuda.cu", directory: "/home/ec2-user/DynamicAnalyis")
!824 = !DISubroutineType(types: !825)
!825 = !{null, !119, !826, !119, !839, !844, !844, !85, !839}
...
!840 = !DIDerivedType(tag: DW_TAG_typedef, name: "record", file: !828, line: 99, baseType: !841)
!841 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "record", file: !828, line: 97, size: 32, align: 32, elements: !842, identifier: "_ZTS6record")
!842 = !{!843}
!843 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !841, file: !828, line: 98, baseType: !9, size: 32, align: 32)
!844 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !119, size: 64, align: 64)
!845 = !{!846, !847, !848, !849, !850, !851, !852, !853, !854, !855, !856}
!846 = !DILocalVariable(name: "height", arg: 1, scope: !822, file: !823, line: 6, type: !119)
!847 = !DILocalVariable(name: "knodesD", arg: 2, scope: !822, file: !823, line: 7, type: !826)
!848 = !DILocalVariable(name: "knodes_elem", arg: 3, scope: !822, file: !823, line: 8, type: !119)
!849 = !DILocalVariable(name: "recordsD", arg: 4, scope: !822, file: !823, line: 9, type: !839)
!850 = !DILocalVariable(name: "currKnodeD", arg: 5, scope: !822, file: !823, line: 11, type: !844)
!851 = !DILocalVariable(name: "offsetD", arg: 6, scope: !822, file: !823, line: 12, type: !844)
!852 = !DILocalVariable(name: "keysD", arg: 7, scope: !822, file: !823, line: 13, type: !85)
!853 = !DILocalVariable(name: "ansD", arg: 8, scope: !822, file: !823, line: 14, type: !839)
!854 = !DILocalVariable(name: "thid", scope: !822, file: !823, line: 18, type: !9)
!855 = !DILocalVariable(name: "bid", scope: !822, file: !823, line: 19, type: !9)
!856 = !DILocalVariable(name: "i", scope: !822, file: !823, line: 22, type: !9)
!857 = !DILocation(line: 6, column: 13, scope: !822)
!858 = !DILocation(line: 7, column: 10, scope: !822)
!859 = !DILocation(line: 8, column: 8, scope: !822)
!860 = !DILocation(line: 9, column: 11, scope: !822)
!861 = !DILocation(line: 11, column: 9, scope: !822)
!862 = !DILocation(line: 12, column: 9, scope: !822)
!863 = !DILocation(line: 13, column: 8, scope: !822)
!864 = !DILocation(line: 14, column: 11, scope: !822)
!865 = !DILocation(line: 67, column: 3, scope: !866, inlinedAt: !900)
!866 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !867, file: !12, line: 67, type: !870, isLocal: false, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !869, variables: !2)
!867 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_threadIdx_t", file: !12, line: 66, size: 8, align: 8, elements: !868, identifier: "_ZTS26__cuda_builtin_threadIdx_t")
!868 = !{!869, !872, !873, !874, !885, !889, !893, !896}
!869 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !867, file: !12, line: 67, type: !870, isLocal: false, isDefinition: false, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true)
!870 = !DISubroutineType(types: !871)
!871 = !{!375}
!872 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !867, file: !12, line: 68, type: !870, isLocal: false, isDefinition: false, scopeLine: 68, flags: DIFlagPrototyped, isOptimized: true)
!873 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_zEv", scope: !867, file: !12, line: 69, type: !870, isLocal: false, isDefinition: false, scopeLine: 69, flags: DIFlagPrototyped, isOptimized: true)
!874 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK26__cuda_builtin_threadIdx_tcv5uint3Ev", scope: !867, file: !12, line: 72, type: !875, isLocal: false, isDefinition: false, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: true)
!875 = !DISubroutineType(types: !876)
!876 = !{!877, !883}
!877 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uint3", file: !878, line: 190, size: 96, align: 32, elements: !879, identifier: "_ZTS5uint3")
!878 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
!879 = !{!880, !881, !882}
!880 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !877, file: !878, line: 192, baseType: !375, size: 32, align: 32)
!881 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !877, file: !878, line: 192, baseType: !375, size: 32, align: 32, offset: 32)
!882 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !877, file: !878, line: 192, baseType: !375, size: 32, align: 32, offset: 64)
!883 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !884, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!884 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !867)
!885 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !867, file: !12, line: 74, type: !886, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!886 = !DISubroutineType(types: !887)
!887 = !{null, !888}
!888 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !867, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!889 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !867, file: !12, line: 74, type: !890, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!890 = !DISubroutineType(types: !891)
!891 = !{null, !888, !892}
!892 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !884, size: 64, align: 64)
!893 = !DISubprogram(name: "operator=", linkageName: "_ZNK26__cuda_builtin_threadIdx_taSERKS_", scope: !867, file: !12, line: 74, type: !894, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!894 = !DISubroutineType(types: !895)
!895 = !{null, !883, !892}
!896 = !DISubprogram(name: "operator&", linkageName: "_ZNK26__cuda_builtin_threadIdx_tadEv", scope: !867, file: !12, line: 74, type: !897, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!897 = !DISubroutineType(types: !898)
!898 = !{!899, !883}
!899 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !867, size: 64, align: 64)
!900 = distinct !DILocation(line: 18, column: 13, scope: !822)
!901 = !{i32 0, i32 1024}
!902 = !DILocation(line: 18, column: 6, scope: !822)
!903 = !DILocation(line: 78, column: 3, scope: !904, inlinedAt: !930)
!904 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !905, file: !12, line: 78, type: !870, isLocal: false, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !907, variables: !2)
!905 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_blockIdx_t", file: !12, line: 77, size: 8, align: 8, elements: !906, identifier: "_ZTS25__cuda_builtin_blockIdx_t")
!906 = !{!907, !908, !909, !910, !915, !919, !923, !926}
!907 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !905, file: !12, line: 78, type: !870, isLocal: false, isDefinition: false, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true)
!908 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !905, file: !12, line: 79, type: !870, isLocal: false, isDefinition: false, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: true)
!909 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_zEv", scope: !905, file: !12, line: 80, type: !870, isLocal: false, isDefinition: false, scopeLine: 80, flags: DIFlagPrototyped, isOptimized: true)
!910 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK25__cuda_builtin_blockIdx_tcv5uint3Ev", scope: !905, file: !12, line: 83, type: !911, isLocal: false, isDefinition: false, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true)
!911 = !DISubroutineType(types: !912)
!912 = !{!877, !913}
!913 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !914, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!914 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !905)
!915 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !905, file: !12, line: 85, type: !916, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!916 = !DISubroutineType(types: !917)
!917 = !{null, !918}
!918 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !905, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!919 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !905, file: !12, line: 85, type: !920, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!920 = !DISubroutineType(types: !921)
!921 = !{null, !918, !922}
!922 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !914, size: 64, align: 64)
!923 = !DISubprogram(name: "operator=", linkageName: "_ZNK25__cuda_builtin_blockIdx_taSERKS_", scope: !905, file: !12, line: 85, type: !924, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!924 = !DISubroutineType(types: !925)
!925 = !{null, !913, !922}
!926 = !DISubprogram(name: "operator&", linkageName: "_ZNK25__cuda_builtin_blockIdx_tadEv", scope: !905, file: !12, line: 85, type: !927, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!927 = !DISubroutineType(types: !928)
!928 = !{!929, !913}
!929 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !905, size: 64, align: 64)
!930 = distinct !DILocation(line: 19, column: 12, scope: !822)
!931 = !{i32 0, i32 2147483647}
!932 = !DILocation(line: 19, column: 6, scope: !822)
!933 = !DILocation(line: 22, column: 6, scope: !822)
!934 = !DILocation(line: 23, column: 15, scope: !935)
!935 = !DILexicalBlockFile(scope: !936, file: !823, discriminator: 1)
!936 = distinct !DILexicalBlock(scope: !937, file: !823, line: 23, column: 2)
!937 = distinct !DILexicalBlock(scope: !822, file: !823, line: 23, column: 2)
!938 = !DILocation(line: 26, column: 7, scope: !939)
!939 = distinct !DILexicalBlock(scope: !940, file: !823, line: 26, column: 6)
!940 = distinct !DILexicalBlock(scope: !936, file: !823, line: 23, column: 29)
!941 = !DILocation(line: 26, column: 15, scope: !939)
!942 = !{!943, !943, i64 0}
!943 = !{!"int", !720, i64 0}
!944 = !DILocation(line: 26, column: 47, scope: !939)
!945 = !DILocation(line: 23, column: 2, scope: !935)
!946 = !DILocation(line: 37, column: 10, scope: !947)
!947 = distinct !DILexicalBlock(scope: !940, file: !823, line: 37, column: 6)
!948 = !DILocation(line: 38, column: 22, scope: !949)
!949 = distinct !DILexicalBlock(scope: !947, file: !823, line: 37, column: 14)
!950 = !DILocation(line: 26, column: 96, scope: !951)
!951 = !DILexicalBlockFile(scope: !939, file: !823, discriminator: 1)
!952 = !DILocation(line: 26, column: 62, scope: !951)
!953 = !DILocation(line: 26, column: 44, scope: !939)
!954 = !DILocation(line: 26, column: 58, scope: !939)
!955 = !DILocation(line: 26, column: 100, scope: !951)
!956 = !DILocation(line: 26, column: 6, scope: !951)
!957 = !DILocation(line: 30, column: 15, scope: !958)
!958 = distinct !DILexicalBlock(scope: !959, file: !823, line: 30, column: 7)
!959 = distinct !DILexicalBlock(scope: !939, file: !823, line: 26, column: 114)
!960 = !DILocation(line: 30, column: 7, scope: !958)
!961 = !DILocation(line: 30, column: 43, scope: !958)
!962 = !DILocation(line: 30, column: 7, scope: !959)
!963 = !DILocation(line: 31, column: 18, scope: !964)
!964 = distinct !DILexicalBlock(scope: !958, file: !823, line: 30, column: 57)
!965 = !DILocation(line: 32, column: 4, scope: !964)
!966 = !DILocation(line: 34, column: 3, scope: !940)
!967 = !DILocation(line: 37, column: 6, scope: !940)
!968 = !DILocation(line: 38, column: 20, scope: !949)
!969 = !DILocation(line: 39, column: 3, scope: !949)
!970 = !DILocation(line: 40, column: 3, scope: !940)
!971 = !DILocation(line: 23, column: 26, scope: !972)
!972 = !DILexicalBlockFile(scope: !936, file: !823, discriminator: 2)
!973 = !DILocation(line: 23, column: 13, scope: !935)
!974 = distinct !{!974, !975}
!975 = !DILocation(line: 23, column: 2, scope: !822)
!976 = !DILocation(line: 46, column: 41, scope: !977)
!977 = distinct !DILexicalBlock(scope: !822, file: !823, line: 46, column: 5)
!978 = !DILocation(line: 46, column: 5, scope: !822)
!979 = !DILocation(line: 47, column: 30, scope: !980)
!980 = distinct !DILexicalBlock(scope: !977, file: !823, line: 46, column: 55)
!981 = !DILocation(line: 47, column: 21, scope: !980)
!982 = !DILocation(line: 47, column: 70, scope: !980)
!983 = !{!984, !943, i64 0}
!984 = !{!"_ZTS6record", !943, i64 0}
!985 = !DILocation(line: 47, column: 13, scope: !980)
!986 = !DILocation(line: 47, column: 19, scope: !980)
!987 = !DILocation(line: 48, column: 2, scope: !980)
!988 = !DILocation(line: 50, column: 1, scope: !822)
