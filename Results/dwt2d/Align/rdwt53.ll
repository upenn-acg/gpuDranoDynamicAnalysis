; ModuleID = 'Results/dwt2d/dwt_cuda/rdwt53.cu'
source_filename = "Results/dwt2d/dwt_cuda/rdwt53.cu"
...
define void @_ZN8dwt_cuda6rdwt53EPiS0_iii(i32* %in, i32* %out, i32 %sizeX, i32 %sizeY, i32 %levels) local_unnamed_addr #0 !dbg !886 {
entry:
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !892, metadata !902), !dbg !903
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !893, metadata !902), !dbg !904
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !894, metadata !902), !dbg !905
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !895, metadata !902), !dbg !906
  tail call void @llvm.dbg.value(metadata i32 %levels, i64 0, metadata !896, metadata !902), !dbg !907
  %cmp = icmp sgt i32 %levels, 1, !dbg !908
  br i1 %cmp, label %if.then, label %if.end, !dbg !909

if.then:                                          ; preds = %entry
  %div.i = sdiv i32 %sizeX, 2, !dbg !910
  %rem.i81 = and i32 %sizeX, 1, !dbg !921
  %add.i = add nsw i32 %rem.i81, %div.i, !dbg !922
  tail call void @llvm.dbg.value(metadata i32 %add.i, i64 0, metadata !897, metadata !902), !dbg !923
  %div.i22 = sdiv i32 %sizeY, 2, !dbg !924
  %rem.i2382 = and i32 %sizeY, 1, !dbg !926
  %add.i26 = add nsw i32 %rem.i2382, %div.i22, !dbg !927
  tail call void @llvm.dbg.value(metadata i32 %add.i26, i64 0, metadata !901, metadata !902), !dbg !928
  %sub = add nsw i32 %levels, -1, !dbg !929
  tail call void @_ZN8dwt_cuda6rdwt53EPiS0_iii(i32* %in, i32* %out, i32 %add.i, i32 %add.i26, i32 %sub), !dbg !930
  %conv = sext i32 %add.i to i64, !dbg !931
  %conv3 = sext i32 %add.i26 to i64, !dbg !932
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !933, metadata !902), !dbg !947
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !942, metadata !902), !dbg !949
  tail call void @llvm.dbg.value(metadata i64 %conv, i64 0, metadata !943, metadata !902), !dbg !950
  tail call void @llvm.dbg.value(metadata i64 %conv3, i64 0, metadata !944, metadata !902), !dbg !951
  %0 = bitcast i32* %in to i8*, !dbg !952
  %1 = bitcast i32* %out to i8*, !dbg !953
  %mul.i51 = shl nsw i64 %conv, 2, !dbg !954
  %mul1.i = mul i64 %mul.i51, %conv3, !dbg !955
  %call.i = tail call i32 @cudaMemcpy(i8* %0, i8* %1, i64 %mul1.i, i32 3), !dbg !956
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !945, metadata !902), !dbg !957
  br label %if.end, !dbg !958

if.end:                                           ; preds = %if.then, %entry
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !894, metadata !902), !dbg !905
  %cmp4 = icmp sgt i32 %sizeX, 959, !dbg !959
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !895, metadata !902), !dbg !906
  br i1 %cmp4, label %if.then5, label %if.else, !dbg !961

if.then5:                                         ; preds = %if.end
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !962, metadata !902), !dbg !998
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !970, metadata !902), !dbg !1001
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !971, metadata !902), !dbg !1002
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !972, metadata !902), !dbg !1003
  %div.i.i52 = sdiv i32 %sizeY, 120, !dbg !1004
  %rem.i.i53 = srem i32 %sizeY, 120, !dbg !1006
  %tobool.i.i54 = icmp ne i32 %rem.i.i53, 0, !dbg !1007
  %cond.i.i55 = zext i1 %tobool.i.i54 to i32, !dbg !1007
  %add.i.i56 = add nsw i32 %cond.i.i55, %div.i.i52, !dbg !1008
  tail call void @llvm.dbg.value(metadata i32 %add.i.i56, i64 0, metadata !973, metadata !902), !dbg !1009
  %div.i13.i5778 = udiv i32 %sizeX, 192
  %rem.i14.i79 = urem i32 %sizeX, 192
  %tobool.i15.i58 = icmp ne i32 %rem.i14.i79, 0, !dbg !1010
  %cond.i16.i59 = zext i1 %tobool.i15.i58 to i32, !dbg !1010
  %add.i17.i60 = add nuw nsw i32 %cond.i16.i59, %div.i13.i5778, !dbg !1012
  %mul.i61 = shl nsw i32 %add.i.i56, 3, !dbg !1013
  %div.i21.i62 = sdiv i32 %sizeY, %mul.i61, !dbg !1014
  %rem.i22.i63 = srem i32 %sizeY, %mul.i61, !dbg !1017
  %tobool.i23.i64 = icmp ne i32 %rem.i22.i63, 0, !dbg !1018
  %cond.i24.i65 = zext i1 %tobool.i23.i64 to i32, !dbg !1018
  %add.i25.i66 = add nsw i32 %cond.i24.i65, %div.i21.i62, !dbg !1019
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !974, metadata !1020), !dbg !1021
  %gSize.sroa.0.sroa.4.0.insert.ext.i67 = zext i32 %add.i25.i66 to i64, !dbg !1022
  %gSize.sroa.0.sroa.4.0.insert.shift.i68 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i67, 32, !dbg !1022
  %gSize.sroa.0.sroa.0.0.insert.ext.i69 = zext i32 %add.i17.i60 to i64, !dbg !1022
  %gSize.sroa.0.sroa.0.0.insert.insert.i70 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i68, %gSize.sroa.0.sroa.0.0.insert.ext.i69, !dbg !1022
  %call6.i71 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i70, i32 1, i64 4294967488, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1023
  %tobool.i72 = icmp eq i32 %call6.i71, 0, !dbg !1025
  br i1 %tobool.i72, label %kcall.configok.i73, label %if.end10, !dbg !1026

kcall.configok.i73:                               ; preds = %if.then5
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !971, metadata !902), !dbg !1002
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !972, metadata !902), !dbg !1003
  tail call void @_ZN8dwt_cuda12rdwt53KernelILi192ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i56), !dbg !1027
  br label %if.end10, !dbg !1027

if.else:                                          ; preds = %if.end
  %cmp6 = icmp sgt i32 %sizeX, 479, !dbg !1028
  %div.i.i = sdiv i32 %sizeY, 120, !dbg !1031
  %rem.i.i = srem i32 %sizeY, 120, !dbg !1045
  %tobool.i.i = icmp ne i32 %rem.i.i, 0, !dbg !1046
  %cond.i.i = zext i1 %tobool.i.i to i32, !dbg !1046
  %add.i.i = add nsw i32 %cond.i.i, %div.i.i, !dbg !1047
  br i1 %cmp6, label %if.then7, label %if.else8, !dbg !1048

if.then7:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !1037, metadata !902), !dbg !1049
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !1038, metadata !902), !dbg !1050
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1039, metadata !902), !dbg !1051
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1040, metadata !902), !dbg !1052
  tail call void @llvm.dbg.value(metadata i32 %add.i.i, i64 0, metadata !1041, metadata !902), !dbg !1053
  %div.i13.i80 = lshr i32 %sizeX, 7
  %rem.i1436.i = and i32 %sizeX, 127, !dbg !1054
  %tobool.i15.i = icmp ne i32 %rem.i1436.i, 0, !dbg !1054
  %cond.i16.i = zext i1 %tobool.i15.i to i32, !dbg !1054
  %add.i17.i = add nuw nsw i32 %cond.i16.i, %div.i13.i80, !dbg !1056
  %mul.i = shl nsw i32 %add.i.i, 3, !dbg !1057
  %div.i21.i = sdiv i32 %sizeY, %mul.i, !dbg !1058
  %rem.i22.i = srem i32 %sizeY, %mul.i, !dbg !1061
  %tobool.i23.i = icmp ne i32 %rem.i22.i, 0, !dbg !1062
  %cond.i24.i = zext i1 %tobool.i23.i to i32, !dbg !1062
  %add.i25.i = add nsw i32 %cond.i24.i, %div.i21.i, !dbg !1063
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1042, metadata !1020), !dbg !1064
  %gSize.sroa.0.sroa.4.0.insert.ext.i = zext i32 %add.i25.i to i64, !dbg !1065
  %gSize.sroa.0.sroa.4.0.insert.shift.i = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i, 32, !dbg !1065
  %gSize.sroa.0.sroa.0.0.insert.ext.i = zext i32 %add.i17.i to i64, !dbg !1065
  %gSize.sroa.0.sroa.0.0.insert.insert.i = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i, %gSize.sroa.0.sroa.0.0.insert.ext.i, !dbg !1065
  %call6.i = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i, i32 1, i64 4294967424, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1066
  %tobool.i27 = icmp eq i32 %call6.i, 0, !dbg !1068
  br i1 %tobool.i27, label %kcall.configok.i, label %if.end10, !dbg !1069

kcall.configok.i:                                 ; preds = %if.then7
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1039, metadata !902), !dbg !1051
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1040, metadata !902), !dbg !1052
  tail call void @_ZN8dwt_cuda12rdwt53KernelILi128ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i), !dbg !1070
  br label %if.end10, !dbg !1070

if.else8:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !1071, metadata !902), !dbg !1081
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !1076, metadata !902), !dbg !1084
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1077, metadata !902), !dbg !1085
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1078, metadata !902), !dbg !1086
  tail call void @llvm.dbg.value(metadata i32 %add.i.i, i64 0, metadata !1079, metadata !902), !dbg !1087
  %div.i13.i33 = sdiv i32 %sizeX, 64, !dbg !1088
  %rem.i1436.i34 = and i32 %sizeX, 63, !dbg !1090
  %tobool.i15.i35 = icmp ne i32 %rem.i1436.i34, 0, !dbg !1090
  %cond.i16.i36 = zext i1 %tobool.i15.i35 to i32, !dbg !1090
  %add.i17.i37 = add nsw i32 %cond.i16.i36, %div.i13.i33, !dbg !1091
  %mul.i38 = shl nsw i32 %add.i.i, 3, !dbg !1092
  %div.i21.i39 = sdiv i32 %sizeY, %mul.i38, !dbg !1093
  %rem.i22.i40 = srem i32 %sizeY, %mul.i38, !dbg !1096
  %tobool.i23.i41 = icmp ne i32 %rem.i22.i40, 0, !dbg !1097
  %cond.i24.i42 = zext i1 %tobool.i23.i41 to i32, !dbg !1097
  %add.i25.i43 = add nsw i32 %cond.i24.i42, %div.i21.i39, !dbg !1098
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1080, metadata !1020), !dbg !1099
  %gSize.sroa.0.sroa.4.0.insert.ext.i44 = zext i32 %add.i25.i43 to i64, !dbg !1100
  %gSize.sroa.0.sroa.4.0.insert.shift.i45 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i44, 32, !dbg !1100
  %gSize.sroa.0.sroa.0.0.insert.ext.i46 = zext i32 %add.i17.i37 to i64, !dbg !1100
  %gSize.sroa.0.sroa.0.0.insert.insert.i47 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i45, %gSize.sroa.0.sroa.0.0.insert.ext.i46, !dbg !1100
  %call6.i48 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i47, i32 1, i64 4294967360, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1101
  %tobool.i49 = icmp eq i32 %call6.i48, 0, !dbg !1103
  br i1 %tobool.i49, label %kcall.configok.i50, label %if.end10, !dbg !1104

kcall.configok.i50:                               ; preds = %if.else8
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1077, metadata !902), !dbg !1085
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1078, metadata !902), !dbg !1086
  tail call void @_ZN8dwt_cuda12rdwt53KernelILi64ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i), !dbg !1105
  br label %if.end10, !dbg !1105

if.end10:                                         ; preds = %kcall.configok.i50, %if.else8, %kcall.configok.i, %if.then7, %kcall.configok.i73, %if.then5
  ret void, !dbg !1106
}
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt53KernelILi192ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1107 {
entry:
  ...
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !1111, metadata !902), !dbg !1116
  store i32* %in, i32** %in.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !1112, metadata !902), !dbg !1121
  store i32* %out, i32** %out.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1113, metadata !902), !dbg !1122
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1114, metadata !902), !dbg !1125
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1115, metadata !902), !dbg !1126
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1123
  %0 = bitcast i32** %in.addr to i8*, !dbg !1127
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1127
  %2 = icmp eq i32 %1, 0, !dbg !1127
  br i1 %2, label %setup.next, label %setup.end, !dbg !1127

setup.next:                                       ; preds = %entry
  %3 = bitcast i32** %out.addr to i8*, !dbg !1128
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1128
  %5 = icmp eq i32 %4, 0, !dbg !1128
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1128

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1130
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1130
  %8 = icmp eq i32 %7, 0, !dbg !1130
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1130

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1132
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1132
  %11 = icmp eq i32 %10, 0, !dbg !1132
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1132

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1134
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1134
  %14 = icmp eq i32 %13, 0, !dbg !1134
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1134

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (i32*, i32*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt53KernelILi192ELi8EEEvPKiPiiii to i8*)), !dbg !1136
  br label %setup.end, !dbg !1136
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt53KernelILi128ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1139 {
entry:
  %in.addr = alloca i32*, align 8
  %out.addr = alloca i32*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !1141, metadata !902), !dbg !1146
  store i32* %in, i32** %in.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !1142, metadata !902), !dbg !1147
  store i32* %out, i32** %out.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1143, metadata !902), !dbg !1148
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1144, metadata !902), !dbg !1149
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1145, metadata !902), !dbg !1150
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1123
  %0 = bitcast i32** %in.addr to i8*, !dbg !1151
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1151
  %2 = icmp eq i32 %1, 0, !dbg !1151
  br i1 %2, label %setup.next, label %setup.end, !dbg !1151

setup.next:                                       ; preds = %entry
  %3 = bitcast i32** %out.addr to i8*, !dbg !1152
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1152
  %5 = icmp eq i32 %4, 0, !dbg !1152
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1152

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1154
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1154
  %8 = icmp eq i32 %7, 0, !dbg !1154
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1154

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1156
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1156
  %11 = icmp eq i32 %10, 0, !dbg !1156
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1156

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1158
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1158
  %14 = icmp eq i32 %13, 0, !dbg !1158
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1158

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (i32*, i32*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt53KernelILi128ELi8EEEvPKiPiiii to i8*)), !dbg !1160
  br label %setup.end, !dbg !1160
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt53KernelILi64ELi8EEEvPKiPiiii(i32* %in, i32* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1163 {
entry:
  %in.addr = alloca i32*, align 8
  %out.addr = alloca i32*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata i32* %in, i64 0, metadata !1165, metadata !902), !dbg !1170
  store i32* %in, i32** %in.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32* %out, i64 0, metadata !1166, metadata !902), !dbg !1171
  store i32* %out, i32** %out.addr, align 8, !tbaa !1117
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1167, metadata !902), !dbg !1172
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1168, metadata !902), !dbg !1173
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1123
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1169, metadata !902), !dbg !1174
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1123
  %0 = bitcast i32** %in.addr to i8*, !dbg !1175
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1175
  %2 = icmp eq i32 %1, 0, !dbg !1175
  br i1 %2, label %setup.next, label %setup.end, !dbg !1175

setup.next:                                       ; preds = %entry
  %3 = bitcast i32** %out.addr to i8*, !dbg !1176
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1176
  %5 = icmp eq i32 %4, 0, !dbg !1176
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1176

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1178
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1178
  %8 = icmp eq i32 %7, 0, !dbg !1178
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1178

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1180
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1180
  %11 = icmp eq i32 %10, 0, !dbg !1180
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1180

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1182
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1182
  %14 = icmp eq i32 %13, 0, !dbg !1182
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1182

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (i32*, i32*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt53KernelILi64ELi8EEEvPKiPiiii to i8*)), !dbg !1184
  br label %setup.end, !dbg !1184
...
!1 = !DIFile(filename: "Results/dwt2d/dwt_cuda/rdwt53.cu", directory: "/home/ec2-user/DynamicAnalyis")
!2 = !{!3, !86}
...
!886 = distinct !DISubprogram(name: "rdwt53", linkageName: "_ZN8dwt_cuda6rdwt53EPiS0_iii", scope: !887, file: !1, line: 338, type: !889, isLocal: false, isDefinition: true, scopeLine: 338, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !891)
...
!892 = !DILocalVariable(name: "in", arg: 1, scope: !886, file: !1, line: 338, type: !165)
!893 = !DILocalVariable(name: "out", arg: 2, scope: !886, file: !1, line: 338, type: !165)
!894 = !DILocalVariable(name: "sizeX", arg: 3, scope: !886, file: !1, line: 338, type: !160)
!895 = !DILocalVariable(name: "sizeY", arg: 4, scope: !886, file: !1, line: 338, type: !160)
!896 = !DILocalVariable(name: "levels", arg: 5, scope: !886, file: !1, line: 338, type: !160)
!897 = !DILocalVariable(name: "llSizeX", scope: !898, file: !1, line: 341, type: !900)
!898 = distinct !DILexicalBlock(scope: !899, file: !1, line: 339, column: 20)
!899 = distinct !DILexicalBlock(scope: !886, file: !1, line: 339, column: 8)
!900 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !160)
!901 = !DILocalVariable(name: "llSizeY", scope: !898, file: !1, line: 342, type: !900)
!902 = !DIExpression()
!903 = !DILocation(line: 338, column: 21, scope: !886)
!904 = !DILocation(line: 338, column: 31, scope: !886)
!905 = !DILocation(line: 338, column: 40, scope: !886)
!906 = !DILocation(line: 338, column: 51, scope: !886)
!907 = !DILocation(line: 338, column: 62, scope: !886)
!908 = !DILocation(line: 339, column: 15, scope: !899)
!909 = !DILocation(line: 339, column: 8, scope: !886)
!910 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !920)
!911 = distinct !DISubprogram(name: "divRndUp<int>", linkageName: "_ZN8dwt_cuda8divRndUpIiEET_RKS1_S3_", scope: !887, file: !888, line: 74, type: !912, isLocal: false, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !915, variables: !917)
!912 = !DISubroutineType(types: !913)
!913 = !{!160, !914, !914}
!914 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !900, size: 64, align: 64)
!915 = !{!916}
!916 = !DITemplateTypeParameter(name: "T", type: !160)
!917 = !{!918, !919}
!918 = !DILocalVariable(name: "n", arg: 1, scope: !911, file: !888, line: 74, type: !914)
!919 = !DILocalVariable(name: "d", arg: 2, scope: !911, file: !888, line: 74, type: !914)
!920 = distinct !DILocation(line: 341, column: 27, scope: !898)
!921 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !920)
!922 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !920)
!923 = !DILocation(line: 341, column: 17, scope: !898)
!924 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !925)
!925 = distinct !DILocation(line: 342, column: 27, scope: !898)
!926 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !925)
!927 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !925)
!928 = !DILocation(line: 342, column: 17, scope: !898)
!929 = !DILocation(line: 343, column: 48, scope: !898)
!930 = !DILocation(line: 343, column: 7, scope: !898)
!931 = !DILocation(line: 346, column: 24, scope: !898)
!932 = !DILocation(line: 346, column: 33, scope: !898)
!933 = !DILocalVariable(name: "dest", arg: 1, scope: !934, file: !888, line: 238, type: !937)
!934 = distinct !DISubprogram(name: "memCopy<int>", linkageName: "_ZN8dwt_cuda7memCopyIiEEvPT_PKS1_mm", scope: !887, file: !888, line: 238, type: !935, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !915, variables: !941)
!935 = !DISubroutineType(types: !936)
!936 = !{null, !937, !938, !940, !940}
!937 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !165)
!938 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !939)
!939 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !900, size: 64, align: 64)
!940 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !386)
!941 = !{!933, !942, !943, !944, !945}
!942 = !DILocalVariable(name: "src", arg: 2, scope: !934, file: !888, line: 238, type: !938)
!943 = !DILocalVariable(name: "sx", arg: 3, scope: !934, file: !888, line: 239, type: !940)
!944 = !DILocalVariable(name: "sy", arg: 4, scope: !934, file: !888, line: 239, type: !940)
!945 = !DILocalVariable(name: "status", scope: !934, file: !888, line: 240, type: !946)
!946 = !DIDerivedType(tag: DW_TAG_typedef, name: "cudaError_t", file: !4, line: 1420, baseType: !3)
!947 = !DILocation(line: 238, column: 33, scope: !934, inlinedAt: !948)
!948 = distinct !DILocation(line: 346, column: 7, scope: !898)
!949 = !DILocation(line: 238, column: 55, scope: !934, inlinedAt: !948)
!950 = !DILocation(line: 239, column: 36, scope: !934, inlinedAt: !948)
!951 = !DILocation(line: 239, column: 53, scope: !934, inlinedAt: !948)
!952 = !DILocation(line: 242, column: 25, scope: !934, inlinedAt: !948)
!953 = !DILocation(line: 242, column: 31, scope: !934, inlinedAt: !948)
!954 = !DILocation(line: 242, column: 38, scope: !934, inlinedAt: !948)
!955 = !DILocation(line: 242, column: 41, scope: !934, inlinedAt: !948)
!956 = !DILocation(line: 242, column: 14, scope: !934, inlinedAt: !948)
!957 = !DILocation(line: 240, column: 17, scope: !934, inlinedAt: !948)
!958 = !DILocation(line: 347, column: 5, scope: !898)
!959 = !DILocation(line: 350, column: 14, scope: !960)
!960 = distinct !DILexicalBlock(scope: !886, file: !1, line: 350, column: 8)
!961 = !DILocation(line: 350, column: 8, scope: !886)
!962 = !DILocalVariable(name: "in", arg: 1, scope: !963, file: !1, line: 314, type: !165)
!963 = distinct !DISubprogram(name: "launchRDWT53Kernel<192, 8>", linkageName: "_ZN8dwt_cuda18launchRDWT53KernelILi192ELi8EEEvPiS1_ii", scope: !887, file: !1, line: 314, type: !964, isLocal: false, isDefinition: true, scopeLine: 314, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !966, variables: !969)
!964 = !DISubroutineType(types: !965)
!965 = !{null, !165, !165, !900, !900}
!966 = !{!967, !968}
!967 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 192)
!968 = !DITemplateValueParameter(name: "WIN_SY", type: !160, value: i32 8)
!969 = !{!962, !970, !971, !972, !973, !974}
!970 = !DILocalVariable(name: "out", arg: 2, scope: !963, file: !1, line: 314, type: !165)
!971 = !DILocalVariable(name: "sx", arg: 3, scope: !963, file: !1, line: 314, type: !900)
!972 = !DILocalVariable(name: "sy", arg: 4, scope: !963, file: !1, line: 314, type: !900)
!973 = !DILocalVariable(name: "steps", scope: !963, file: !1, line: 316, type: !900)
!974 = !DILocalVariable(name: "gSize", scope: !963, file: !1, line: 319, type: !975)
!975 = !DIDerivedType(tag: DW_TAG_typedef, name: "dim3", file: !976, line: 427, baseType: !977)
!976 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
!977 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "dim3", file: !976, line: 417, size: 96, align: 32, elements: !978, identifier: "_ZTS4dim3")
!978 = !{!979, !980, !981, !982, !986, !995}
!979 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !977, file: !976, line: 419, baseType: !456, size: 32, align: 32)
!980 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !977, file: !976, line: 419, baseType: !456, size: 32, align: 32, offset: 32)
!981 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !977, file: !976, line: 419, baseType: !456, size: 32, align: 32, offset: 64)
!982 = !DISubprogram(name: "dim3", scope: !977, file: !976, line: 421, type: !983, isLocal: false, isDefinition: false, scopeLine: 421, flags: DIFlagPrototyped, isOptimized: true)
!983 = !DISubroutineType(types: !984)
!984 = !{null, !985, !456, !456, !456}
!985 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !977, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!986 = !DISubprogram(name: "dim3", scope: !977, file: !976, line: 422, type: !987, isLocal: false, isDefinition: false, scopeLine: 422, flags: DIFlagPrototyped, isOptimized: true)
!987 = !DISubroutineType(types: !988)
!988 = !{null, !985, !989}
!989 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint3", file: !976, line: 383, baseType: !990)
!990 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uint3", file: !976, line: 190, size: 96, align: 32, elements: !991, identifier: "_ZTS5uint3")
!991 = !{!992, !993, !994}
!992 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !990, file: !976, line: 192, baseType: !456, size: 32, align: 32)
!993 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !990, file: !976, line: 192, baseType: !456, size: 32, align: 32, offset: 32)
!994 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !990, file: !976, line: 192, baseType: !456, size: 32, align: 32, offset: 64)
!995 = !DISubprogram(name: "operator uint3", linkageName: "_ZN4dim3cv5uint3Ev", scope: !977, file: !976, line: 423, type: !996, isLocal: false, isDefinition: false, scopeLine: 423, flags: DIFlagPrototyped, isOptimized: true)
!996 = !DISubroutineType(types: !997)
!997 = !{!989, !985}
!998 = !DILocation(line: 314, column: 34, scope: !963, inlinedAt: !999)
!999 = distinct !DILocation(line: 351, column: 7, scope: !1000)
!1000 = distinct !DILexicalBlock(scope: !960, file: !1, line: 350, column: 22)
!1001 = !DILocation(line: 314, column: 44, scope: !963, inlinedAt: !999)
!1002 = !DILocation(line: 314, column: 59, scope: !963, inlinedAt: !999)
!1003 = !DILocation(line: 314, column: 73, scope: !963, inlinedAt: !999)
!1004 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1005)
!1005 = distinct !DILocation(line: 316, column: 23, scope: !963, inlinedAt: !999)
!1006 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1005)
!1007 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1005)
!1008 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1005)
!1009 = !DILocation(line: 316, column: 15, scope: !963, inlinedAt: !999)
!1010 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1011)
!1011 = distinct !DILocation(line: 319, column: 16, scope: !963, inlinedAt: !999)
!1012 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1011)
!1013 = !DILocation(line: 319, column: 58, scope: !963, inlinedAt: !999)
!1014 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1015)
!1015 = distinct !DILocation(line: 319, column: 38, scope: !1016, inlinedAt: !999)
!1016 = !DILexicalBlockFile(scope: !963, file: !1, discriminator: 1)
!1017 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1015)
!1018 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1015)
!1019 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1015)
!1020 = !DIExpression(DW_OP_deref)
!1021 = !DILocation(line: 319, column: 10, scope: !963, inlinedAt: !999)
!1022 = !DILocation(line: 323, column: 36, scope: !963, inlinedAt: !999)
!1023 = !DILocation(line: 323, column: 33, scope: !1024, inlinedAt: !999)
!1024 = !DILexicalBlockFile(scope: !963, file: !1, discriminator: 2)
!1025 = !DILocation(line: 323, column: 33, scope: !963, inlinedAt: !999)
!1026 = !DILocation(line: 323, column: 5, scope: !963, inlinedAt: !999)
!1027 = !DILocation(line: 323, column: 5, scope: !1016, inlinedAt: !999)
!1028 = !DILocation(line: 352, column: 22, scope: !1029)
!1029 = !DILexicalBlockFile(scope: !1030, file: !1, discriminator: 1)
!1030 = distinct !DILexicalBlock(scope: !960, file: !1, line: 352, column: 16)
!1031 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1032)
!1032 = distinct !DILocation(line: 316, column: 23, scope: !1033, inlinedAt: !1043)
!1033 = distinct !DISubprogram(name: "launchRDWT53Kernel<128, 8>", linkageName: "_ZN8dwt_cuda18launchRDWT53KernelILi128ELi8EEEvPiS1_ii", scope: !887, file: !1, line: 314, type: !964, isLocal: false, isDefinition: true, scopeLine: 314, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1034, variables: !1036)
!1034 = !{!1035, !968}
!1035 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 128)
!1036 = !{!1037, !1038, !1039, !1040, !1041, !1042}
!1037 = !DILocalVariable(name: "in", arg: 1, scope: !1033, file: !1, line: 314, type: !165)
!1038 = !DILocalVariable(name: "out", arg: 2, scope: !1033, file: !1, line: 314, type: !165)
!1039 = !DILocalVariable(name: "sx", arg: 3, scope: !1033, file: !1, line: 314, type: !900)
!1040 = !DILocalVariable(name: "sy", arg: 4, scope: !1033, file: !1, line: 314, type: !900)
!1041 = !DILocalVariable(name: "steps", scope: !1033, file: !1, line: 316, type: !900)
!1042 = !DILocalVariable(name: "gSize", scope: !1033, file: !1, line: 319, type: !975)
!1043 = distinct !DILocation(line: 353, column: 7, scope: !1044)
!1044 = distinct !DILexicalBlock(scope: !1030, file: !1, line: 352, column: 30)
!1045 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1032)
!1046 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1032)
!1047 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1032)
!1048 = !DILocation(line: 352, column: 16, scope: !1029)
!1049 = !DILocation(line: 314, column: 34, scope: !1033, inlinedAt: !1043)
!1050 = !DILocation(line: 314, column: 44, scope: !1033, inlinedAt: !1043)
!1051 = !DILocation(line: 314, column: 59, scope: !1033, inlinedAt: !1043)
!1052 = !DILocation(line: 314, column: 73, scope: !1033, inlinedAt: !1043)
!1053 = !DILocation(line: 316, column: 15, scope: !1033, inlinedAt: !1043)
!1054 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1055)
!1055 = distinct !DILocation(line: 319, column: 16, scope: !1033, inlinedAt: !1043)
!1056 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1055)
!1057 = !DILocation(line: 319, column: 58, scope: !1033, inlinedAt: !1043)
!1058 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1059)
!1059 = distinct !DILocation(line: 319, column: 38, scope: !1060, inlinedAt: !1043)
!1060 = !DILexicalBlockFile(scope: !1033, file: !1, discriminator: 1)
!1061 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1059)
!1062 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1059)
!1063 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1059)
!1064 = !DILocation(line: 319, column: 10, scope: !1033, inlinedAt: !1043)
!1065 = !DILocation(line: 323, column: 36, scope: !1033, inlinedAt: !1043)
!1066 = !DILocation(line: 323, column: 33, scope: !1067, inlinedAt: !1043)
!1067 = !DILexicalBlockFile(scope: !1033, file: !1, discriminator: 2)
!1068 = !DILocation(line: 323, column: 33, scope: !1033, inlinedAt: !1043)
!1069 = !DILocation(line: 323, column: 5, scope: !1033, inlinedAt: !1043)
!1070 = !DILocation(line: 323, column: 5, scope: !1060, inlinedAt: !1043)
!1071 = !DILocalVariable(name: "in", arg: 1, scope: !1072, file: !1, line: 314, type: !165)
!1072 = distinct !DISubprogram(name: "launchRDWT53Kernel<64, 8>", linkageName: "_ZN8dwt_cuda18launchRDWT53KernelILi64ELi8EEEvPiS1_ii", scope: !887, file: !1, line: 314, type: !964, isLocal: false, isDefinition: true, scopeLine: 314, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1073, variables: !1075)
!1073 = !{!1074, !968}
!1074 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 64)
!1075 = !{!1071, !1076, !1077, !1078, !1079, !1080}
!1076 = !DILocalVariable(name: "out", arg: 2, scope: !1072, file: !1, line: 314, type: !165)
!1077 = !DILocalVariable(name: "sx", arg: 3, scope: !1072, file: !1, line: 314, type: !900)
!1078 = !DILocalVariable(name: "sy", arg: 4, scope: !1072, file: !1, line: 314, type: !900)
!1079 = !DILocalVariable(name: "steps", scope: !1072, file: !1, line: 316, type: !900)
!1080 = !DILocalVariable(name: "gSize", scope: !1072, file: !1, line: 319, type: !975)
!1081 = !DILocation(line: 314, column: 34, scope: !1072, inlinedAt: !1082)
!1082 = distinct !DILocation(line: 355, column: 7, scope: !1083)
!1083 = distinct !DILexicalBlock(scope: !1030, file: !1, line: 354, column: 12)
!1084 = !DILocation(line: 314, column: 44, scope: !1072, inlinedAt: !1082)
!1085 = !DILocation(line: 314, column: 59, scope: !1072, inlinedAt: !1082)
!1086 = !DILocation(line: 314, column: 73, scope: !1072, inlinedAt: !1082)
!1087 = !DILocation(line: 316, column: 15, scope: !1072, inlinedAt: !1082)
!1088 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1089)
!1089 = distinct !DILocation(line: 319, column: 16, scope: !1072, inlinedAt: !1082)
!1090 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1089)
!1091 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1089)
!1092 = !DILocation(line: 319, column: 58, scope: !1072, inlinedAt: !1082)
!1093 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1094)
!1094 = distinct !DILocation(line: 319, column: 38, scope: !1095, inlinedAt: !1082)
!1095 = !DILexicalBlockFile(scope: !1072, file: !1, discriminator: 1)
!1096 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1094)
!1097 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1094)
!1098 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1094)
!1099 = !DILocation(line: 319, column: 10, scope: !1072, inlinedAt: !1082)
!1100 = !DILocation(line: 323, column: 36, scope: !1072, inlinedAt: !1082)
!1101 = !DILocation(line: 323, column: 33, scope: !1102, inlinedAt: !1082)
!1102 = !DILexicalBlockFile(scope: !1072, file: !1, discriminator: 2)
!1103 = !DILocation(line: 323, column: 33, scope: !1072, inlinedAt: !1082)
!1104 = !DILocation(line: 323, column: 5, scope: !1072, inlinedAt: !1082)
!1105 = !DILocation(line: 323, column: 5, scope: !1095, inlinedAt: !1082)
!1106 = !DILocation(line: 357, column: 3, scope: !886)
!1107 = distinct !DISubprogram(name: "rdwt53Kernel<192, 8>", linkageName: "_ZN8dwt_cuda12rdwt53KernelILi192ELi8EEEvPKiPiiii", scope: !887, file: !1, line: 298, type: !1108, isLocal: false, isDefinition: true, scopeLine: 299, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !966, variables: !1110)
!1108 = !DISubroutineType(types: !1109)
!1109 = !{null, !938, !937, !900, !900, !900}
!1110 = !{!1111, !1112, !1113, !1114, !1115}
!1111 = !DILocalVariable(name: "in", arg: 1, scope: !1107, file: !1, line: 298, type: !938)
!1112 = !DILocalVariable(name: "out", arg: 2, scope: !1107, file: !1, line: 298, type: !937)
!1113 = !DILocalVariable(name: "sx", arg: 3, scope: !1107, file: !1, line: 299, type: !900)
!1114 = !DILocalVariable(name: "sy", arg: 4, scope: !1107, file: !1, line: 299, type: !900)
!1115 = !DILocalVariable(name: "steps", arg: 5, scope: !1107, file: !1, line: 299, type: !900)
!1116 = !DILocation(line: 298, column: 50, scope: !1107)
!1117 = !{!1118, !1118, i64 0}
!1118 = !{!"any pointer", !1119, i64 0}
!1119 = !{!"omnipotent char", !1120, i64 0}
!1120 = !{!"Simple C++ TBAA"}
!1121 = !DILocation(line: 298, column: 66, scope: !1107)
!1122 = !DILocation(line: 299, column: 42, scope: !1107)
!1123 = !{!1124, !1124, i64 0}
!1124 = !{!"int", !1119, i64 0}
!1125 = !DILocation(line: 299, column: 56, scope: !1107)
!1126 = !DILocation(line: 299, column: 70, scope: !1107)
!1127 = !DILocation(line: 299, column: 77, scope: !1107)
!1128 = !DILocation(line: 299, column: 77, scope: !1129)
!1129 = !DILexicalBlockFile(scope: !1107, file: !1, discriminator: 1)
!1130 = !DILocation(line: 299, column: 77, scope: !1131)
!1131 = !DILexicalBlockFile(scope: !1107, file: !1, discriminator: 2)
!1132 = !DILocation(line: 299, column: 77, scope: !1133)
!1133 = !DILexicalBlockFile(scope: !1107, file: !1, discriminator: 3)
!1134 = !DILocation(line: 299, column: 77, scope: !1135)
!1135 = !DILexicalBlockFile(scope: !1107, file: !1, discriminator: 4)
!1136 = !DILocation(line: 299, column: 77, scope: !1137)
!1137 = !DILexicalBlockFile(scope: !1107, file: !1, discriminator: 5)
!1138 = !DILocation(line: 301, column: 3, scope: !1107)
!1139 = distinct !DISubprogram(name: "rdwt53Kernel<128, 8>", linkageName: "_ZN8dwt_cuda12rdwt53KernelILi128ELi8EEEvPKiPiiii", scope: !887, file: !1, line: 298, type: !1108, isLocal: false, isDefinition: true, scopeLine: 299, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1034, variables: !1140)
!1140 = !{!1141, !1142, !1143, !1144, !1145}
!1141 = !DILocalVariable(name: "in", arg: 1, scope: !1139, file: !1, line: 298, type: !938)
!1142 = !DILocalVariable(name: "out", arg: 2, scope: !1139, file: !1, line: 298, type: !937)
!1143 = !DILocalVariable(name: "sx", arg: 3, scope: !1139, file: !1, line: 299, type: !900)
!1144 = !DILocalVariable(name: "sy", arg: 4, scope: !1139, file: !1, line: 299, type: !900)
!1145 = !DILocalVariable(name: "steps", arg: 5, scope: !1139, file: !1, line: 299, type: !900)
!1146 = !DILocation(line: 298, column: 50, scope: !1139)
!1147 = !DILocation(line: 298, column: 66, scope: !1139)
!1148 = !DILocation(line: 299, column: 42, scope: !1139)
!1149 = !DILocation(line: 299, column: 56, scope: !1139)
!1150 = !DILocation(line: 299, column: 70, scope: !1139)
!1151 = !DILocation(line: 299, column: 77, scope: !1139)
!1152 = !DILocation(line: 299, column: 77, scope: !1153)
!1153 = !DILexicalBlockFile(scope: !1139, file: !1, discriminator: 1)
!1154 = !DILocation(line: 299, column: 77, scope: !1155)
!1155 = !DILexicalBlockFile(scope: !1139, file: !1, discriminator: 2)
!1156 = !DILocation(line: 299, column: 77, scope: !1157)
!1157 = !DILexicalBlockFile(scope: !1139, file: !1, discriminator: 3)
!1158 = !DILocation(line: 299, column: 77, scope: !1159)
!1159 = !DILexicalBlockFile(scope: !1139, file: !1, discriminator: 4)
!1160 = !DILocation(line: 299, column: 77, scope: !1161)
!1161 = !DILexicalBlockFile(scope: !1139, file: !1, discriminator: 5)
!1162 = !DILocation(line: 301, column: 3, scope: !1139)
!1163 = distinct !DISubprogram(name: "rdwt53Kernel<64, 8>", linkageName: "_ZN8dwt_cuda12rdwt53KernelILi64ELi8EEEvPKiPiiii", scope: !887, file: !1, line: 298, type: !1108, isLocal: false, isDefinition: true, scopeLine: 299, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1073, variables: !1164)
!1164 = !{!1165, !1166, !1167, !1168, !1169}
!1165 = !DILocalVariable(name: "in", arg: 1, scope: !1163, file: !1, line: 298, type: !938)
!1166 = !DILocalVariable(name: "out", arg: 2, scope: !1163, file: !1, line: 298, type: !937)
!1167 = !DILocalVariable(name: "sx", arg: 3, scope: !1163, file: !1, line: 299, type: !900)
!1168 = !DILocalVariable(name: "sy", arg: 4, scope: !1163, file: !1, line: 299, type: !900)
!1169 = !DILocalVariable(name: "steps", arg: 5, scope: !1163, file: !1, line: 299, type: !900)
!1170 = !DILocation(line: 298, column: 50, scope: !1163)
!1171 = !DILocation(line: 298, column: 66, scope: !1163)
!1172 = !DILocation(line: 299, column: 42, scope: !1163)
!1173 = !DILocation(line: 299, column: 56, scope: !1163)
!1174 = !DILocation(line: 299, column: 70, scope: !1163)
!1175 = !DILocation(line: 299, column: 77, scope: !1163)
!1176 = !DILocation(line: 299, column: 77, scope: !1177)
!1177 = !DILexicalBlockFile(scope: !1163, file: !1, discriminator: 1)
!1178 = !DILocation(line: 299, column: 77, scope: !1179)
!1179 = !DILexicalBlockFile(scope: !1163, file: !1, discriminator: 2)
!1180 = !DILocation(line: 299, column: 77, scope: !1181)
!1181 = !DILexicalBlockFile(scope: !1163, file: !1, discriminator: 3)
!1182 = !DILocation(line: 299, column: 77, scope: !1183)
!1183 = !DILexicalBlockFile(scope: !1163, file: !1, discriminator: 4)
!1184 = !DILocation(line: 299, column: 77, scope: !1185)
!1185 = !DILexicalBlockFile(scope: !1163, file: !1, discriminator: 5)
!1186 = !DILocation(line: 301, column: 3, scope: !1163)
