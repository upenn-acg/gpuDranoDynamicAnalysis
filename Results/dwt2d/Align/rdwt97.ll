; ModuleID = 'Results/dwt2d/dwt_cuda/rdwt97.cu'
source_filename = "Results/dwt2d/dwt_cuda/rdwt97.cu"
...
define void @_ZN8dwt_cuda6rdwt97EPfS0_iii(float* %in, float* %out, i32 %sizeX, i32 %sizeY, i32 %levels) local_unnamed_addr #0 !dbg !886 {
entry:
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !892, metadata !902), !dbg !903
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !893, metadata !902), !dbg !904
...
if.then:                                          ; preds = %entry
  ...
  tail call void @_ZN8dwt_cuda6rdwt97EPfS0_iii(float* %in, float* %out, i32 %add.i, i32 %add.i26, i32 %sub), !dbg !930
  %conv = sext i32 %add.i to i64, !dbg !931
  %conv3 = sext i32 %add.i26 to i64, !dbg !932
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !933, metadata !902), !dbg !950
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !945, metadata !902), !dbg !952
  tail call void @llvm.dbg.value(metadata i64 %conv, i64 0, metadata !946, metadata !902), !dbg !953
  tail call void @llvm.dbg.value(metadata i64 %conv3, i64 0, metadata !947, metadata !902), !dbg !954
  %0 = bitcast float* %in to i8*, !dbg !955
  %1 = bitcast float* %out to i8*, !dbg !956
  %mul.i51 = shl nsw i64 %conv, 2, !dbg !957
  %mul1.i = mul i64 %mul.i51, %conv3, !dbg !958
  %call.i = tail call i32 @cudaMemcpy(i8* %0, i8* %1, i64 %mul1.i, i32 3), !dbg !959
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !948, metadata !902), !dbg !960
  br label %if.end, !dbg !961

if.end:                                           ; preds = %if.then, %entry
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !894, metadata !902), !dbg !905
  %cmp4 = icmp sgt i32 %sizeX, 959, !dbg !962
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !895, metadata !902), !dbg !906
  br i1 %cmp4, label %if.then5, label %if.else, !dbg !964

if.then5:                                         ; preds = %if.end
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !965, metadata !902), !dbg !1001
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !973, metadata !902), !dbg !1004
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !974, metadata !902), !dbg !1005
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !975, metadata !902), !dbg !1006
  %div.i.i52 = sdiv i32 %sizeY, 120, !dbg !1007
  %rem.i.i53 = srem i32 %sizeY, 120, !dbg !1009
  %tobool.i.i54 = icmp ne i32 %rem.i.i53, 0, !dbg !1010
  %cond.i.i55 = zext i1 %tobool.i.i54 to i32, !dbg !1010
  %add.i.i56 = add nsw i32 %cond.i.i55, %div.i.i52, !dbg !1011
  tail call void @llvm.dbg.value(metadata i32 %add.i.i56, i64 0, metadata !976, metadata !902), !dbg !1012
  %div.i13.i5778 = udiv i32 %sizeX, 192
  %rem.i14.i79 = urem i32 %sizeX, 192
  %tobool.i15.i58 = icmp ne i32 %rem.i14.i79, 0, !dbg !1013
  %cond.i16.i59 = zext i1 %tobool.i15.i58 to i32, !dbg !1013
  %add.i17.i60 = add nuw nsw i32 %cond.i16.i59, %div.i13.i5778, !dbg !1015
  %mul.i61 = shl nsw i32 %add.i.i56, 3, !dbg !1016
  %div.i21.i62 = sdiv i32 %sizeY, %mul.i61, !dbg !1017
  %rem.i22.i63 = srem i32 %sizeY, %mul.i61, !dbg !1020
  %tobool.i23.i64 = icmp ne i32 %rem.i22.i63, 0, !dbg !1021
  %cond.i24.i65 = zext i1 %tobool.i23.i64 to i32, !dbg !1021
  %add.i25.i66 = add nsw i32 %cond.i24.i65, %div.i21.i62, !dbg !1022
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !977, metadata !1023), !dbg !1024
  %gSize.sroa.0.sroa.4.0.insert.ext.i67 = zext i32 %add.i25.i66 to i64, !dbg !1025
  %gSize.sroa.0.sroa.4.0.insert.shift.i68 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i67, 32, !dbg !1025
  %gSize.sroa.0.sroa.0.0.insert.ext.i69 = zext i32 %add.i17.i60 to i64, !dbg !1025
  %gSize.sroa.0.sroa.0.0.insert.insert.i70 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i68, %gSize.sroa.0.sroa.0.0.insert.ext.i69, !dbg !1025
  %call6.i71 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i70, i32 1, i64 4294967488, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1026
  %tobool.i72 = icmp eq i32 %call6.i71, 0, !dbg !1028
  br i1 %tobool.i72, label %kcall.configok.i73, label %if.end10, !dbg !1029

kcall.configok.i73:                               ; preds = %if.then5
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !974, metadata !902), !dbg !1005
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !975, metadata !902), !dbg !1006
  tail call void @_ZN8dwt_cuda12rdwt97KernelILi192ELi8EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i56), !dbg !1030
  br label %if.end10, !dbg !1030

if.else:                                          ; preds = %if.end
  %cmp6 = icmp sgt i32 %sizeX, 479, !dbg !1031
  %div.i.i = sdiv i32 %sizeY, 90, !dbg !1034
  %rem.i.i = srem i32 %sizeY, 90, !dbg !1049
  %tobool.i.i = icmp ne i32 %rem.i.i, 0, !dbg !1050
  %cond.i.i = zext i1 %tobool.i.i to i32, !dbg !1050
  %add.i.i = add nsw i32 %cond.i.i, %div.i.i, !dbg !1051
  br i1 %cmp6, label %if.then7, label %if.else8, !dbg !1052

if.then7:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1041, metadata !902), !dbg !1053
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1042, metadata !902), !dbg !1054
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1043, metadata !902), !dbg !1055
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1044, metadata !902), !dbg !1056
  tail call void @llvm.dbg.value(metadata i32 %add.i.i, i64 0, metadata !1045, metadata !902), !dbg !1057
  %div.i13.i80 = lshr i32 %sizeX, 7
  %rem.i1436.i = and i32 %sizeX, 127, !dbg !1058
  %tobool.i15.i = icmp ne i32 %rem.i1436.i, 0, !dbg !1058
  %cond.i16.i = zext i1 %tobool.i15.i to i32, !dbg !1058
  %add.i17.i = add nuw nsw i32 %cond.i16.i, %div.i13.i80, !dbg !1060
  %mul.i = mul nsw i32 %add.i.i, 6, !dbg !1061
  %div.i21.i = sdiv i32 %sizeY, %mul.i, !dbg !1062
  %rem.i22.i = srem i32 %sizeY, %mul.i, !dbg !1065
  %tobool.i23.i = icmp ne i32 %rem.i22.i, 0, !dbg !1066
  %cond.i24.i = zext i1 %tobool.i23.i to i32, !dbg !1066
  %add.i25.i = add nsw i32 %cond.i24.i, %div.i21.i, !dbg !1067
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1046, metadata !1023), !dbg !1068
  %gSize.sroa.0.sroa.4.0.insert.ext.i = zext i32 %add.i25.i to i64, !dbg !1069
  %gSize.sroa.0.sroa.4.0.insert.shift.i = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i, 32, !dbg !1069
  %gSize.sroa.0.sroa.0.0.insert.ext.i = zext i32 %add.i17.i to i64, !dbg !1069
  %gSize.sroa.0.sroa.0.0.insert.insert.i = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i, %gSize.sroa.0.sroa.0.0.insert.ext.i, !dbg !1069
  %call6.i = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i, i32 1, i64 4294967424, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1070
  %tobool.i27 = icmp eq i32 %call6.i, 0, !dbg !1072
  br i1 %tobool.i27, label %kcall.configok.i, label %if.end10, !dbg !1073

kcall.configok.i:                                 ; preds = %if.then7
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1043, metadata !902), !dbg !1055
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1044, metadata !902), !dbg !1056
  tail call void @_ZN8dwt_cuda12rdwt97KernelILi128ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i), !dbg !1074
  br label %if.end10, !dbg !1074

if.else8:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1075, metadata !902), !dbg !1085
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1080, metadata !902), !dbg !1088
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1081, metadata !902), !dbg !1089
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1082, metadata !902), !dbg !1090
  tail call void @llvm.dbg.value(metadata i32 %add.i.i, i64 0, metadata !1083, metadata !902), !dbg !1091
  %div.i13.i33 = sdiv i32 %sizeX, 64, !dbg !1092
  %rem.i1436.i34 = and i32 %sizeX, 63, !dbg !1094
  %tobool.i15.i35 = icmp ne i32 %rem.i1436.i34, 0, !dbg !1094
  %cond.i16.i36 = zext i1 %tobool.i15.i35 to i32, !dbg !1094
  %add.i17.i37 = add nsw i32 %cond.i16.i36, %div.i13.i33, !dbg !1095
  %mul.i38 = mul nsw i32 %add.i.i, 6, !dbg !1096
  %div.i21.i39 = sdiv i32 %sizeY, %mul.i38, !dbg !1097
  %rem.i22.i40 = srem i32 %sizeY, %mul.i38, !dbg !1100
  %tobool.i23.i41 = icmp ne i32 %rem.i22.i40, 0, !dbg !1101
  %cond.i24.i42 = zext i1 %tobool.i23.i41 to i32, !dbg !1101
  %add.i25.i43 = add nsw i32 %cond.i24.i42, %div.i21.i39, !dbg !1102
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1084, metadata !1023), !dbg !1103
  %gSize.sroa.0.sroa.4.0.insert.ext.i44 = zext i32 %add.i25.i43 to i64, !dbg !1104
  %gSize.sroa.0.sroa.4.0.insert.shift.i45 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i44, 32, !dbg !1104
  %gSize.sroa.0.sroa.0.0.insert.ext.i46 = zext i32 %add.i17.i37 to i64, !dbg !1104
  %gSize.sroa.0.sroa.0.0.insert.insert.i47 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i45, %gSize.sroa.0.sroa.0.0.insert.ext.i46, !dbg !1104
  %call6.i48 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i47, i32 1, i64 4294967360, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1105
  %tobool.i49 = icmp eq i32 %call6.i48, 0, !dbg !1107
  br i1 %tobool.i49, label %kcall.configok.i50, label %if.end10, !dbg !1108

kcall.configok.i50:                               ; preds = %if.else8
  tail call void @llvm.dbg.value(metadata i32 %sizeX, i64 0, metadata !1081, metadata !902), !dbg !1089
  tail call void @llvm.dbg.value(metadata i32 %sizeY, i64 0, metadata !1082, metadata !902), !dbg !1090
  tail call void @_ZN8dwt_cuda12rdwt97KernelILi64ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX, i32 %sizeY, i32 %add.i.i), !dbg !1109
  br label %if.end10, !dbg !1109
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt97KernelILi192ELi8EEEvPKfPfiii(float* %in, float* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1111 {
entry:
  ...
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1115, metadata !902), !dbg !1120
  store float* %in, float** %in.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1116, metadata !902), !dbg !1125
  store float* %out, float** %out.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1117, metadata !902), !dbg !1126
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1118, metadata !902), !dbg !1129
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1119, metadata !902), !dbg !1130
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1127
  %0 = bitcast float** %in.addr to i8*, !dbg !1131
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1131
  %2 = icmp eq i32 %1, 0, !dbg !1131
  br i1 %2, label %setup.next, label %setup.end, !dbg !1131

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %out.addr to i8*, !dbg !1132
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1132
  %5 = icmp eq i32 %4, 0, !dbg !1132
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1132

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1134
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1134
  %8 = icmp eq i32 %7, 0, !dbg !1134
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1134

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1136
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1136
  %11 = icmp eq i32 %10, 0, !dbg !1136
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1136

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1138
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1138
  %14 = icmp eq i32 %13, 0, !dbg !1138
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1138

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt97KernelILi192ELi8EEEvPKfPfiii to i8*)), !dbg !1140
  br label %setup.end, !dbg !1140
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt97KernelILi128ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1143 {
entry:
  %in.addr = alloca float*, align 8
  %out.addr = alloca float*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1145, metadata !902), !dbg !1150
  store float* %in, float** %in.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1146, metadata !902), !dbg !1151
  store float* %out, float** %out.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1147, metadata !902), !dbg !1152
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1148, metadata !902), !dbg !1153
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1149, metadata !902), !dbg !1154
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1127
  %0 = bitcast float** %in.addr to i8*, !dbg !1155
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1155
  %2 = icmp eq i32 %1, 0, !dbg !1155
  br i1 %2, label %setup.next, label %setup.end, !dbg !1155

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %out.addr to i8*, !dbg !1156
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1156
  %5 = icmp eq i32 %4, 0, !dbg !1156
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1156

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1158
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1158
  %8 = icmp eq i32 %7, 0, !dbg !1158
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1158

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1160
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1160
  %11 = icmp eq i32 %10, 0, !dbg !1160
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1160

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1162
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1162
  %14 = icmp eq i32 %13, 0, !dbg !1162
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1162

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt97KernelILi128ELi6EEEvPKfPfiii to i8*)), !dbg !1164
  br label %setup.end, !dbg !1164
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12rdwt97KernelILi64ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1167 {
entry:
  %in.addr = alloca float*, align 8
  %out.addr = alloca float*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1169, metadata !902), !dbg !1174
  store float* %in, float** %in.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1170, metadata !902), !dbg !1175
  store float* %out, float** %out.addr, align 8, !tbaa !1121
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1171, metadata !902), !dbg !1176
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1172, metadata !902), !dbg !1177
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1127
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1173, metadata !902), !dbg !1178
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1127
  %0 = bitcast float** %in.addr to i8*, !dbg !1179
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1179
  %2 = icmp eq i32 %1, 0, !dbg !1179
  br i1 %2, label %setup.next, label %setup.end, !dbg !1179

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %out.addr to i8*, !dbg !1180
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1180
  %5 = icmp eq i32 %4, 0, !dbg !1180
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1180

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1182
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1182
  %8 = icmp eq i32 %7, 0, !dbg !1182
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1182

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1184
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1184
  %11 = icmp eq i32 %10, 0, !dbg !1184
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1184

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1186
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1186
  %14 = icmp eq i32 %13, 0, !dbg !1186
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1186

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12rdwt97KernelILi64ELi6EEEvPKfPfiii to i8*)), !dbg !1188
  br label %setup.end, !dbg !1188
...
!1 = !DIFile(filename: "Results/dwt2d/dwt_cuda/rdwt97.cu", directory: "/home/ec2-user/DynamicAnalyis")
!2 = !{!3, !86}
...
!886 = distinct !DISubprogram(name: "rdwt97", linkageName: "_ZN8dwt_cuda6rdwt97EPfS0_iii", scope: !887, file: !1, line: 340, type: !889, isLocal: false, isDefinition: true, scopeLine: 340, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !891)
...
!892 = !DILocalVariable(name: "in", arg: 1, scope: !886, file: !1, line: 340, type: !234)
!893 = !DILocalVariable(name: "out", arg: 2, scope: !886, file: !1, line: 340, type: !234)
!894 = !DILocalVariable(name: "sizeX", arg: 3, scope: !886, file: !1, line: 340, type: !160)
!895 = !DILocalVariable(name: "sizeY", arg: 4, scope: !886, file: !1, line: 340, type: !160)
!896 = !DILocalVariable(name: "levels", arg: 5, scope: !886, file: !1, line: 340, type: !160)
!897 = !DILocalVariable(name: "llSizeX", scope: !898, file: !1, line: 343, type: !900)
!898 = distinct !DILexicalBlock(scope: !899, file: !1, line: 341, column: 20)
!899 = distinct !DILexicalBlock(scope: !886, file: !1, line: 341, column: 8)
!900 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !160)
!901 = !DILocalVariable(name: "llSizeY", scope: !898, file: !1, line: 344, type: !900)
!902 = !DIExpression()
!903 = !DILocation(line: 340, column: 23, scope: !886)
!904 = !DILocation(line: 340, column: 35, scope: !886)
!905 = !DILocation(line: 340, column: 44, scope: !886)
!906 = !DILocation(line: 340, column: 55, scope: !886)
!907 = !DILocation(line: 340, column: 66, scope: !886)
!908 = !DILocation(line: 341, column: 15, scope: !899)
!909 = !DILocation(line: 341, column: 8, scope: !886)
...
!920 = distinct !DILocation(line: 343, column: 27, scope: !898)
!921 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !920)
!922 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !920)
!923 = !DILocation(line: 343, column: 17, scope: !898)
!924 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !925)
!925 = distinct !DILocation(line: 344, column: 27, scope: !898)
!926 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !925)
!927 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !925)
!928 = !DILocation(line: 344, column: 17, scope: !898)
!929 = !DILocation(line: 345, column: 48, scope: !898)
!930 = !DILocation(line: 345, column: 7, scope: !898)
!931 = !DILocation(line: 348, column: 24, scope: !898)
!932 = !DILocation(line: 348, column: 33, scope: !898)
!933 = !DILocalVariable(name: "dest", arg: 1, scope: !934, file: !888, line: 238, type: !937)
!934 = distinct !DISubprogram(name: "memCopy<float>", linkageName: "_ZN8dwt_cuda7memCopyIfEEvPT_PKS1_mm", scope: !887, file: !888, line: 238, type: !935, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !942, variables: !944)
!935 = !DISubroutineType(types: !936)
!936 = !{null, !937, !938, !941, !941}
!937 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !234)
!938 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !939)
!939 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !940, size: 64, align: 64)
!940 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !105)
!941 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !386)
!942 = !{!943}
!943 = !DITemplateTypeParameter(name: "T", type: !105)
!944 = !{!933, !945, !946, !947, !948}
!945 = !DILocalVariable(name: "src", arg: 2, scope: !934, file: !888, line: 238, type: !938)
!946 = !DILocalVariable(name: "sx", arg: 3, scope: !934, file: !888, line: 239, type: !941)
!947 = !DILocalVariable(name: "sy", arg: 4, scope: !934, file: !888, line: 239, type: !941)
!948 = !DILocalVariable(name: "status", scope: !934, file: !888, line: 240, type: !949)
!949 = !DIDerivedType(tag: DW_TAG_typedef, name: "cudaError_t", file: !4, line: 1420, baseType: !3)
!950 = !DILocation(line: 238, column: 33, scope: !934, inlinedAt: !951)
!951 = distinct !DILocation(line: 348, column: 7, scope: !898)
!952 = !DILocation(line: 238, column: 55, scope: !934, inlinedAt: !951)
!953 = !DILocation(line: 239, column: 36, scope: !934, inlinedAt: !951)
!954 = !DILocation(line: 239, column: 53, scope: !934, inlinedAt: !951)
!955 = !DILocation(line: 242, column: 25, scope: !934, inlinedAt: !951)
!956 = !DILocation(line: 242, column: 31, scope: !934, inlinedAt: !951)
!957 = !DILocation(line: 242, column: 38, scope: !934, inlinedAt: !951)
!958 = !DILocation(line: 242, column: 41, scope: !934, inlinedAt: !951)
!959 = !DILocation(line: 242, column: 14, scope: !934, inlinedAt: !951)
!960 = !DILocation(line: 240, column: 17, scope: !934, inlinedAt: !951)
!961 = !DILocation(line: 349, column: 5, scope: !898)
!962 = !DILocation(line: 352, column: 14, scope: !963)
!963 = distinct !DILexicalBlock(scope: !886, file: !1, line: 352, column: 8)
!964 = !DILocation(line: 352, column: 8, scope: !886)
!965 = !DILocalVariable(name: "in", arg: 1, scope: !966, file: !1, line: 316, type: !234)
!966 = distinct !DISubprogram(name: "launchRDWT97Kernel<192, 8>", linkageName: "_ZN8dwt_cuda18launchRDWT97KernelILi192ELi8EEEvPfS1_ii", scope: !887, file: !1, line: 316, type: !967, isLocal: false, isDefinition: true, scopeLine: 316, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !969, variables: !972)
!967 = !DISubroutineType(types: !968)
!968 = !{null, !234, !234, !160, !160}
!969 = !{!970, !971}
!970 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 192)
!971 = !DITemplateValueParameter(name: "WIN_SY", type: !160, value: i32 8)
!972 = !{!965, !973, !974, !975, !976, !977}
!973 = !DILocalVariable(name: "out", arg: 2, scope: !966, file: !1, line: 316, type: !234)
!974 = !DILocalVariable(name: "sx", arg: 3, scope: !966, file: !1, line: 316, type: !160)
!975 = !DILocalVariable(name: "sy", arg: 4, scope: !966, file: !1, line: 316, type: !160)
!976 = !DILocalVariable(name: "steps", scope: !966, file: !1, line: 318, type: !900)
!977 = !DILocalVariable(name: "gSize", scope: !966, file: !1, line: 321, type: !978)
!978 = !DIDerivedType(tag: DW_TAG_typedef, name: "dim3", file: !979, line: 427, baseType: !980)
!979 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
...
!982 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !980, file: !979, line: 419, baseType: !456, size: 32, align: 32)
!983 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !980, file: !979, line: 419, baseType: !456, size: 32, align: 32, offset: 32)
!984 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !980, file: !979, line: 419, baseType: !456, size: 32, align: 32, offset: 64)
!985 = !DISubprogram(name: "dim3", scope: !980, file: !979, line: 421, type: !986, isLocal: false, isDefinition: false, scopeLine: 421, flags: DIFlagPrototyped, isOptimized: true)
!986 = !DISubroutineType(types: !987)
!987 = !{null, !988, !456, !456, !456}
!988 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !980, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!989 = !DISubprogram(name: "dim3", scope: !980, file: !979, line: 422, type: !990, isLocal: false, isDefinition: false, scopeLine: 422, flags: DIFlagPrototyped, isOptimized: true)
...
!994 = !{!995, !996, !997}
!995 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !993, file: !979, line: 192, baseType: !456, size: 32, align: 32)
!996 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !993, file: !979, line: 192, baseType: !456, size: 32, align: 32, offset: 32)
!997 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !993, file: !979, line: 192, baseType: !456, size: 32, align: 32, offset: 64)
!998 = !DISubprogram(name: "operator uint3", linkageName: "_ZN4dim3cv5uint3Ev", scope: !980, file: !979, line: 423, type: !999, isLocal: false, isDefinition: false, scopeLine: 423, flags: DIFlagPrototyped, isOptimized: true)
!999 = !DISubroutineType(types: !1000)
!1000 = !{!992, !988}
!1001 = !DILocation(line: 316, column: 36, scope: !966, inlinedAt: !1002)
!1002 = distinct !DILocation(line: 353, column: 7, scope: !1003)
!1003 = distinct !DILexicalBlock(scope: !963, file: !1, line: 352, column: 22)
!1004 = !DILocation(line: 316, column: 48, scope: !966, inlinedAt: !1002)
!1005 = !DILocation(line: 316, column: 57, scope: !966, inlinedAt: !1002)
!1006 = !DILocation(line: 316, column: 65, scope: !966, inlinedAt: !1002)
!1007 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1008)
!1008 = distinct !DILocation(line: 318, column: 23, scope: !966, inlinedAt: !1002)
!1009 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1008)
!1010 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1008)
!1011 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1008)
!1012 = !DILocation(line: 318, column: 15, scope: !966, inlinedAt: !1002)
!1013 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1014)
!1014 = distinct !DILocation(line: 321, column: 16, scope: !966, inlinedAt: !1002)
!1015 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1014)
!1016 = !DILocation(line: 321, column: 58, scope: !966, inlinedAt: !1002)
!1017 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1018)
!1018 = distinct !DILocation(line: 321, column: 38, scope: !1019, inlinedAt: !1002)
!1019 = !DILexicalBlockFile(scope: !966, file: !1, discriminator: 1)
!1020 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1018)
!1021 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1018)
!1022 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1018)
!1023 = !DIExpression(DW_OP_deref)
!1024 = !DILocation(line: 321, column: 10, scope: !966, inlinedAt: !1002)
!1025 = !DILocation(line: 325, column: 36, scope: !966, inlinedAt: !1002)
!1026 = !DILocation(line: 325, column: 33, scope: !1027, inlinedAt: !1002)
!1027 = !DILexicalBlockFile(scope: !966, file: !1, discriminator: 2)
!1028 = !DILocation(line: 325, column: 33, scope: !966, inlinedAt: !1002)
!1029 = !DILocation(line: 325, column: 5, scope: !966, inlinedAt: !1002)
!1030 = !DILocation(line: 325, column: 5, scope: !1019, inlinedAt: !1002)
!1031 = !DILocation(line: 354, column: 22, scope: !1032)
!1032 = !DILexicalBlockFile(scope: !1033, file: !1, discriminator: 1)
!1033 = distinct !DILexicalBlock(scope: !963, file: !1, line: 354, column: 16)
!1034 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1035)
!1035 = distinct !DILocation(line: 318, column: 23, scope: !1036, inlinedAt: !1047)
!1036 = distinct !DISubprogram(name: "launchRDWT97Kernel<128, 6>", linkageName: "_ZN8dwt_cuda18launchRDWT97KernelILi128ELi6EEEvPfS1_ii", scope: !887, file: !1, line: 316, type: !967, isLocal: false, isDefinition: true, scopeLine: 316, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1037, variables: !1040)
!1037 = !{!1038, !1039}
!1038 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 128)
!1039 = !DITemplateValueParameter(name: "WIN_SY", type: !160, value: i32 6)
!1040 = !{!1041, !1042, !1043, !1044, !1045, !1046}
!1041 = !DILocalVariable(name: "in", arg: 1, scope: !1036, file: !1, line: 316, type: !234)
!1042 = !DILocalVariable(name: "out", arg: 2, scope: !1036, file: !1, line: 316, type: !234)
!1043 = !DILocalVariable(name: "sx", arg: 3, scope: !1036, file: !1, line: 316, type: !160)
!1044 = !DILocalVariable(name: "sy", arg: 4, scope: !1036, file: !1, line: 316, type: !160)
!1045 = !DILocalVariable(name: "steps", scope: !1036, file: !1, line: 318, type: !900)
!1046 = !DILocalVariable(name: "gSize", scope: !1036, file: !1, line: 321, type: !978)
!1047 = distinct !DILocation(line: 355, column: 7, scope: !1048)
!1048 = distinct !DILexicalBlock(scope: !1033, file: !1, line: 354, column: 30)
!1049 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1035)
!1050 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1035)
!1051 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1035)
!1052 = !DILocation(line: 354, column: 16, scope: !1032)
!1053 = !DILocation(line: 316, column: 36, scope: !1036, inlinedAt: !1047)
!1054 = !DILocation(line: 316, column: 48, scope: !1036, inlinedAt: !1047)
!1055 = !DILocation(line: 316, column: 57, scope: !1036, inlinedAt: !1047)
!1056 = !DILocation(line: 316, column: 65, scope: !1036, inlinedAt: !1047)
!1057 = !DILocation(line: 318, column: 15, scope: !1036, inlinedAt: !1047)
!1058 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1059)
!1059 = distinct !DILocation(line: 321, column: 16, scope: !1036, inlinedAt: !1047)
!1060 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1059)
!1061 = !DILocation(line: 321, column: 58, scope: !1036, inlinedAt: !1047)
!1062 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1063)
!1063 = distinct !DILocation(line: 321, column: 38, scope: !1064, inlinedAt: !1047)
!1064 = !DILexicalBlockFile(scope: !1036, file: !1, discriminator: 1)
!1065 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1063)
!1066 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1063)
!1067 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1063)
!1068 = !DILocation(line: 321, column: 10, scope: !1036, inlinedAt: !1047)
!1069 = !DILocation(line: 325, column: 36, scope: !1036, inlinedAt: !1047)
!1070 = !DILocation(line: 325, column: 33, scope: !1071, inlinedAt: !1047)
!1071 = !DILexicalBlockFile(scope: !1036, file: !1, discriminator: 2)
!1072 = !DILocation(line: 325, column: 33, scope: !1036, inlinedAt: !1047)
!1073 = !DILocation(line: 325, column: 5, scope: !1036, inlinedAt: !1047)
!1074 = !DILocation(line: 325, column: 5, scope: !1064, inlinedAt: !1047)
!1075 = !DILocalVariable(name: "in", arg: 1, scope: !1076, file: !1, line: 316, type: !234)
!1076 = distinct !DISubprogram(name: "launchRDWT97Kernel<64, 6>", linkageName: "_ZN8dwt_cuda18launchRDWT97KernelILi64ELi6EEEvPfS1_ii", scope: !887, file: !1, line: 316, type: !967, isLocal: false, isDefinition: true, scopeLine: 316, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1077, variables: !1079)
!1077 = !{!1078, !1039}
!1078 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 64)
!1079 = !{!1075, !1080, !1081, !1082, !1083, !1084}
!1080 = !DILocalVariable(name: "out", arg: 2, scope: !1076, file: !1, line: 316, type: !234)
!1081 = !DILocalVariable(name: "sx", arg: 3, scope: !1076, file: !1, line: 316, type: !160)
!1082 = !DILocalVariable(name: "sy", arg: 4, scope: !1076, file: !1, line: 316, type: !160)
!1083 = !DILocalVariable(name: "steps", scope: !1076, file: !1, line: 318, type: !900)
!1084 = !DILocalVariable(name: "gSize", scope: !1076, file: !1, line: 321, type: !978)
!1085 = !DILocation(line: 316, column: 36, scope: !1076, inlinedAt: !1086)
!1086 = distinct !DILocation(line: 357, column: 7, scope: !1087)
!1087 = distinct !DILexicalBlock(scope: !1033, file: !1, line: 356, column: 12)
!1088 = !DILocation(line: 316, column: 48, scope: !1076, inlinedAt: !1086)
!1089 = !DILocation(line: 316, column: 57, scope: !1076, inlinedAt: !1086)
!1090 = !DILocation(line: 316, column: 65, scope: !1076, inlinedAt: !1086)
!1091 = !DILocation(line: 318, column: 15, scope: !1076, inlinedAt: !1086)
!1092 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1093)
!1093 = distinct !DILocation(line: 321, column: 16, scope: !1076, inlinedAt: !1086)
!1094 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1093)
!1095 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1093)
!1096 = !DILocation(line: 321, column: 58, scope: !1076, inlinedAt: !1086)
!1097 = !DILocation(line: 75, column: 15, scope: !911, inlinedAt: !1098)
!1098 = distinct !DILocation(line: 321, column: 38, scope: !1099, inlinedAt: !1086)
!1099 = !DILexicalBlockFile(scope: !1076, file: !1, discriminator: 1)
!1100 = !DILocation(line: 75, column: 26, scope: !911, inlinedAt: !1098)
!1101 = !DILocation(line: 75, column: 23, scope: !911, inlinedAt: !1098)
!1102 = !DILocation(line: 75, column: 20, scope: !911, inlinedAt: !1098)
!1103 = !DILocation(line: 321, column: 10, scope: !1076, inlinedAt: !1086)
!1104 = !DILocation(line: 325, column: 36, scope: !1076, inlinedAt: !1086)
!1105 = !DILocation(line: 325, column: 33, scope: !1106, inlinedAt: !1086)
!1106 = !DILexicalBlockFile(scope: !1076, file: !1, discriminator: 2)
!1107 = !DILocation(line: 325, column: 33, scope: !1076, inlinedAt: !1086)
!1108 = !DILocation(line: 325, column: 5, scope: !1076, inlinedAt: !1086)
!1109 = !DILocation(line: 325, column: 5, scope: !1099, inlinedAt: !1086)
!1110 = !DILocation(line: 359, column: 3, scope: !886)
!1111 = distinct !DISubprogram(name: "rdwt97Kernel<192, 8>", linkageName: "_ZN8dwt_cuda12rdwt97KernelILi192ELi8EEEvPKfPfiii", scope: !887, file: !1, line: 300, type: !1112, isLocal: false, isDefinition: true, scopeLine: 301, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !969, variables: !1114)
!1112 = !DISubroutineType(types: !1113)
!1113 = !{null, !938, !937, !900, !900, !900}
!1114 = !{!1115, !1116, !1117, !1118, !1119}
!1115 = !DILocalVariable(name: "in", arg: 1, scope: !1111, file: !1, line: 300, type: !938)
!1116 = !DILocalVariable(name: "out", arg: 2, scope: !1111, file: !1, line: 300, type: !937)
!1117 = !DILocalVariable(name: "sx", arg: 3, scope: !1111, file: !1, line: 301, type: !900)
!1118 = !DILocalVariable(name: "sy", arg: 4, scope: !1111, file: !1, line: 301, type: !900)
!1119 = !DILocalVariable(name: "steps", arg: 5, scope: !1111, file: !1, line: 301, type: !900)
!1120 = !DILocation(line: 300, column: 52, scope: !1111)
!1121 = !{!1122, !1122, i64 0}
!1122 = !{!"any pointer", !1123, i64 0}
!1123 = !{!"omnipotent char", !1124, i64 0}
!1124 = !{!"Simple C++ TBAA"}
!1125 = !DILocation(line: 300, column: 70, scope: !1111)
!1126 = !DILocation(line: 301, column: 42, scope: !1111)
!1127 = !{!1128, !1128, i64 0}
!1128 = !{!"int", !1123, i64 0}
!1129 = !DILocation(line: 301, column: 56, scope: !1111)
!1130 = !DILocation(line: 301, column: 70, scope: !1111)
!1131 = !DILocation(line: 301, column: 77, scope: !1111)
!1132 = !DILocation(line: 301, column: 77, scope: !1133)
!1133 = !DILexicalBlockFile(scope: !1111, file: !1, discriminator: 1)
!1134 = !DILocation(line: 301, column: 77, scope: !1135)
!1135 = !DILexicalBlockFile(scope: !1111, file: !1, discriminator: 2)
!1136 = !DILocation(line: 301, column: 77, scope: !1137)
!1137 = !DILexicalBlockFile(scope: !1111, file: !1, discriminator: 3)
!1138 = !DILocation(line: 301, column: 77, scope: !1139)
!1139 = !DILexicalBlockFile(scope: !1111, file: !1, discriminator: 4)
!1140 = !DILocation(line: 301, column: 77, scope: !1141)
!1141 = !DILexicalBlockFile(scope: !1111, file: !1, discriminator: 5)
!1142 = !DILocation(line: 303, column: 3, scope: !1111)
!1143 = distinct !DISubprogram(name: "rdwt97Kernel<128, 6>", linkageName: "_ZN8dwt_cuda12rdwt97KernelILi128ELi6EEEvPKfPfiii", scope: !887, file: !1, line: 300, type: !1112, isLocal: false, isDefinition: true, scopeLine: 301, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1037, variables: !1144)
!1144 = !{!1145, !1146, !1147, !1148, !1149}
!1145 = !DILocalVariable(name: "in", arg: 1, scope: !1143, file: !1, line: 300, type: !938)
!1146 = !DILocalVariable(name: "out", arg: 2, scope: !1143, file: !1, line: 300, type: !937)
!1147 = !DILocalVariable(name: "sx", arg: 3, scope: !1143, file: !1, line: 301, type: !900)
!1148 = !DILocalVariable(name: "sy", arg: 4, scope: !1143, file: !1, line: 301, type: !900)
!1149 = !DILocalVariable(name: "steps", arg: 5, scope: !1143, file: !1, line: 301, type: !900)
!1150 = !DILocation(line: 300, column: 52, scope: !1143)
!1151 = !DILocation(line: 300, column: 70, scope: !1143)
!1152 = !DILocation(line: 301, column: 42, scope: !1143)
!1153 = !DILocation(line: 301, column: 56, scope: !1143)
!1154 = !DILocation(line: 301, column: 70, scope: !1143)
!1155 = !DILocation(line: 301, column: 77, scope: !1143)
!1156 = !DILocation(line: 301, column: 77, scope: !1157)
!1157 = !DILexicalBlockFile(scope: !1143, file: !1, discriminator: 1)
!1158 = !DILocation(line: 301, column: 77, scope: !1159)
!1159 = !DILexicalBlockFile(scope: !1143, file: !1, discriminator: 2)
!1160 = !DILocation(line: 301, column: 77, scope: !1161)
!1161 = !DILexicalBlockFile(scope: !1143, file: !1, discriminator: 3)
!1162 = !DILocation(line: 301, column: 77, scope: !1163)
!1163 = !DILexicalBlockFile(scope: !1143, file: !1, discriminator: 4)
!1164 = !DILocation(line: 301, column: 77, scope: !1165)
!1165 = !DILexicalBlockFile(scope: !1143, file: !1, discriminator: 5)
!1166 = !DILocation(line: 303, column: 3, scope: !1143)
!1167 = distinct !DISubprogram(name: "rdwt97Kernel<64, 6>", linkageName: "_ZN8dwt_cuda12rdwt97KernelILi64ELi6EEEvPKfPfiii", scope: !887, file: !1, line: 300, type: !1112, isLocal: false, isDefinition: true, scopeLine: 301, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1077, variables: !1168)
!1168 = !{!1169, !1170, !1171, !1172, !1173}
!1169 = !DILocalVariable(name: "in", arg: 1, scope: !1167, file: !1, line: 300, type: !938)
!1170 = !DILocalVariable(name: "out", arg: 2, scope: !1167, file: !1, line: 300, type: !937)
!1171 = !DILocalVariable(name: "sx", arg: 3, scope: !1167, file: !1, line: 301, type: !900)
!1172 = !DILocalVariable(name: "sy", arg: 4, scope: !1167, file: !1, line: 301, type: !900)
!1173 = !DILocalVariable(name: "steps", arg: 5, scope: !1167, file: !1, line: 301, type: !900)
!1174 = !DILocation(line: 300, column: 52, scope: !1167)
!1175 = !DILocation(line: 300, column: 70, scope: !1167)
!1176 = !DILocation(line: 301, column: 42, scope: !1167)
!1177 = !DILocation(line: 301, column: 56, scope: !1167)
!1178 = !DILocation(line: 301, column: 70, scope: !1167)
!1179 = !DILocation(line: 301, column: 77, scope: !1167)
!1180 = !DILocation(line: 301, column: 77, scope: !1181)
!1181 = !DILexicalBlockFile(scope: !1167, file: !1, discriminator: 1)
!1182 = !DILocation(line: 301, column: 77, scope: !1183)
!1183 = !DILexicalBlockFile(scope: !1167, file: !1, discriminator: 2)
!1184 = !DILocation(line: 301, column: 77, scope: !1185)
!1185 = !DILexicalBlockFile(scope: !1167, file: !1, discriminator: 3)
!1186 = !DILocation(line: 301, column: 77, scope: !1187)
!1187 = !DILexicalBlockFile(scope: !1167, file: !1, discriminator: 4)
!1188 = !DILocation(line: 301, column: 77, scope: !1189)
!1189 = !DILexicalBlockFile(scope: !1167, file: !1, discriminator: 5)
!1190 = !DILocation(line: 303, column: 3, scope: !1167)
