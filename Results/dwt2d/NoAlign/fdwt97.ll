; ModuleID = 'Results/dwt2d/dwt_cuda/fdwt97.cu'
source_filename = "Results/dwt2d/dwt_cuda/fdwt97.cu"
...
define void @_ZN8dwt_cuda6fdwt97EPfS0_iii(float* %in, float* %out, i32 %sizeX, i32 %sizeY, i32 %levels) local_unnamed_addr #0 !dbg !886 {
entry:
  %0 = bitcast float* %in to i8*, !dbg !902
  %1 = bitcast float* %out to i8*, !dbg !921
  br label %tailrecurse

tailrecurse:                                      ; preds = %if.then6, %entry
  %sizeX.tr = phi i32 [ %sizeX, %entry ], [ %add.i, %if.then6 ]
  %sizeY.tr = phi i32 [ %sizeY, %entry ], [ %add.i72, %if.then6 ]
  %levels.tr = phi i32 [ %levels, %entry ], [ %sub, %if.then6 ]
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !892, metadata !922), !dbg !923
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !893, metadata !922), !dbg !924
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !894, metadata !922), !dbg !925
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !895, metadata !922), !dbg !926
  tail call void @llvm.dbg.value(metadata i32 %levels.tr, i64 0, metadata !896, metadata !922), !dbg !927
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !894, metadata !922), !dbg !925
  %cmp = icmp sgt i32 %sizeX.tr, 959, !dbg !928
  br i1 %cmp, label %if.then, label %if.else, !dbg !930

if.then:                                          ; preds = %tailrecurse
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !931, metadata !922), !dbg !967
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !939, metadata !922), !dbg !970
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !940, metadata !922), !dbg !971
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !941, metadata !922), !dbg !972
  %div.i.i = sdiv i32 %sizeY.tr, 120, !dbg !973
  %rem.i.i = srem i32 %sizeY.tr, 120, !dbg !984
  %tobool.i.i = icmp ne i32 %rem.i.i, 0, !dbg !985
  %cond.i.i = zext i1 %tobool.i.i to i32, !dbg !985
  %add.i.i = add nsw i32 %cond.i.i, %div.i.i, !dbg !986
  tail call void @llvm.dbg.value(metadata i32 %add.i.i, i64 0, metadata !942, metadata !922), !dbg !987
  %div.i13.i76 = udiv i32 %sizeX.tr, 192
  %rem.i14.i77 = urem i32 %sizeX.tr, 192
  %tobool.i15.i = icmp ne i32 %rem.i14.i77, 0, !dbg !988
  %cond.i16.i = zext i1 %tobool.i15.i to i32, !dbg !988
  %add.i17.i = add nuw nsw i32 %cond.i16.i, %div.i13.i76, !dbg !990
  %mul.i = shl nsw i32 %add.i.i, 3, !dbg !991
  %div.i21.i = sdiv i32 %sizeY.tr, %mul.i, !dbg !992
  %rem.i22.i = srem i32 %sizeY.tr, %mul.i, !dbg !995
  %tobool.i23.i = icmp ne i32 %rem.i22.i, 0, !dbg !996
  %cond.i24.i = zext i1 %tobool.i23.i to i32, !dbg !996
  %add.i25.i = add nsw i32 %cond.i24.i, %div.i21.i, !dbg !997
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !943, metadata !998), !dbg !999
  %gSize.sroa.0.sroa.4.0.insert.ext.i = zext i32 %add.i25.i to i64, !dbg !1000
  %gSize.sroa.0.sroa.4.0.insert.shift.i = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i, 32, !dbg !1000
  %gSize.sroa.0.sroa.0.0.insert.ext.i = zext i32 %add.i17.i to i64, !dbg !1000
  %gSize.sroa.0.sroa.0.0.insert.insert.i = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i, %gSize.sroa.0.sroa.0.0.insert.ext.i, !dbg !1000
  %call6.i = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i, i32 1, i64 4294967488, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1001
  %tobool.i = icmp eq i32 %call6.i, 0, !dbg !1003
  br i1 %tobool.i, label %kcall.configok.i, label %if.end4, !dbg !1004

kcall.configok.i:                                 ; preds = %if.then
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !940, metadata !922), !dbg !971
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !941, metadata !922), !dbg !972
  tail call void @_ZN8dwt_cuda12fdwt97KernelILi192ELi8EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX.tr, i32 %sizeY.tr, i32 %add.i.i), !dbg !1005
  br label %if.end4, !dbg !1005

if.else:                                          ; preds = %tailrecurse
  %cmp1 = icmp sgt i32 %sizeX.tr, 479, !dbg !1006
  %div.i.i22 = sdiv i32 %sizeY.tr, 90, !dbg !1009
  %rem.i.i23 = srem i32 %sizeY.tr, 90, !dbg !1024
  %tobool.i.i24 = icmp ne i32 %rem.i.i23, 0, !dbg !1025
  %cond.i.i25 = zext i1 %tobool.i.i24 to i32, !dbg !1025
  %add.i.i26 = add nsw i32 %cond.i.i25, %div.i.i22, !dbg !1026
  br i1 %cmp1, label %if.then2, label %if.else3, !dbg !1027

if.then2:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1016, metadata !922), !dbg !1028
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1017, metadata !922), !dbg !1029
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !1018, metadata !922), !dbg !1030
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !1019, metadata !922), !dbg !1031
  tail call void @llvm.dbg.value(metadata i32 %add.i.i26, i64 0, metadata !1020, metadata !922), !dbg !1032
  %div.i13.i2778 = lshr i32 %sizeX.tr, 7
  %rem.i1436.i = and i32 %sizeX.tr, 127, !dbg !1033
  %tobool.i15.i28 = icmp ne i32 %rem.i1436.i, 0, !dbg !1033
  %cond.i16.i29 = zext i1 %tobool.i15.i28 to i32, !dbg !1033
  %add.i17.i30 = add nuw nsw i32 %cond.i16.i29, %div.i13.i2778, !dbg !1035
  %mul.i31 = mul nsw i32 %add.i.i26, 6, !dbg !1036
  %div.i21.i32 = sdiv i32 %sizeY.tr, %mul.i31, !dbg !1037
  %rem.i22.i33 = srem i32 %sizeY.tr, %mul.i31, !dbg !1040
  %tobool.i23.i34 = icmp ne i32 %rem.i22.i33, 0, !dbg !1041
  %cond.i24.i35 = zext i1 %tobool.i23.i34 to i32, !dbg !1041
  %add.i25.i36 = add nsw i32 %cond.i24.i35, %div.i21.i32, !dbg !1042
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1021, metadata !998), !dbg !1043
  %gSize.sroa.0.sroa.4.0.insert.ext.i37 = zext i32 %add.i25.i36 to i64, !dbg !1044
  %gSize.sroa.0.sroa.4.0.insert.shift.i38 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i37, 32, !dbg !1044
  %gSize.sroa.0.sroa.0.0.insert.ext.i39 = zext i32 %add.i17.i30 to i64, !dbg !1044
  %gSize.sroa.0.sroa.0.0.insert.insert.i40 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i38, %gSize.sroa.0.sroa.0.0.insert.ext.i39, !dbg !1044
  %call6.i41 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i40, i32 1, i64 4294967424, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1045
  %tobool.i42 = icmp eq i32 %call6.i41, 0, !dbg !1047
  br i1 %tobool.i42, label %kcall.configok.i43, label %if.end4, !dbg !1048

kcall.configok.i43:                               ; preds = %if.then2
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !1018, metadata !922), !dbg !1030
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !1019, metadata !922), !dbg !1031
  tail call void @_ZN8dwt_cuda12fdwt97KernelILi128ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX.tr, i32 %sizeY.tr, i32 %add.i.i26), !dbg !1049
  br label %if.end4, !dbg !1049

if.else3:                                         ; preds = %if.else
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !1050, metadata !922), !dbg !1060
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !1055, metadata !922), !dbg !1063
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !1056, metadata !922), !dbg !1064
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !1057, metadata !922), !dbg !1065
  tail call void @llvm.dbg.value(metadata i32 %add.i.i26, i64 0, metadata !1058, metadata !922), !dbg !1066
  %div.i13.i49 = sdiv i32 %sizeX.tr, 64, !dbg !1067
  %rem.i1436.i50 = and i32 %sizeX.tr, 63, !dbg !1069
  %tobool.i15.i51 = icmp ne i32 %rem.i1436.i50, 0, !dbg !1069
  %cond.i16.i52 = zext i1 %tobool.i15.i51 to i32, !dbg !1069
  %add.i17.i53 = add nsw i32 %cond.i16.i52, %div.i13.i49, !dbg !1070
  %mul.i54 = mul nsw i32 %add.i.i26, 6, !dbg !1071
  %div.i21.i55 = sdiv i32 %sizeY.tr, %mul.i54, !dbg !1072
  %rem.i22.i56 = srem i32 %sizeY.tr, %mul.i54, !dbg !1075
  %tobool.i23.i57 = icmp ne i32 %rem.i22.i56, 0, !dbg !1076
  %cond.i24.i58 = zext i1 %tobool.i23.i57 to i32, !dbg !1076
  %add.i25.i59 = add nsw i32 %cond.i24.i58, %div.i21.i55, !dbg !1077
  tail call void @llvm.dbg.value(metadata %struct.dim3* undef, i64 0, metadata !1059, metadata !998), !dbg !1078
  %gSize.sroa.0.sroa.4.0.insert.ext.i60 = zext i32 %add.i25.i59 to i64, !dbg !1079
  %gSize.sroa.0.sroa.4.0.insert.shift.i61 = shl nuw i64 %gSize.sroa.0.sroa.4.0.insert.ext.i60, 32, !dbg !1079
  %gSize.sroa.0.sroa.0.0.insert.ext.i62 = zext i32 %add.i17.i53 to i64, !dbg !1079
  %gSize.sroa.0.sroa.0.0.insert.insert.i63 = or i64 %gSize.sroa.0.sroa.4.0.insert.shift.i61, %gSize.sroa.0.sroa.0.0.insert.ext.i62, !dbg !1079
  %call6.i64 = tail call i32 @cudaConfigureCall(i64 %gSize.sroa.0.sroa.0.0.insert.insert.i63, i32 1, i64 4294967360, i32 1, i64 0, %struct.CUstream_st* null), !dbg !1080
  %tobool.i65 = icmp eq i32 %call6.i64, 0, !dbg !1082
  br i1 %tobool.i65, label %kcall.configok.i66, label %if.end4, !dbg !1083

kcall.configok.i66:                               ; preds = %if.else3
  tail call void @llvm.dbg.value(metadata i32 %sizeX.tr, i64 0, metadata !1056, metadata !922), !dbg !1064
  tail call void @llvm.dbg.value(metadata i32 %sizeY.tr, i64 0, metadata !1057, metadata !922), !dbg !1065
  tail call void @_ZN8dwt_cuda12fdwt97KernelILi64ELi6EEEvPKfPfiii(float* %in, float* %out, i32 %sizeX.tr, i32 %sizeY.tr, i32 %add.i.i26), !dbg !1084
  br label %if.end4, !dbg !1084

if.end4:                                          ; preds = %kcall.configok.i66, %if.else3, %kcall.configok.i43, %if.then2, %kcall.configok.i, %if.then
  %cmp5 = icmp sgt i32 %levels.tr, 1, !dbg !1085
  br i1 %cmp5, label %if.then6, label %if.end10, !dbg !1086

if.then6:                                         ; preds = %if.end4
  %div.i = sdiv i32 %sizeX.tr, 2, !dbg !1087
  %rem.i79 = and i32 %sizeX.tr, 1, !dbg !1089
  %add.i = add nsw i32 %rem.i79, %div.i, !dbg !1090
  tail call void @llvm.dbg.value(metadata i32 %add.i, i64 0, metadata !897, metadata !922), !dbg !1091
  %div.i68 = sdiv i32 %sizeY.tr, 2, !dbg !1092
  %rem.i6980 = and i32 %sizeY.tr, 1, !dbg !1094
  %add.i72 = add nsw i32 %rem.i6980, %div.i68, !dbg !1095
  tail call void @llvm.dbg.value(metadata i32 %add.i72, i64 0, metadata !901, metadata !922), !dbg !1096
  %conv = sext i32 %add.i to i64, !dbg !1097
  %conv9 = sext i32 %add.i72 to i64, !dbg !1098
  tail call void @llvm.dbg.value(metadata float* %in, i64 0, metadata !914, metadata !922), !dbg !1099
  tail call void @llvm.dbg.value(metadata float* %out, i64 0, metadata !915, metadata !922), !dbg !1100
  tail call void @llvm.dbg.value(metadata i64 %conv, i64 0, metadata !916, metadata !922), !dbg !1101
  tail call void @llvm.dbg.value(metadata i64 %conv9, i64 0, metadata !917, metadata !922), !dbg !1102
  %mul.i73 = shl nsw i64 %conv, 2, !dbg !1103
  %mul1.i = mul i64 %mul.i73, %conv9, !dbg !1104
  %call.i = tail call i32 @cudaMemcpy(i8* %0, i8* %1, i64 %mul1.i, i32 3), !dbg !1105
  tail call void @llvm.dbg.value(metadata i32 0, i64 0, metadata !918, metadata !922), !dbg !1106
  %sub = add nsw i32 %levels.tr, -1, !dbg !1107
  br label %tailrecurse, !dbg !1108

if.end10:                                         ; preds = %if.end4
  ret void, !dbg !1109
}

declare i32 @cudaConfigureCall(i64, i32, i64, i32, i64, %struct.CUstream_st*) local_unnamed_addr #1

; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12fdwt97KernelILi192ELi8EEEvPKfPfiii(float* %input, float* %output, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1110 {
entry:
  ...
  tail call void @llvm.dbg.value(metadata float* %input, i64 0, metadata !1114, metadata !922), !dbg !1119
  store float* %input, float** %input.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata float* %output, i64 0, metadata !1115, metadata !922), !dbg !1124
  store float* %output, float** %output.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1116, metadata !922), !dbg !1125
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1117, metadata !922), !dbg !1128
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1118, metadata !922), !dbg !1129
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1126
  %0 = bitcast float** %input.addr to i8*, !dbg !1130
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1130
  %2 = icmp eq i32 %1, 0, !dbg !1130
  br i1 %2, label %setup.next, label %setup.end, !dbg !1130

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %output.addr to i8*, !dbg !1131
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1131
  %5 = icmp eq i32 %4, 0, !dbg !1131
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1131

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1133
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1133
  %8 = icmp eq i32 %7, 0, !dbg !1133
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1133

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1135
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1135
  %11 = icmp eq i32 %10, 0, !dbg !1135
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1135

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1137
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1137
  %14 = icmp eq i32 %13, 0, !dbg !1137
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1137

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12fdwt97KernelILi192ELi8EEEvPKfPfiii to i8*)), !dbg !1139
  br label %setup.end, !dbg !1139
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12fdwt97KernelILi128ELi6EEEvPKfPfiii(float* %input, float* %output, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1142 {
entry:
  %input.addr = alloca float*, align 8
  %output.addr = alloca float*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata float* %input, i64 0, metadata !1144, metadata !922), !dbg !1149
  store float* %input, float** %input.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata float* %output, i64 0, metadata !1145, metadata !922), !dbg !1150
  store float* %output, float** %output.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1146, metadata !922), !dbg !1151
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1147, metadata !922), !dbg !1152
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1148, metadata !922), !dbg !1153
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1126
  %0 = bitcast float** %input.addr to i8*, !dbg !1154
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1154
  %2 = icmp eq i32 %1, 0, !dbg !1154
  br i1 %2, label %setup.next, label %setup.end, !dbg !1154

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %output.addr to i8*, !dbg !1155
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1155
  %5 = icmp eq i32 %4, 0, !dbg !1155
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1155

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1157
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1157
  %8 = icmp eq i32 %7, 0, !dbg !1157
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1157

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1159
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1159
  %11 = icmp eq i32 %10, 0, !dbg !1159
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1159

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1161
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1161
  %14 = icmp eq i32 %13, 0, !dbg !1161
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1161

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12fdwt97KernelILi128ELi6EEEvPKfPfiii to i8*)), !dbg !1163
  br label %setup.end, !dbg !1163
...
; Function Attrs: uwtable
define linkonce_odr void @_ZN8dwt_cuda12fdwt97KernelILi64ELi6EEEvPKfPfiii(float* %input, float* %output, i32 %sx, i32 %sy, i32 %steps) #0 comdat !dbg !1166 {
entry:
  %input.addr = alloca float*, align 8
  %output.addr = alloca float*, align 8
  %sx.addr = alloca i32, align 4
  %sy.addr = alloca i32, align 4
  %steps.addr = alloca i32, align 4
  tail call void @llvm.dbg.value(metadata float* %input, i64 0, metadata !1168, metadata !922), !dbg !1173
  store float* %input, float** %input.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata float* %output, i64 0, metadata !1169, metadata !922), !dbg !1174
  store float* %output, float** %output.addr, align 8, !tbaa !1120
  tail call void @llvm.dbg.value(metadata i32 %sx, i64 0, metadata !1170, metadata !922), !dbg !1175
  store i32 %sx, i32* %sx.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %sy, i64 0, metadata !1171, metadata !922), !dbg !1176
  store i32 %sy, i32* %sy.addr, align 4, !tbaa !1126
  tail call void @llvm.dbg.value(metadata i32 %steps, i64 0, metadata !1172, metadata !922), !dbg !1177
  store i32 %steps, i32* %steps.addr, align 4, !tbaa !1126
  %0 = bitcast float** %input.addr to i8*, !dbg !1178
  %1 = call i32 @cudaSetupArgument(i8* %0, i64 8, i64 0), !dbg !1178
  %2 = icmp eq i32 %1, 0, !dbg !1178
  br i1 %2, label %setup.next, label %setup.end, !dbg !1178

setup.next:                                       ; preds = %entry
  %3 = bitcast float** %output.addr to i8*, !dbg !1179
  %4 = call i32 @cudaSetupArgument(i8* %3, i64 8, i64 8), !dbg !1179
  %5 = icmp eq i32 %4, 0, !dbg !1179
  br i1 %5, label %setup.next1, label %setup.end, !dbg !1179

setup.next1:                                      ; preds = %setup.next
  %6 = bitcast i32* %sx.addr to i8*, !dbg !1181
  %7 = call i32 @cudaSetupArgument(i8* %6, i64 4, i64 16), !dbg !1181
  %8 = icmp eq i32 %7, 0, !dbg !1181
  br i1 %8, label %setup.next2, label %setup.end, !dbg !1181

setup.next2:                                      ; preds = %setup.next1
  %9 = bitcast i32* %sy.addr to i8*, !dbg !1183
  %10 = call i32 @cudaSetupArgument(i8* %9, i64 4, i64 20), !dbg !1183
  %11 = icmp eq i32 %10, 0, !dbg !1183
  br i1 %11, label %setup.next3, label %setup.end, !dbg !1183

setup.next3:                                      ; preds = %setup.next2
  %12 = bitcast i32* %steps.addr to i8*, !dbg !1185
  %13 = call i32 @cudaSetupArgument(i8* %12, i64 4, i64 24), !dbg !1185
  %14 = icmp eq i32 %13, 0, !dbg !1185
  br i1 %14, label %setup.next4, label %setup.end, !dbg !1185

setup.next4:                                      ; preds = %setup.next3
  %15 = call i32 @cudaLaunch(i8* bitcast (void (float*, float*, i32, i32, i32)* @_ZN8dwt_cuda12fdwt97KernelILi64ELi6EEEvPKfPfiii to i8*)), !dbg !1187
  br label %setup.end, !dbg !1187

setup.end:                                        ; preds = %setup.next4, %setup.next3, %setup.next2, %setup.next1, %setup.next, %entry
  ret void, !dbg !1189
}

declare i32 @cudaMemcpy(i8*, i8*, i64, i32) local_unnamed_addr #1
...
!1 = !DIFile(filename: "Results/dwt2d/dwt_cuda/fdwt97.cu", directory: "/home/ec2-user/DynamicAnalyis")
!2 = !{!3, !86}
...
!886 = distinct !DISubprogram(name: "fdwt97", linkageName: "_ZN8dwt_cuda6fdwt97EPfS0_iii", scope: !887, file: !1, line: 344, type: !889, isLocal: false, isDefinition: true, scopeLine: 344, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !891)
...
!890 = !{null, !234, !234, !160, !160, !160}
!891 = !{!892, !893, !894, !895, !896, !897, !901}
!892 = !DILocalVariable(name: "in", arg: 1, scope: !886, file: !1, line: 344, type: !234)
!893 = !DILocalVariable(name: "out", arg: 2, scope: !886, file: !1, line: 344, type: !234)
!894 = !DILocalVariable(name: "sizeX", arg: 3, scope: !886, file: !1, line: 344, type: !160)
!895 = !DILocalVariable(name: "sizeY", arg: 4, scope: !886, file: !1, line: 344, type: !160)
!896 = !DILocalVariable(name: "levels", arg: 5, scope: !886, file: !1, line: 344, type: !160)
!897 = !DILocalVariable(name: "llSizeX", scope: !898, file: !1, line: 357, type: !900)
!898 = distinct !DILexicalBlock(scope: !899, file: !1, line: 355, column: 20)
!899 = distinct !DILexicalBlock(scope: !886, file: !1, line: 355, column: 8)
!900 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !160)
!901 = !DILocalVariable(name: "llSizeY", scope: !898, file: !1, line: 358, type: !900)
!902 = !DILocation(line: 242, column: 25, scope: !903, inlinedAt: !920)
!903 = distinct !DISubprogram(name: "memCopy<float>", linkageName: "_ZN8dwt_cuda7memCopyIfEEvPT_PKS1_mm", scope: !887, file: !888, line: 238, type: !904, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !911, variables: !913)
!904 = !DISubroutineType(types: !905)
!905 = !{null, !906, !907, !910, !910}
!906 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !234)
...
!909 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !105)
!910 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !386)
!911 = !{!912}
!912 = !DITemplateTypeParameter(name: "T", type: !105)
!913 = !{!914, !915, !916, !917, !918}
!914 = !DILocalVariable(name: "dest", arg: 1, scope: !903, file: !888, line: 238, type: !906)
!915 = !DILocalVariable(name: "src", arg: 2, scope: !903, file: !888, line: 238, type: !907)
!916 = !DILocalVariable(name: "sx", arg: 3, scope: !903, file: !888, line: 239, type: !910)
!917 = !DILocalVariable(name: "sy", arg: 4, scope: !903, file: !888, line: 239, type: !910)
!918 = !DILocalVariable(name: "status", scope: !903, file: !888, line: 240, type: !919)
!919 = !DIDerivedType(tag: DW_TAG_typedef, name: "cudaError_t", file: !4, line: 1420, baseType: !3)
!920 = distinct !DILocation(line: 359, column: 7, scope: !898)
!921 = !DILocation(line: 242, column: 31, scope: !903, inlinedAt: !920)
!922 = !DIExpression()
!923 = !DILocation(line: 344, column: 23, scope: !886)
!924 = !DILocation(line: 344, column: 35, scope: !886)
!925 = !DILocation(line: 344, column: 44, scope: !886)
!926 = !DILocation(line: 344, column: 55, scope: !886)
!927 = !DILocation(line: 344, column: 66, scope: !886)
!928 = !DILocation(line: 346, column: 14, scope: !929)
!929 = distinct !DILexicalBlock(scope: !886, file: !1, line: 346, column: 8)
!930 = !DILocation(line: 346, column: 8, scope: !886)
!931 = !DILocalVariable(name: "in", arg: 1, scope: !932, file: !1, line: 321, type: !234)
!932 = distinct !DISubprogram(name: "launchFDWT97Kernel<192, 8>", linkageName: "_ZN8dwt_cuda18launchFDWT97KernelILi192ELi8EEEvPfS1_ii", scope: !887, file: !1, line: 321, type: !933, isLocal: false, isDefinition: true, scopeLine: 321, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !935, variables: !938)
!933 = !DISubroutineType(types: !934)
!934 = !{null, !234, !234, !160, !160}
!935 = !{!936, !937}
!936 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 192)
!937 = !DITemplateValueParameter(name: "WIN_SY", type: !160, value: i32 8)
!938 = !{!931, !939, !940, !941, !942, !943}
!939 = !DILocalVariable(name: "out", arg: 2, scope: !932, file: !1, line: 321, type: !234)
!940 = !DILocalVariable(name: "sx", arg: 3, scope: !932, file: !1, line: 321, type: !160)
!941 = !DILocalVariable(name: "sy", arg: 4, scope: !932, file: !1, line: 321, type: !160)
!942 = !DILocalVariable(name: "steps", scope: !932, file: !1, line: 323, type: !900)
!943 = !DILocalVariable(name: "gSize", scope: !932, file: !1, line: 326, type: !944)
!944 = !DIDerivedType(tag: DW_TAG_typedef, name: "dim3", file: !945, line: 427, baseType: !946)
!945 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
!946 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "dim3", file: !945, line: 417, size: 96, align: 32, elements: !947, identifier: "_ZTS4dim3")
!947 = !{!948, !949, !950, !951, !955, !964}
!948 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !946, file: !945, line: 419, baseType: !456, size: 32, align: 32)
!949 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !946, file: !945, line: 419, baseType: !456, size: 32, align: 32, offset: 32)
!950 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !946, file: !945, line: 419, baseType: !456, size: 32, align: 32, offset: 64)
!951 = !DISubprogram(name: "dim3", scope: !946, file: !945, line: 421, type: !952, isLocal: false, isDefinition: false, scopeLine: 421, flags: DIFlagPrototyped, isOptimized: true)
!952 = !DISubroutineType(types: !953)
!953 = !{null, !954, !456, !456, !456}
!954 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !946, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!955 = !DISubprogram(name: "dim3", scope: !946, file: !945, line: 422, type: !956, isLocal: false, isDefinition: false, scopeLine: 422, flags: DIFlagPrototyped, isOptimized: true)
!956 = !DISubroutineType(types: !957)
!957 = !{null, !954, !958}
!958 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint3", file: !945, line: 383, baseType: !959)
!959 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uint3", file: !945, line: 190, size: 96, align: 32, elements: !960, identifier: "_ZTS5uint3")
!960 = !{!961, !962, !963}
!961 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !959, file: !945, line: 192, baseType: !456, size: 32, align: 32)
!962 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !959, file: !945, line: 192, baseType: !456, size: 32, align: 32, offset: 32)
!963 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !959, file: !945, line: 192, baseType: !456, size: 32, align: 32, offset: 64)
!964 = !DISubprogram(name: "operator uint3", linkageName: "_ZN4dim3cv5uint3Ev", scope: !946, file: !945, line: 423, type: !965, isLocal: false, isDefinition: false, scopeLine: 423, flags: DIFlagPrototyped, isOptimized: true)
!965 = !DISubroutineType(types: !966)
!966 = !{!958, !954}
!967 = !DILocation(line: 321, column: 36, scope: !932, inlinedAt: !968)
!968 = distinct !DILocation(line: 347, column: 7, scope: !969)
!969 = distinct !DILexicalBlock(scope: !929, file: !1, line: 346, column: 22)
!970 = !DILocation(line: 321, column: 48, scope: !932, inlinedAt: !968)
!971 = !DILocation(line: 321, column: 57, scope: !932, inlinedAt: !968)
!972 = !DILocation(line: 321, column: 65, scope: !932, inlinedAt: !968)
!973 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !983)
!974 = distinct !DISubprogram(name: "divRndUp<int>", linkageName: "_ZN8dwt_cuda8divRndUpIiEET_RKS1_S3_", scope: !887, file: !888, line: 74, type: !975, isLocal: false, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !978, variables: !980)
!975 = !DISubroutineType(types: !976)
!976 = !{!160, !977, !977}
!977 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !900, size: 64, align: 64)
!978 = !{!979}
!979 = !DITemplateTypeParameter(name: "T", type: !160)
!980 = !{!981, !982}
!981 = !DILocalVariable(name: "n", arg: 1, scope: !974, file: !888, line: 74, type: !977)
!982 = !DILocalVariable(name: "d", arg: 2, scope: !974, file: !888, line: 74, type: !977)
!983 = distinct !DILocation(line: 323, column: 23, scope: !932, inlinedAt: !968)
!984 = !DILocation(line: 75, column: 26, scope: !974, inlinedAt: !983)
!985 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !983)
!986 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !983)
!987 = !DILocation(line: 323, column: 15, scope: !932, inlinedAt: !968)
!988 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !989)
!989 = distinct !DILocation(line: 326, column: 16, scope: !932, inlinedAt: !968)
!990 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !989)
!991 = !DILocation(line: 326, column: 58, scope: !932, inlinedAt: !968)
!992 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !993)
!993 = distinct !DILocation(line: 326, column: 38, scope: !994, inlinedAt: !968)
!994 = !DILexicalBlockFile(scope: !932, file: !1, discriminator: 1)
!995 = !DILocation(line: 75, column: 26, scope: !974, inlinedAt: !993)
!996 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !993)
!997 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !993)
!998 = !DIExpression(DW_OP_deref)
!999 = !DILocation(line: 326, column: 10, scope: !932, inlinedAt: !968)
!1000 = !DILocation(line: 330, column: 36, scope: !932, inlinedAt: !968)
!1001 = !DILocation(line: 330, column: 33, scope: !1002, inlinedAt: !968)
!1002 = !DILexicalBlockFile(scope: !932, file: !1, discriminator: 2)
!1003 = !DILocation(line: 330, column: 33, scope: !932, inlinedAt: !968)
!1004 = !DILocation(line: 330, column: 5, scope: !932, inlinedAt: !968)
!1005 = !DILocation(line: 330, column: 5, scope: !994, inlinedAt: !968)
!1006 = !DILocation(line: 348, column: 22, scope: !1007)
!1007 = !DILexicalBlockFile(scope: !1008, file: !1, discriminator: 1)
!1008 = distinct !DILexicalBlock(scope: !929, file: !1, line: 348, column: 16)
!1009 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1010)
!1010 = distinct !DILocation(line: 323, column: 23, scope: !1011, inlinedAt: !1022)
!1011 = distinct !DISubprogram(name: "launchFDWT97Kernel<128, 6>", linkageName: "_ZN8dwt_cuda18launchFDWT97KernelILi128ELi6EEEvPfS1_ii", scope: !887, file: !1, line: 321, type: !933, isLocal: false, isDefinition: true, scopeLine: 321, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1012, variables: !1015)
!1012 = !{!1013, !1014}
!1013 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 128)
!1014 = !DITemplateValueParameter(name: "WIN_SY", type: !160, value: i32 6)
!1015 = !{!1016, !1017, !1018, !1019, !1020, !1021}
!1016 = !DILocalVariable(name: "in", arg: 1, scope: !1011, file: !1, line: 321, type: !234)
!1017 = !DILocalVariable(name: "out", arg: 2, scope: !1011, file: !1, line: 321, type: !234)
!1018 = !DILocalVariable(name: "sx", arg: 3, scope: !1011, file: !1, line: 321, type: !160)
!1019 = !DILocalVariable(name: "sy", arg: 4, scope: !1011, file: !1, line: 321, type: !160)
!1020 = !DILocalVariable(name: "steps", scope: !1011, file: !1, line: 323, type: !900)
!1021 = !DILocalVariable(name: "gSize", scope: !1011, file: !1, line: 326, type: !944)
!1022 = distinct !DILocation(line: 349, column: 7, scope: !1023)
!1023 = distinct !DILexicalBlock(scope: !1008, file: !1, line: 348, column: 30)
!1024 = !DILocation(line: 75, column: 26, scope: !974, inlinedAt: !1010)
!1025 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1010)
!1026 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1010)
!1027 = !DILocation(line: 348, column: 16, scope: !1007)
!1028 = !DILocation(line: 321, column: 36, scope: !1011, inlinedAt: !1022)
!1029 = !DILocation(line: 321, column: 48, scope: !1011, inlinedAt: !1022)
!1030 = !DILocation(line: 321, column: 57, scope: !1011, inlinedAt: !1022)
!1031 = !DILocation(line: 321, column: 65, scope: !1011, inlinedAt: !1022)
!1032 = !DILocation(line: 323, column: 15, scope: !1011, inlinedAt: !1022)
!1033 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1034)
!1034 = distinct !DILocation(line: 326, column: 16, scope: !1011, inlinedAt: !1022)
!1035 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1034)
!1036 = !DILocation(line: 326, column: 58, scope: !1011, inlinedAt: !1022)
!1037 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1038)
!1038 = distinct !DILocation(line: 326, column: 38, scope: !1039, inlinedAt: !1022)
!1039 = !DILexicalBlockFile(scope: !1011, file: !1, discriminator: 1)
!1040 = !DILocation(line: 75, column: 26, scope: !974, inlinedAt: !1038)
!1041 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1038)
!1042 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1038)
!1043 = !DILocation(line: 326, column: 10, scope: !1011, inlinedAt: !1022)
!1044 = !DILocation(line: 330, column: 36, scope: !1011, inlinedAt: !1022)
!1045 = !DILocation(line: 330, column: 33, scope: !1046, inlinedAt: !1022)
!1046 = !DILexicalBlockFile(scope: !1011, file: !1, discriminator: 2)
!1047 = !DILocation(line: 330, column: 33, scope: !1011, inlinedAt: !1022)
!1048 = !DILocation(line: 330, column: 5, scope: !1011, inlinedAt: !1022)
!1049 = !DILocation(line: 330, column: 5, scope: !1039, inlinedAt: !1022)
!1050 = !DILocalVariable(name: "in", arg: 1, scope: !1051, file: !1, line: 321, type: !234)
!1051 = distinct !DISubprogram(name: "launchFDWT97Kernel<64, 6>", linkageName: "_ZN8dwt_cuda18launchFDWT97KernelILi64ELi6EEEvPfS1_ii", scope: !887, file: !1, line: 321, type: !933, isLocal: false, isDefinition: true, scopeLine: 321, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1052, variables: !1054)
!1052 = !{!1053, !1014}
!1053 = !DITemplateValueParameter(name: "WIN_SX", type: !160, value: i32 64)
!1054 = !{!1050, !1055, !1056, !1057, !1058, !1059}
!1055 = !DILocalVariable(name: "out", arg: 2, scope: !1051, file: !1, line: 321, type: !234)
!1056 = !DILocalVariable(name: "sx", arg: 3, scope: !1051, file: !1, line: 321, type: !160)
!1057 = !DILocalVariable(name: "sy", arg: 4, scope: !1051, file: !1, line: 321, type: !160)
!1058 = !DILocalVariable(name: "steps", scope: !1051, file: !1, line: 323, type: !900)
!1059 = !DILocalVariable(name: "gSize", scope: !1051, file: !1, line: 326, type: !944)
!1060 = !DILocation(line: 321, column: 36, scope: !1051, inlinedAt: !1061)
!1061 = distinct !DILocation(line: 351, column: 7, scope: !1062)
!1062 = distinct !DILexicalBlock(scope: !1008, file: !1, line: 350, column: 12)
!1063 = !DILocation(line: 321, column: 48, scope: !1051, inlinedAt: !1061)
!1064 = !DILocation(line: 321, column: 57, scope: !1051, inlinedAt: !1061)
!1065 = !DILocation(line: 321, column: 65, scope: !1051, inlinedAt: !1061)
!1066 = !DILocation(line: 323, column: 15, scope: !1051, inlinedAt: !1061)
!1067 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1068)
!1068 = distinct !DILocation(line: 326, column: 16, scope: !1051, inlinedAt: !1061)
!1069 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1068)
!1070 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1068)
!1071 = !DILocation(line: 326, column: 58, scope: !1051, inlinedAt: !1061)
!1072 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1073)
!1073 = distinct !DILocation(line: 326, column: 38, scope: !1074, inlinedAt: !1061)
!1074 = !DILexicalBlockFile(scope: !1051, file: !1, discriminator: 1)
!1075 = !DILocation(line: 75, column: 26, scope: !974, inlinedAt: !1073)
!1076 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1073)
!1077 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1073)
!1078 = !DILocation(line: 326, column: 10, scope: !1051, inlinedAt: !1061)
!1079 = !DILocation(line: 330, column: 36, scope: !1051, inlinedAt: !1061)
!1080 = !DILocation(line: 330, column: 33, scope: !1081, inlinedAt: !1061)
!1081 = !DILexicalBlockFile(scope: !1051, file: !1, discriminator: 2)
!1082 = !DILocation(line: 330, column: 33, scope: !1051, inlinedAt: !1061)
!1083 = !DILocation(line: 330, column: 5, scope: !1051, inlinedAt: !1061)
!1084 = !DILocation(line: 330, column: 5, scope: !1074, inlinedAt: !1061)
!1085 = !DILocation(line: 355, column: 15, scope: !899)
!1086 = !DILocation(line: 355, column: 8, scope: !886)
!1087 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1088)
!1088 = distinct !DILocation(line: 357, column: 27, scope: !898)
!1089 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1088)
!1090 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1088)
!1091 = !DILocation(line: 357, column: 17, scope: !898)
!1092 = !DILocation(line: 75, column: 15, scope: !974, inlinedAt: !1093)
!1093 = distinct !DILocation(line: 358, column: 27, scope: !898)
!1094 = !DILocation(line: 75, column: 23, scope: !974, inlinedAt: !1093)
!1095 = !DILocation(line: 75, column: 20, scope: !974, inlinedAt: !1093)
!1096 = !DILocation(line: 358, column: 17, scope: !898)
!1097 = !DILocation(line: 359, column: 24, scope: !898)
!1098 = !DILocation(line: 359, column: 33, scope: !898)
!1099 = !DILocation(line: 238, column: 33, scope: !903, inlinedAt: !920)
!1100 = !DILocation(line: 238, column: 55, scope: !903, inlinedAt: !920)
!1101 = !DILocation(line: 239, column: 36, scope: !903, inlinedAt: !920)
!1102 = !DILocation(line: 239, column: 53, scope: !903, inlinedAt: !920)
!1103 = !DILocation(line: 242, column: 38, scope: !903, inlinedAt: !920)
!1104 = !DILocation(line: 242, column: 41, scope: !903, inlinedAt: !920)
!1105 = !DILocation(line: 242, column: 14, scope: !903, inlinedAt: !920)
!1106 = !DILocation(line: 240, column: 17, scope: !903, inlinedAt: !920)
!1107 = !DILocation(line: 362, column: 48, scope: !898)
!1108 = !DILocation(line: 362, column: 7, scope: !898)
!1109 = !DILocation(line: 364, column: 3, scope: !886)
!1110 = distinct !DISubprogram(name: "fdwt97Kernel<192, 8>", linkageName: "_ZN8dwt_cuda12fdwt97KernelILi192ELi8EEEvPKfPfiii", scope: !887, file: !1, line: 301, type: !1111, isLocal: false, isDefinition: true, scopeLine: 302, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !935, variables: !1113)
!1111 = !DISubroutineType(types: !1112)
!1112 = !{null, !907, !906, !900, !900, !900}
!1113 = !{!1114, !1115, !1116, !1117, !1118}
!1114 = !DILocalVariable(name: "input", arg: 1, scope: !1110, file: !1, line: 301, type: !907)
!1115 = !DILocalVariable(name: "output", arg: 2, scope: !1110, file: !1, line: 301, type: !906)
!1116 = !DILocalVariable(name: "sx", arg: 3, scope: !1110, file: !1, line: 302, type: !900)
!1117 = !DILocalVariable(name: "sy", arg: 4, scope: !1110, file: !1, line: 302, type: !900)
!1118 = !DILocalVariable(name: "steps", arg: 5, scope: !1110, file: !1, line: 302, type: !900)
!1119 = !DILocation(line: 301, column: 52, scope: !1110)
!1120 = !{!1121, !1121, i64 0}
!1121 = !{!"any pointer", !1122, i64 0}
!1122 = !{!"omnipotent char", !1123, i64 0}
!1123 = !{!"Simple C++ TBAA"}
!1124 = !DILocation(line: 301, column: 73, scope: !1110)
!1125 = !DILocation(line: 302, column: 42, scope: !1110)
!1126 = !{!1127, !1127, i64 0}
!1127 = !{!"int", !1122, i64 0}
!1128 = !DILocation(line: 302, column: 56, scope: !1110)
!1129 = !DILocation(line: 302, column: 70, scope: !1110)
!1130 = !DILocation(line: 302, column: 77, scope: !1110)
!1131 = !DILocation(line: 302, column: 77, scope: !1132)
!1132 = !DILexicalBlockFile(scope: !1110, file: !1, discriminator: 1)
!1133 = !DILocation(line: 302, column: 77, scope: !1134)
!1134 = !DILexicalBlockFile(scope: !1110, file: !1, discriminator: 2)
!1135 = !DILocation(line: 302, column: 77, scope: !1136)
!1136 = !DILexicalBlockFile(scope: !1110, file: !1, discriminator: 3)
!1137 = !DILocation(line: 302, column: 77, scope: !1138)
!1138 = !DILexicalBlockFile(scope: !1110, file: !1, discriminator: 4)
!1139 = !DILocation(line: 302, column: 77, scope: !1140)
!1140 = !DILexicalBlockFile(scope: !1110, file: !1, discriminator: 5)
!1141 = !DILocation(line: 308, column: 3, scope: !1110)
!1142 = distinct !DISubprogram(name: "fdwt97Kernel<128, 6>", linkageName: "_ZN8dwt_cuda12fdwt97KernelILi128ELi6EEEvPKfPfiii", scope: !887, file: !1, line: 301, type: !1111, isLocal: false, isDefinition: true, scopeLine: 302, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1012, variables: !1143)
!1143 = !{!1144, !1145, !1146, !1147, !1148}
!1144 = !DILocalVariable(name: "input", arg: 1, scope: !1142, file: !1, line: 301, type: !907)
!1145 = !DILocalVariable(name: "output", arg: 2, scope: !1142, file: !1, line: 301, type: !906)
!1146 = !DILocalVariable(name: "sx", arg: 3, scope: !1142, file: !1, line: 302, type: !900)
!1147 = !DILocalVariable(name: "sy", arg: 4, scope: !1142, file: !1, line: 302, type: !900)
!1148 = !DILocalVariable(name: "steps", arg: 5, scope: !1142, file: !1, line: 302, type: !900)
!1149 = !DILocation(line: 301, column: 52, scope: !1142)
!1150 = !DILocation(line: 301, column: 73, scope: !1142)
!1151 = !DILocation(line: 302, column: 42, scope: !1142)
!1152 = !DILocation(line: 302, column: 56, scope: !1142)
!1153 = !DILocation(line: 302, column: 70, scope: !1142)
!1154 = !DILocation(line: 302, column: 77, scope: !1142)
!1155 = !DILocation(line: 302, column: 77, scope: !1156)
!1156 = !DILexicalBlockFile(scope: !1142, file: !1, discriminator: 1)
!1157 = !DILocation(line: 302, column: 77, scope: !1158)
!1158 = !DILexicalBlockFile(scope: !1142, file: !1, discriminator: 2)
!1159 = !DILocation(line: 302, column: 77, scope: !1160)
!1160 = !DILexicalBlockFile(scope: !1142, file: !1, discriminator: 3)
!1161 = !DILocation(line: 302, column: 77, scope: !1162)
!1162 = !DILexicalBlockFile(scope: !1142, file: !1, discriminator: 4)
!1163 = !DILocation(line: 302, column: 77, scope: !1164)
!1164 = !DILexicalBlockFile(scope: !1142, file: !1, discriminator: 5)
!1165 = !DILocation(line: 308, column: 3, scope: !1142)
!1166 = distinct !DISubprogram(name: "fdwt97Kernel<64, 6>", linkageName: "_ZN8dwt_cuda12fdwt97KernelILi64ELi6EEEvPKfPfiii", scope: !887, file: !1, line: 301, type: !1111, isLocal: false, isDefinition: true, scopeLine: 302, flags: DIFlagPrototyped, isOptimized: true, unit: !0, templateParams: !1052, variables: !1167)
!1167 = !{!1168, !1169, !1170, !1171, !1172}
!1168 = !DILocalVariable(name: "input", arg: 1, scope: !1166, file: !1, line: 301, type: !907)
!1169 = !DILocalVariable(name: "output", arg: 2, scope: !1166, file: !1, line: 301, type: !906)
!1170 = !DILocalVariable(name: "sx", arg: 3, scope: !1166, file: !1, line: 302, type: !900)
!1171 = !DILocalVariable(name: "sy", arg: 4, scope: !1166, file: !1, line: 302, type: !900)
!1172 = !DILocalVariable(name: "steps", arg: 5, scope: !1166, file: !1, line: 302, type: !900)
!1173 = !DILocation(line: 301, column: 52, scope: !1166)
!1174 = !DILocation(line: 301, column: 73, scope: !1166)
!1175 = !DILocation(line: 302, column: 42, scope: !1166)
!1176 = !DILocation(line: 302, column: 56, scope: !1166)
!1177 = !DILocation(line: 302, column: 70, scope: !1166)
!1178 = !DILocation(line: 302, column: 77, scope: !1166)
!1179 = !DILocation(line: 302, column: 77, scope: !1180)
!1180 = !DILexicalBlockFile(scope: !1166, file: !1, discriminator: 1)
!1181 = !DILocation(line: 302, column: 77, scope: !1182)
!1182 = !DILexicalBlockFile(scope: !1166, file: !1, discriminator: 2)
!1183 = !DILocation(line: 302, column: 77, scope: !1184)
!1184 = !DILexicalBlockFile(scope: !1166, file: !1, discriminator: 3)
!1185 = !DILocation(line: 302, column: 77, scope: !1186)
!1186 = !DILexicalBlockFile(scope: !1166, file: !1, discriminator: 4)
!1187 = !DILocation(line: 302, column: 77, scope: !1188)
!1188 = !DILexicalBlockFile(scope: !1166, file: !1, discriminator: 5)
!1189 = !DILocation(line: 308, column: 3, scope: !1166)
