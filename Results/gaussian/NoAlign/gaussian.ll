...
entry:
  ...
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #6, !dbg !835, !range !872
  %1 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() #6, !dbg !873, !range !902
  %2 = tail call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() #6, !dbg !903, !range !948
  %mul = mul i32 %2, %1, !dbg !949
  %add = add i32 %mul, %0, !dbg !950
  %sub = add nsw i32 %Size, -1, !dbg !951
  %sub3 = sub i32 %sub, %t, !dbg !952
  %cmp = icmp ult i32 %add, %sub3, !dbg !953
  br i1 %cmp, label %if.end, label %return, !dbg !954

if.end:                                           ; preds = %entry
  %add9 = add i32 %t, 1, !dbg !955
  %add10 = add i32 %add9, %add, !dbg !956
  %mul11 = mul i32 %add10, %Size, !dbg !957
  %idx.ext = zext i32 %mul11 to i64, !dbg !958
  %add.ptr = getelementptr inbounds float, float* %a_cuda, i64 %idx.ext, !dbg !958
  %idx.ext12 = sext i32 %t to i64, !dbg !959
  %add.ptr13 = getelementptr inbounds float, float* %add.ptr, i64 %idx.ext12, !dbg !959
  %3 = bitcast float* %add.ptr13 to i8*, !dbg !960
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %3, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0), i32 295, i32 61, i32 0, i32 4), !dbg !960
  %4 = load float, float* %add.ptr13, align 4, !dbg !960, !tbaa !961
  %mul14 = mul nsw i32 %t, %Size, !dbg !963
  %idx.ext15 = sext i32 %mul14 to i64, !dbg !964
  %add.ptr16 = getelementptr inbounds float, float* %a_cuda, i64 %idx.ext15, !dbg !964
  %add.ptr18 = getelementptr inbounds float, float* %add.ptr16, i64 %idx.ext12, !dbg !965
  %5 = bitcast float* %add.ptr18 to i8*, !dbg !966
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %5, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @5, i32 0, i32 0), i32 295, i32 120, i32 1, i32 4), !dbg !966
  %6 = load float, float* %add.ptr18, align 4, !dbg !966, !tbaa !961
  %div = fdiv float %4, %6, !dbg !967
  %add.ptr28 = getelementptr inbounds float, float* %m_cuda, i64 %idx.ext, !dbg !968
  %add.ptr30 = getelementptr inbounds float, float* %add.ptr28, i64 %idx.ext12, !dbg !969
  %7 = bitcast float* %add.ptr30 to i8*, !dbg !970
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %7, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @6, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @7, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @8, i32 0, i32 0), i32 295, i32 59, i32 2, i32 4), !dbg !970
  store float %div, float* %add.ptr30, align 4, !dbg !970, !tbaa !961
...
; Function Attrs: nounwind
define void @_Z4Fan2PfS_S_iii(float* nocapture readonly %m_cuda, float* nocapture %a_cuda, float* nocapture %b_cuda, i32 %Size, i32 %j1, i32 %t) local_unnamed_addr #4 !dbg !974 {
entry:
  tail call void @llvm.dbg.value(metadata float* %m_cuda, i64 0, metadata !978, metadata !588), !dbg !986
  tail call void @llvm.dbg.value(metadata float* %a_cuda, i64 0, metadata !979, metadata !588), !dbg !987
  tail call void @llvm.dbg.value(metadata float* %b_cuda, i64 0, metadata !980, metadata !588), !dbg !988
  tail call void @llvm.dbg.value(metadata i32 %Size, i64 0, metadata !981, metadata !588), !dbg !989
  tail call void @llvm.dbg.value(metadata i32 %j1, i64 0, metadata !982, metadata !588), !dbg !990
  tail call void @llvm.dbg.value(metadata i32 %t, i64 0, metadata !983, metadata !588), !dbg !991
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #6, !dbg !992, !range !872
  %1 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x() #6, !dbg !995, !range !902
  %2 = tail call i32 @llvm.nvvm.read.ptx.sreg.ntid.x() #6, !dbg !998, !range !948
  %mul = mul i32 %2, %1, !dbg !1001
  %add = add i32 %mul, %0, !dbg !1002
  %sub = add nsw i32 %Size, -1, !dbg !1003
  %sub3 = sub i32 %sub, %t, !dbg !1004
  %cmp = icmp ult i32 %add, %sub3, !dbg !1005
  br i1 %cmp, label %if.end, label %return, !dbg !1006

if.end:                                           ; preds = %entry
  %3 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.y() #6, !dbg !1007, !range !872
  %4 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.y() #6, !dbg !1011, !range !1015
  %5 = tail call i32 @llvm.nvvm.read.ptx.sreg.ntid.y() #6, !dbg !1016, !range !948
  %mul7 = mul nuw nsw i32 %5, %4, !dbg !1020
  %add8 = add nuw nsw i32 %mul7, %3, !dbg !1021
  %sub9 = sub nsw i32 %Size, %t, !dbg !1022
  %cmp10 = icmp ult i32 %add8, %sub9, !dbg !1023
  br i1 %cmp10, label %if.end12, label %return, !dbg !1024

if.end12:                                         ; preds = %if.end
  tail call void @llvm.dbg.value(metadata i32 %add, i64 0, metadata !984, metadata !588), !dbg !1025
  tail call void @llvm.dbg.value(metadata i32 %add8, i64 0, metadata !985, metadata !588), !dbg !1026
  %add23 = add i32 %t, 1, !dbg !1027
  %add24 = add i32 %add23, %add, !dbg !1028
  %mul25 = mul nsw i32 %add24, %Size, !dbg !1029
  %add26 = add nsw i32 %mul25, %t, !dbg !1030
  %idxprom = sext i32 %add26 to i64, !dbg !1031
  %arrayidx = getelementptr inbounds float, float* %m_cuda, i64 %idxprom, !dbg !1031
  %6 = bitcast float* %arrayidx to i8*, !dbg !1031
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %6, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @11, i32 0, i32 0), i32 312, i32 38, i32 3, i32 4), !dbg !1031
  %7 = load float, float* %arrayidx, align 4, !dbg !1031, !tbaa !961
  %mul27 = mul nsw i32 %t, %Size, !dbg !1032
  %add28 = add nsw i32 %add8, %t, !dbg !1033
  %add29 = add nsw i32 %add28, %mul27, !dbg !1034
  %idxprom30 = sext i32 %add29 to i64, !dbg !1035
  %arrayidx31 = getelementptr inbounds float, float* %a_cuda, i64 %idxprom30, !dbg !1035
  %8 = bitcast float* %arrayidx31 to i8*, !dbg !1035
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %8, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @12, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @13, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @14, i32 0, i32 0), i32 312, i32 66, i32 4, i32 4), !dbg !1035
  %9 = load float, float* %arrayidx31, align 4, !dbg !1035, !tbaa !961
  %mul32 = fmul float %7, %9, !dbg !1036
  %add37 = add nsw i32 %add28, %mul25, !dbg !1037
  %idxprom38 = sext i32 %add37 to i64, !dbg !1038
  %arrayidx39 = getelementptr inbounds float, float* %a_cuda, i64 %idxprom38, !dbg !1038
  %10 = bitcast float* %arrayidx39 to i8*, !dbg !1039
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %10, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @15, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @16, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @17, i32 0, i32 0), i32 312, i32 35, i32 5, i32 4), !dbg !1039
  %11 = load float, float* %arrayidx39, align 4, !dbg !1039, !tbaa !961
  %sub40 = fsub float %11, %mul32, !dbg !1039
  %12 = bitcast float* %arrayidx39 to i8*, !dbg !1039
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %12, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @18, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @19, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @20, i32 0, i32 0), i32 312, i32 35, i32 6, i32 4), !dbg !1039
  store float %sub40, float* %arrayidx39, align 4, !dbg !1039, !tbaa !961
  %cmp41 = icmp eq i32 %add8, 0, !dbg !1040
  br i1 %cmp41, label %if.then42, label %return, !dbg !1042

if.then42:                                        ; preds = %if.end12
  %arrayidx49 = getelementptr inbounds float, float* %m_cuda, i64 %idxprom38, !dbg !1043
  %13 = bitcast float* %arrayidx49 to i8*, !dbg !1043
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %13, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @21, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @22, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @23, i32 0, i32 0), i32 317, i32 23, i32 7, i32 4), !dbg !1043
  %14 = load float, float* %arrayidx49, align 4, !dbg !1043, !tbaa !961
  %idxprom50 = sext i32 %t to i64, !dbg !1045
  %arrayidx51 = getelementptr inbounds float, float* %b_cuda, i64 %idxprom50, !dbg !1045
  %15 = bitcast float* %arrayidx51 to i8*, !dbg !1045
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %15, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @24, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @25, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @26, i32 0, i32 0), i32 317, i32 58, i32 8, i32 4), !dbg !1045
  %16 = load float, float* %arrayidx51, align 4, !dbg !1045, !tbaa !961
  %mul52 = fmul float %14, %16, !dbg !1046
  %idxprom55 = sext i32 %add24 to i64, !dbg !1047
  %arrayidx56 = getelementptr inbounds float, float* %b_cuda, i64 %idxprom55, !dbg !1047
  %17 = bitcast float* %arrayidx56 to i8*, !dbg !1048
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %17, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @27, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @28, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @29, i32 0, i32 0), i32 317, i32 20, i32 9, i32 4), !dbg !1048
  %18 = load float, float* %arrayidx56, align 4, !dbg !1048, !tbaa !961
  %sub57 = fsub float %18, %mul52, !dbg !1048
  %19 = bitcast float* %arrayidx56 to i8*, !dbg !1048
  call void @_Z15countCacheLinesPvPcS0_S0_iiii(i8* %19, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @30, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @31, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @32, i32 0, i32 0), i32 317, i32 20, i32 10, i32 4), !dbg !1048
  store float %sub57, float* %arrayidx56, align 4, !dbg !1048, !tbaa !961
...
!835 = !DILocation(line: 67, column: 3, scope: !836, inlinedAt: !870)
!836 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !837, file: !12, line: 67, type: !840, isLocal: false, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !839, variables: !2)
!837 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_threadIdx_t", file: !12, line: 66, size: 8, align: 8, elements: !838, identifier: "_ZTS26__cuda_builtin_threadIdx_t")
!838 = !{!839, !842, !843, !844, !855, !859, !863, !866}
!839 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_xEv", scope: !837, file: !12, line: 67, type: !840, isLocal: false, isDefinition: false, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true)
!840 = !DISubroutineType(types: !841)
!841 = !{!375}
!842 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !837, file: !12, line: 68, type: !840, isLocal: false, isDefinition: false, scopeLine: 68, flags: DIFlagPrototyped, isOptimized: true)
!843 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_zEv", scope: !837, file: !12, line: 69, type: !840, isLocal: false, isDefinition: false, scopeLine: 69, flags: DIFlagPrototyped, isOptimized: true)
!844 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK26__cuda_builtin_threadIdx_tcv5uint3Ev", scope: !837, file: !12, line: 72, type: !845, isLocal: false, isDefinition: false, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: true)
!845 = !DISubroutineType(types: !846)
!846 = !{!847, !853}
!847 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uint3", file: !848, line: 190, size: 96, align: 32, elements: !849, identifier: "_ZTS5uint3")
!848 = !DIFile(filename: "/usr/local/cuda/include/vector_types.h", directory: "/home/ec2-user/DynamicAnalyis")
!849 = !{!850, !851, !852}
!850 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !847, file: !848, line: 192, baseType: !375, size: 32, align: 32)
!851 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !847, file: !848, line: 192, baseType: !375, size: 32, align: 32, offset: 32)
!852 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !847, file: !848, line: 192, baseType: !375, size: 32, align: 32, offset: 64)
!853 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !854, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!854 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !837)
!855 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !837, file: !12, line: 74, type: !856, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!856 = !DISubroutineType(types: !857)
!857 = !{null, !858}
!858 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !837, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!859 = !DISubprogram(name: "__cuda_builtin_threadIdx_t", scope: !837, file: !12, line: 74, type: !860, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!860 = !DISubroutineType(types: !861)
!861 = !{null, !858, !862}
!862 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !854, size: 64, align: 64)
!863 = !DISubprogram(name: "operator=", linkageName: "_ZNK26__cuda_builtin_threadIdx_taSERKS_", scope: !837, file: !12, line: 74, type: !864, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!864 = !DISubroutineType(types: !865)
!865 = !{null, !853, !862}
!866 = !DISubprogram(name: "operator&", linkageName: "_ZNK26__cuda_builtin_threadIdx_tadEv", scope: !837, file: !12, line: 74, type: !867, isLocal: false, isDefinition: false, scopeLine: 74, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!867 = !DISubroutineType(types: !868)
!868 = !{!869, !853}
!869 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !837, size: 64, align: 64)
!870 = distinct !DILocation(line: 294, column: 5, scope: !871)
!871 = distinct !DILexicalBlock(scope: !823, file: !1, line: 294, column: 5)
!872 = !{i32 0, i32 1024}
!873 = !DILocation(line: 78, column: 3, scope: !874, inlinedAt: !900)
!874 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !875, file: !12, line: 78, type: !840, isLocal: false, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !877, variables: !2)
!875 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_blockIdx_t", file: !12, line: 77, size: 8, align: 8, elements: !876, identifier: "_ZTS25__cuda_builtin_blockIdx_t")
!876 = !{!877, !878, !879, !880, !885, !889, !893, !896}
!877 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_xEv", scope: !875, file: !12, line: 78, type: !840, isLocal: false, isDefinition: false, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true)
!878 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !875, file: !12, line: 79, type: !840, isLocal: false, isDefinition: false, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: true)
!879 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_zEv", scope: !875, file: !12, line: 80, type: !840, isLocal: false, isDefinition: false, scopeLine: 80, flags: DIFlagPrototyped, isOptimized: true)
!880 = !DISubprogram(name: "operator uint3", linkageName: "_ZNK25__cuda_builtin_blockIdx_tcv5uint3Ev", scope: !875, file: !12, line: 83, type: !881, isLocal: false, isDefinition: false, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true)
...
!885 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !875, file: !12, line: 85, type: !886, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!886 = !DISubroutineType(types: !887)
!887 = !{null, !888}
!888 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !875, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!889 = !DISubprogram(name: "__cuda_builtin_blockIdx_t", scope: !875, file: !12, line: 85, type: !890, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!890 = !DISubroutineType(types: !891)
!891 = !{null, !888, !892}
!892 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !884, size: 64, align: 64)
!893 = !DISubprogram(name: "operator=", linkageName: "_ZNK25__cuda_builtin_blockIdx_taSERKS_", scope: !875, file: !12, line: 85, type: !894, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!894 = !DISubroutineType(types: !895)
!895 = !{null, !883, !892}
!896 = !DISubprogram(name: "operator&", linkageName: "_ZNK25__cuda_builtin_blockIdx_tadEv", scope: !875, file: !12, line: 85, type: !897, isLocal: false, isDefinition: false, scopeLine: 85, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!897 = !DISubroutineType(types: !898)
!898 = !{!899, !883}
!899 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !875, size: 64, align: 64)
!900 = distinct !DILocation(line: 294, column: 19, scope: !901)
!901 = !DILexicalBlockFile(scope: !871, file: !1, discriminator: 2)
!902 = !{i32 0, i32 2147483647}
!903 = !DILocation(line: 89, column: 3, scope: !904, inlinedAt: !946)
!904 = distinct !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !905, file: !12, line: 89, type: !840, isLocal: false, isDefinition: true, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !907, variables: !2)
!905 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__cuda_builtin_blockDim_t", file: !12, line: 88, size: 8, align: 8, elements: !906, identifier: "_ZTS25__cuda_builtin_blockDim_t")
!906 = !{!907, !908, !909, !910, !931, !935, !939, !942}
!907 = !DISubprogram(name: "__fetch_builtin_x", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_xEv", scope: !905, file: !12, line: 89, type: !840, isLocal: false, isDefinition: false, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true)
!908 = !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv", scope: !905, file: !12, line: 90, type: !840, isLocal: false, isDefinition: false, scopeLine: 90, flags: DIFlagPrototyped, isOptimized: true)
!909 = !DISubprogram(name: "__fetch_builtin_z", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_zEv", scope: !905, file: !12, line: 91, type: !840, isLocal: false, isDefinition: false, scopeLine: 91, flags: DIFlagPrototyped, isOptimized: true)
!910 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK25__cuda_builtin_blockDim_tcv4dim3Ev", scope: !905, file: !12, line: 94, type: !911, isLocal: false, isDefinition: false, scopeLine: 94, flags: DIFlagPrototyped, isOptimized: true)
!911 = !DISubroutineType(types: !912)
!912 = !{!913, !929}
!913 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "dim3", file: !848, line: 417, size: 96, align: 32, elements: !914, identifier: "_ZTS4dim3")
!914 = !{!915, !916, !917, !918, !922, !926}
!915 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !913, file: !848, line: 419, baseType: !375, size: 32, align: 32)
!916 = !DIDerivedType(tag: DW_TAG_member, name: "y", scope: !913, file: !848, line: 419, baseType: !375, size: 32, align: 32, offset: 32)
!917 = !DIDerivedType(tag: DW_TAG_member, name: "z", scope: !913, file: !848, line: 419, baseType: !375, size: 32, align: 32, offset: 64)
!918 = !DISubprogram(name: "dim3", scope: !913, file: !848, line: 421, type: !919, isLocal: false, isDefinition: false, scopeLine: 421, flags: DIFlagPrototyped, isOptimized: true)
!919 = !DISubroutineType(types: !920)
!920 = !{null, !921, !375, !375, !375}
!921 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !913, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!922 = !DISubprogram(name: "dim3", scope: !913, file: !848, line: 422, type: !923, isLocal: false, isDefinition: false, scopeLine: 422, flags: DIFlagPrototyped, isOptimized: true)
!923 = !DISubroutineType(types: !924)
!924 = !{null, !921, !925}
!925 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint3", file: !848, line: 383, baseType: !847)
!926 = !DISubprogram(name: "operator uint3", linkageName: "_ZN4dim3cv5uint3Ev", scope: !913, file: !848, line: 423, type: !927, isLocal: false, isDefinition: false, scopeLine: 423, flags: DIFlagPrototyped, isOptimized: true)
!927 = !DISubroutineType(types: !928)
!928 = !{!925, !921}
!929 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !930, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!930 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !905)
!931 = !DISubprogram(name: "__cuda_builtin_blockDim_t", scope: !905, file: !12, line: 96, type: !932, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!932 = !DISubroutineType(types: !933)
!933 = !{null, !934}
!934 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !905, size: 64, align: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!935 = !DISubprogram(name: "__cuda_builtin_blockDim_t", scope: !905, file: !12, line: 96, type: !936, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!936 = !DISubroutineType(types: !937)
!937 = !{null, !934, !938}
!938 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !930, size: 64, align: 64)
!939 = !DISubprogram(name: "operator=", linkageName: "_ZNK25__cuda_builtin_blockDim_taSERKS_", scope: !905, file: !12, line: 96, type: !940, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!940 = !DISubroutineType(types: !941)
!941 = !{null, !929, !938}
!942 = !DISubprogram(name: "operator&", linkageName: "_ZNK25__cuda_builtin_blockDim_tadEv", scope: !905, file: !12, line: 96, type: !943, isLocal: false, isDefinition: false, scopeLine: 96, flags: DIFlagPrivate | DIFlagPrototyped, isOptimized: true)
!943 = !DISubroutineType(types: !944)
!944 = !{!945, !929}
!945 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !905, size: 64, align: 64)
!946 = distinct !DILocation(line: 294, column: 32, scope: !947)
!947 = !DILexicalBlockFile(scope: !871, file: !1, discriminator: 3)
!948 = !{i32 1, i32 1025}
!949 = !DILocation(line: 294, column: 30, scope: !871)
!950 = !DILocation(line: 294, column: 17, scope: !871)
!951 = !DILocation(line: 294, column: 50, scope: !871)
!952 = !DILocation(line: 294, column: 52, scope: !871)
!953 = !DILocation(line: 294, column: 43, scope: !871)
!954 = !DILocation(line: 294, column: 5, scope: !823)
!955 = !DILocation(line: 295, column: 109, scope: !823)
!956 = !DILocation(line: 295, column: 111, scope: !823)
!957 = !DILocation(line: 295, column: 74, scope: !823)
!958 = !DILocation(line: 295, column: 69, scope: !823)
!959 = !DILocation(line: 295, column: 114, scope: !823)
!960 = !DILocation(line: 295, column: 61, scope: !823)
!961 = !{!962, !962, i64 0}
!962 = !{!"float", !721, i64 0}
!963 = !DILocation(line: 295, column: 133, scope: !823)
!964 = !DILocation(line: 295, column: 128, scope: !823)
!965 = !DILocation(line: 295, column: 135, scope: !823)
!966 = !DILocation(line: 295, column: 120, scope: !823)
!967 = !DILocation(line: 295, column: 118, scope: !823)
!968 = !DILocation(line: 295, column: 10, scope: !823)
!969 = !DILocation(line: 295, column: 55, scope: !823)
!970 = !DILocation(line: 295, column: 59, scope: !823)
!971 = !DILocation(line: 296, column: 1, scope: !823)
!972 = !DILocation(line: 296, column: 1, scope: !973)
!973 = !DILexicalBlockFile(scope: !823, file: !1, discriminator: 1)
!974 = distinct !DISubprogram(name: "Fan2", linkageName: "_Z4Fan2PfS_S_iii", scope: !1, file: !1, line: 303, type: !975, isLocal: false, isDefinition: true, scopeLine: 304, flags: DIFlagPrototyped, isOptimized: true, unit: !0, variables: !977)
!975 = !DISubroutineType(types: !976)
!976 = !{null, !154, !154, !154, !9, !9, !9}
!977 = !{!978, !979, !980, !981, !982, !983, !984, !985}
!978 = !DILocalVariable(name: "m_cuda", arg: 1, scope: !974, file: !1, line: 303, type: !154)
!979 = !DILocalVariable(name: "a_cuda", arg: 2, scope: !974, file: !1, line: 303, type: !154)
!980 = !DILocalVariable(name: "b_cuda", arg: 3, scope: !974, file: !1, line: 303, type: !154)
!981 = !DILocalVariable(name: "Size", arg: 4, scope: !974, file: !1, line: 303, type: !9)
!982 = !DILocalVariable(name: "j1", arg: 5, scope: !974, file: !1, line: 303, type: !9)
!983 = !DILocalVariable(name: "t", arg: 6, scope: !974, file: !1, line: 303, type: !9)
!984 = !DILocalVariable(name: "xidx", scope: !974, file: !1, line: 308, type: !9)
!985 = !DILocalVariable(name: "yidx", scope: !974, file: !1, line: 309, type: !9)
!986 = !DILocation(line: 303, column: 29, scope: !974)
!987 = !DILocation(line: 303, column: 44, scope: !974)
!988 = !DILocation(line: 303, column: 59, scope: !974)
!989 = !DILocation(line: 303, column: 70, scope: !974)
!990 = !DILocation(line: 303, column: 80, scope: !974)
!991 = !DILocation(line: 303, column: 88, scope: !974)
!992 = !DILocation(line: 67, column: 3, scope: !836, inlinedAt: !993)
!993 = distinct !DILocation(line: 305, column: 5, scope: !994)
!994 = distinct !DILexicalBlock(scope: !974, file: !1, line: 305, column: 5)
!995 = !DILocation(line: 78, column: 3, scope: !874, inlinedAt: !996)
!996 = distinct !DILocation(line: 305, column: 19, scope: !997)
!997 = !DILexicalBlockFile(scope: !994, file: !1, discriminator: 2)
!998 = !DILocation(line: 89, column: 3, scope: !904, inlinedAt: !999)
!999 = distinct !DILocation(line: 305, column: 32, scope: !1000)
!1000 = !DILexicalBlockFile(scope: !994, file: !1, discriminator: 3)
!1001 = !DILocation(line: 305, column: 30, scope: !994)
!1002 = !DILocation(line: 305, column: 17, scope: !994)
!1003 = !DILocation(line: 305, column: 50, scope: !994)
!1004 = !DILocation(line: 305, column: 52, scope: !994)
!1005 = !DILocation(line: 305, column: 43, scope: !994)
!1006 = !DILocation(line: 305, column: 5, scope: !974)
!1007 = !DILocation(line: 68, column: 3, scope: !1008, inlinedAt: !1009)
!1008 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN26__cuda_builtin_threadIdx_t17__fetch_builtin_yEv", scope: !837, file: !12, line: 68, type: !840, isLocal: false, isDefinition: true, scopeLine: 68, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !842, variables: !2)
!1009 = distinct !DILocation(line: 306, column: 5, scope: !1010)
!1010 = distinct !DILexicalBlock(scope: !974, file: !1, line: 306, column: 5)
!1011 = !DILocation(line: 79, column: 3, scope: !1012, inlinedAt: !1013)
!1012 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockIdx_t17__fetch_builtin_yEv", scope: !875, file: !12, line: 79, type: !840, isLocal: false, isDefinition: true, scopeLine: 79, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !878, variables: !2)
!1013 = distinct !DILocation(line: 306, column: 19, scope: !1014)
!1014 = !DILexicalBlockFile(scope: !1010, file: !1, discriminator: 2)
!1015 = !{i32 0, i32 65535}
!1016 = !DILocation(line: 90, column: 3, scope: !1017, inlinedAt: !1018)
!1017 = distinct !DISubprogram(name: "__fetch_builtin_y", linkageName: "_ZN25__cuda_builtin_blockDim_t17__fetch_builtin_yEv", scope: !905, file: !12, line: 90, type: !840, isLocal: false, isDefinition: true, scopeLine: 90, flags: DIFlagPrototyped, isOptimized: true, unit: !0, declaration: !908, variables: !2)
!1018 = distinct !DILocation(line: 306, column: 32, scope: !1019)
!1019 = !DILexicalBlockFile(scope: !1010, file: !1, discriminator: 3)
!1020 = !DILocation(line: 306, column: 30, scope: !1010)
!1021 = !DILocation(line: 306, column: 17, scope: !1010)
!1022 = !DILocation(line: 306, column: 50, scope: !1010)
!1023 = !DILocation(line: 306, column: 43, scope: !1010)
!1024 = !DILocation(line: 306, column: 5, scope: !974)
!1025 = !DILocation(line: 308, column: 6, scope: !974)
!1026 = !DILocation(line: 309, column: 6, scope: !974)
!1027 = !DILocation(line: 312, column: 55, scope: !974)
!1028 = !DILocation(line: 312, column: 57, scope: !974)
!1029 = !DILocation(line: 312, column: 49, scope: !974)
!1030 = !DILocation(line: 312, column: 60, scope: !974)
!1031 = !DILocation(line: 312, column: 38, scope: !974)
!1032 = !DILocation(line: 312, column: 77, scope: !974)
!1033 = !DILocation(line: 312, column: 85, scope: !974)
!1034 = !DILocation(line: 312, column: 79, scope: !974)
!1035 = !DILocation(line: 312, column: 66, scope: !974)
!1036 = !DILocation(line: 312, column: 64, scope: !974)
!1037 = !DILocation(line: 312, column: 24, scope: !974)
!1038 = !DILocation(line: 312, column: 2, scope: !974)
!1039 = !DILocation(line: 312, column: 35, scope: !974)
!1040 = !DILocation(line: 314, column: 10, scope: !1041)
!1041 = distinct !DILexicalBlock(scope: !974, file: !1, line: 314, column: 5)
!1042 = !DILocation(line: 314, column: 5, scope: !974)
!1043 = !DILocation(line: 317, column: 23, scope: !1044)
!1044 = distinct !DILexicalBlock(scope: !1041, file: !1, line: 314, column: 15)
!1045 = !DILocation(line: 317, column: 58, scope: !1044)
!1046 = !DILocation(line: 317, column: 56, scope: !1044)
!1047 = !DILocation(line: 317, column: 3, scope: !1044)
!1048 = !DILocation(line: 317, column: 20, scope: !1044)
!1049 = !DILocation(line: 318, column: 2, scope: !1044)
!1050 = !DILocation(line: 319, column: 1, scope: !1051)
!1051 = !DILexicalBlockFile(scope: !974, file: !1, discriminator: 1)
